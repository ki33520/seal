...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkOrderlistAppJsx = __webpack_require__(633);
	...
	function bootstrap() {
	    ...
	    _reactDom2["default"].render(_react2["default"].createElement(_sharedChunkOrderlistAppJsx2["default"], { initialState: initialState }), document.getElementById('order-list'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(634);
	...
	var _componentJsx = __webpack_require__(636);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(635);
	...
	var OrderListApp = (function (_Component) {
	    _inherits(OrderListApp, _Component);

	    function OrderListApp() {
	        _classCallCheck(this, OrderListApp);

	        _get(Object.getPrototypeOf(OrderListApp.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(OrderListApp, [{
	        key: "render",
	        value: function render() {
	            var _props$initialState = this.props.initialState;
	            var isFetched = _props$initialState.isFetched;
	            var orders = _props$initialState.orders;
	            var flag = _props$initialState.flag;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ordersByParam = ordersByParam;
	...
	function ordersByParam(state, action) {
	    if (state === undefined) state = {};

	    switch (action.type) {
	        case _actionEs6.CHANGE_ORDER:
	            var flag = state.flag;
	            var orders = _extends({}, state.orders);
	            orders[flag].list.map(function (v, k) {
	        ...
	        case _actionEs6.RECEIVE_ORDER:
	            var obj = action.res;
	            var status = action.param.status;
	            obj.isFetching = false;
	            obj.orders.forEach(function (v, k) {
	                if (v) {
	                    var oldlist = state.orders[k] && state.orders[k].list || [];
	                    var newlist = v.list || [];
	                    v.list = _lodash2["default"].union(oldlist, newlist);
	                } else {
	                    obj.orders[k] = state.orders[k];
	                }
	            });
	            return _Object$assign({}, state, obj);
	        ...
	        case _actionEs6.RESPONSE_DELIVERYORDER:
	            ...
	            var orderStatus = action.res.orderStatus;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RECEIVE_ORDER = RECEIVE_ORDER;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialFloorJsx = __webpack_require__(637);
	...
	var OrderList = (function (_Component) {
	    ...
	    function OrderList(props) {
	        ...
	        _get(Object.getPrototypeOf(OrderList.prototype), "constructor", this).call(this, props);
	        this.state = {
	    ...
	    _createClass(OrderList, [{
	        ...
	        key: "confirmDialog",
	        value: function confirmDialog(orderNo, i) {
	            var _this = this;
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            if (nextProps.ordersByParam.deliveryOrderChanging === false && this.props.ordersByParam.deliveryOrderChanging === true) {
	        ...
	        value: function beginRefresh(interval, flag) {
	            var fetchOrder = this.props.fetchOrder;
	            var _props$ordersByParam = this.props.ordersByParam;
	            var orders = _props$ordersByParam.orders;
	            var isFetching = _props$ordersByParam.isFetching;
	        ...
	        key: "componentDidMount",
	        value: function componentDidMount() {
	            _reactDom2["default"].findDOMNode(this.refs["slideTabs"]).children[0].children[this.state.displayFlag].click();
	        }
	    }, {
	        key: "componentDidUpdate",
	        value: function componentDidUpdate(prevProps, prevState) {
	            ...
	            if (prevProps.ordersByParam.paygatewayFetched === false && this.props.ordersByParam.paygatewayFetched === true) {
	                setTimeout(function () {
	                    _reactDom2["default"].findDOMNode(_this2.refs["submitForm"]).submit();
	                }, 10);
	            }
	        }
	    }, {
	        ...
	        value: function toggleFlag(flag, e) {
	            e && e.preventDefault();
	            var orders = this.props.ordersByParam.orders;
	        ...
	        value: function render() {
	            ...
	            var _props$ordersByParam2 = this.props.ordersByParam;
	            var orders = _props$ordersByParam2.orders;
	            var isFetching = _props$ordersByParam2.isFetching;
	            var systemTime = _props$ordersByParam2.systemTime;
	            var alertActive = _props$ordersByParam2.alertActive;
	            var alertContent = _props$ordersByParam2.alertContent;
	            var cashierParam = _props$ordersByParam2.cashierParam;

	            cashierParam = cashierParam || {};
	            var tab_nav_item = ["全部", "待付款", "待发货", "待收货", "待评价"];
	            return _react2["default"].createElement(
	                "div",
	                ...
	                _react2["default"].createElement(
	                    "header",
	                    { className: "header" },
	                    _react2["default"].createElement("a", { href: "/membercenter", className: "iconfont icon-back" }),
	                    _react2["default"].createElement(
	                        "span",
	                        { className: "title" },
	                        "我的订单"
	                ...
	                _react2["default"].createElement(
	                    ...
	                    { ref: "slideTabs", axis: "x", activeIndex: 0, navbarSlidable: false, onSelect: this.toggleFlag.bind(this) },
	                    tab_nav_item.map(function (v, k) {
	                        ...
	                        return _react2["default"].createElement(
	                            ...
	                            { key: k, navigator: function () {
	                                    return _react2["default"].createElement(
	                                        "a",
	                                        { onClick: _this3.handleLink.bind(_this3), href: "/orderlist/" + k },
	                                        v
	                                    );
	                                }, className: "listMain" },
	                            _react2["default"].createElement(
	                                ...
	                                { relative: true },
	                                _react2["default"].createElement(_partialFloorJsx2["default"], _extends({ systemTime: systemTime, orderIndex: k, confirmDialog: _this3.confirmDialog.bind(_this3) }, _this3.props)),
	                                _react2["default"].createElement(_componentRefresherJsx2["default"], { active: refresherActive, handleRefresh: _this3.beginRefresh.bind(_this3) })
	                            )
	                        );
	                    })
	                ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Floor = (function (_Component) {
	    ...
	    _createClass(Floor, [{
	        ...
	        value: function handleDeliveryOrder(child, i, e) {
	            e && e.preventDefault();
	            var _props = this.props;
	            var dispatch = _props.dispatch;
	            var confirmDialog = _props.confirmDialog;
	            var orderNo = child.orderNo;

	            confirmDialog.call(this, orderNo, i);
	        }
	    }, {
	        key: "handlePayGateway",
	        value: function handlePayGateway(child, e) {
	            e && e.preventDefault();
	        ...
	        key: "renderButtons",
	        value: function renderButtons(child, i) {
	            var orderIndex = this.props.orderIndex;
	            var orderStatus = child.orderStatus;
	            var orderId = child.orderId;
	            var itemList = child.itemList;
	            ...
	            switch (orderStatus) {
	                case "STATUS_NOT_PAY":
	                    return _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(null)", onClick: this.handlePayGateway.bind(this, child), className: "pop_c" },
	                            "去支付"
	                        )
	                    );
	                case "STATUS_CONFIRMED":
	                    return _react2["default"].createElement("div", { className: "order-buttons" });
	                case "STATUS_OUT_HOUSE":
	                    return _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(null)", onClick: this.handleDeliveryOrder.bind(this, child, i), className: "pop_c" },
	                            "确认收货"
	                        ),
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/orderdetail/" + orderId + "?back=" + orderIndex + "#/logistics", className: "view_c" },
	                            "查看物流"
	                        )
	                    );
	                case "STATUS_SENDED":
	                ...
	                case "STATUS_FINISHED":
	                    if (hasNotComment.length > 0) {
	                        return _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "a",
	                                { href: "/orderdetail/" + orderId + "?back=" + orderIndex + "#/comment", className: "view_c" },
	                                "评价晒单"
	                            )
	                        );
	                    } else {
	        ...
	        key: "renderGoods",
	        value: function renderGoods(itemList) {
	            var _this = this;

	            var content;
	            var tabItems = itemList.map(function (good, i) {
	                return _react2["default"].createElement(_componentSlidetabsJsx.SlideTabsItem, { key: i, navigator: function () {
	                        return _react2["default"].createElement(
	                            "span",
	                            { className: "img_wrap J_ytag cartlist" },
	                            _react2["default"].createElement(_componentImageJsx2["default"], { placeholder: good.singleImageUrl })
	                        );
	                    }, className: "listMain" });
	            });
	            if (itemList.length > 1) {
	                content = _react2["default"].createElement(
	                    "div",
	                    { className: "clearfix slide-img-block" },
	                    _react2["default"].createElement(
	                        _componentSlidetabsJsx.SlideTabs,
	                        { ref: "imgslide", axis: "x", activeIndex: 0, navbarSlidable: itemList.length > 4 },
	                        tabItems
	                    )
	                );
	            } else {
	                content = itemList.map(function (good, i) {
	                    var salesPrice = good.salesPrice !== undefined ? good.salesPrice : 0;
	                    return _react2["default"].createElement(
	                        "div",
	        ...
	        key: "renderOutTime",
	        value: function renderOutTime(child) {
	            var systemTime = this.props.ordersByParam.systemTime;
	            var createdAt = child.createdAt;
	            var timeoutTime = child.timeoutTime;
	            var orderStatus = child.orderStatus;
	            ...
	            if (orderStatus === "STATUS_NOT_PAY" && outTime) {
	                return _react2["default"].createElement(
	                    "i",
	                    null,
	                    _react2["default"].createElement(_commonTimerJsx2["default"], { onTimerExpire: this.timeOut.bind(this, child), endTime: outTime, referTime: currentTime, template: "<i><%= hour %></i>:<i><%= minute %></i>:<i><%= second %></i>" }),
	                    _react2["default"].createElement(
	                        "span",
	                        null,
	                        "后自动取消"
	        ...
	        value: function renderNode(list) {
	            ...
	            if (list.length > 0) {
	                return list.map(function (child, i) {
	                    var createdAt = child.createdAt;
	                    var id = child.id;
	                    var orderReceiveId = child.orderReceiveId;
	                    var orderId = child.orderId;
	                    var itemList = child.itemList;
	                    var paymentFee = child.paymentFee;
	                    var salesTotalFee = child.salesTotalFee;
	                    var orderStatus = child.orderStatus;
	                    var timeoutTime = child.timeoutTime;

	                    var paymentFeeTotal = paymentFee !== undefined ? paymentFee : 0;
	                    var crtTime = (0, _moment2["default"])(new Date(createdAt)).format("YYYY-MM-DD HH:mm:ss");
	                    var classes = (0, _classnames2["default"])({
	                        green: orderStatus === "STATUS_FINISHED"
	                    });
	                    return _react2["default"].createElement(
	                        "div",
	                        { className: "order-box", key: i },
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "order-up" },
	                            _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "a",
	                                { href: "/orderdetail/" + orderId + "?back=" + orderIndex },
	                                _this2.renderGoods(itemList)
	                            )
	                        ),
	                        _react2["default"].createElement(
	                            "div",
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    null,
	                                    "¥",
	                                    _this2.formatPrice(paymentFeeTotal)
	                                )
	                            ),
	                            _this2.renderButtons(child, i)
	                        )
	                    );
	                });
	            }
	        ...
	        value: function render() {
	            ...
	            var orderItem = orders[orderIndex];
	            return _react2["default"].createElement(
	                "div",
	                { className: "order-content order-content-" + orderIndex },
