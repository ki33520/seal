...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkMembercollectAppJsx = __webpack_require__(589);

	var _sharedChunkMembercollectAppJsx2 = _interopRequireDefault(_sharedChunkMembercollectAppJsx);
	...
	function bootstrap() {
	    ...
	    _reactDom2["default"].render(_react2["default"].createElement(_sharedChunkMembercollectAppJsx2["default"], { initialState: initialState }), document.getElementById('member-collect'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(590);
	...
	var _componentJsx = __webpack_require__(592);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(591);
	...
	var MembercollectApp = (function (_Component) {
	    _inherits(MembercollectApp, _Component);

	    function MembercollectApp() {
	        _classCallCheck(this, MembercollectApp);

	        _get(Object.getPrototypeOf(MembercollectApp.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(MembercollectApp, [{
	        key: "render",
	        value: function render() {
	            var _props$initialState = this.props.initialState;
	            var collect = _props$initialState.collect;
	    ...
	    return MembercollectApp;
	})(_react.Component);

	exports["default"] = MembercollectApp;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function memberCollectByUser(state, action) {
	    ...
	    switch (action.type) {
	        case _actionEs6.REQUEST_COLLECT:
	            return _Object$assign({}, state, {
	                isFetched: false,
	                isFetching: true
	            });
	        case _actionEs6.RECEIVE_COLLECT:
	            var collect = _extends({}, state.collect);
	        ...
	        case _actionEs6.START_TOGGLE_COLLECTED:
	            return _Object$assign({}, state, {
	                isToggling: true,
	                isToggled: false
	            });
	        case _actionEs6.FINISH_TOGGLE_COLLECTED:
	            var collect = _extends({}, state.collect);
	...
	var rootReducer = (0, _redux.combineReducers)({
	    memberCollectByUser: memberCollectByUser
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var REQUEST_COLLECT = "REQUEST_COLLECT";
	exports.REQUEST_COLLECT = REQUEST_COLLECT;
	var RECEIVE_COLLECT = "RECEIVE_COLLECT";
	exports.RECEIVE_COLLECT = RECEIVE_COLLECT;
	var START_TOGGLE_COLLECTED = "REQUEST_DELETE";
	exports.START_TOGGLE_COLLECTED = START_TOGGLE_COLLECTED;
	var FINISH_TOGGLE_COLLECTED = "RECEIVE_DELETE";
	...
	function fetchCollect(url, param) {
	    return function (dispatch) {
	    ...
	    return function (dispatch) {
	        ...
	        (0, _libUtilEs6.apiRequest)("/togglecollected", param).then(function (res) {
	            ...
	            if (res.isToggled) {
	                ...
	                dispatch((0, _commonActionEs6.alert)(alertMsg, 1000));
	            } else {
	                dispatch((0, _commonActionEs6.alert)(res.errMsg, 1000));
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialFloorJsx = __webpack_require__(593);

	var _partialFloorJsx2 = _interopRequireDefault(_partialFloorJsx);

	var MembercollectList = (function (_Component) {
	    _inherits(MembercollectList, _Component);

	    function MembercollectList() {
	        _classCallCheck(this, MembercollectList);

	        _get(Object.getPrototypeOf(MembercollectList.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(MembercollectList, [{
	        key: "beginRefresh",
	        value: function beginRefresh() {
	            var _props = this.props;
	            var dispatch = _props.dispatch;
	            var fetchCollect = _props.fetchCollect;
	            var _props$memberCollectByUser = this.props.memberCollectByUser;
	            var collect = _props$memberCollectByUser.collect;
	            var isFetching = _props$memberCollectByUser.isFetching;
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            var changeScene = _props2.changeScene;
	            var fetchCollect = _props2.fetchCollect;

	            var self = this;
	            if (nextProps.memberCollectByUser.isToggling === false && this.props.memberCollectByUser.isToggling === true) {
	        ...
	        key: "handleDelete",
	        value: function handleDelete(child, e) {
	            e && e.preventDefault();
	            e && e.preventDefault();
	        ...
	        key: "render",
	        value: function render() {
	            var _props$memberCollectByUser2 = this.props.memberCollectByUser;
	            var collect = _props$memberCollectByUser2.collect;
	            var isFetching = _props$memberCollectByUser2.isFetching;
	            var alertActive = _props$memberCollectByUser2.alertActive;
	            var alertContent = _props$memberCollectByUser2.alertContent;
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    { relative: true },
	                    _react2["default"].createElement(_partialFloorJsx2["default"], _extends({ handleDelete: this.handleDelete.bind(this) }, collect, this.props)),
	...
	exports["default"] = MembercollectList;
	module.exports = exports["default"];
	        ...
	        value: function render() {
	            ...
	            if (list.length > 0) {
	                return _react2['default'].createElement(
	                    ...
	                    list.map(function (child, key) {
	                        var masker = null;
	                        if (child.stock === 0) {
	                            masker = _react2['default'].createElement('div', { className: 'sold_out' });
	                        }
	                        if (child.version === 2) {
	                            masker = _react2['default'].createElement('div', { className: 'not_sell' });
	                        }
	                        return _react2['default'].createElement(
	                            'li',
	                            ...
	                            _react2['default'].createElement(
	                                ...
	                                _react2['default'].createElement(
	                                    ...
	                                    _react2['default'].createElement(
	                                        'div',
	                                        { className: 'origin' },
	                                        _react2['default'].createElement('img', { src: child.sourceImage }),
	                                        child.sourceName
	                                    ),
	                                    _react2['default'].createElement(
	                                        'div',
	                                        ...
	                                        _react2['default'].createElement(
	                                            ...
	                                            _this.formatPrice(child.originPrice)
	                                        ),
	                                        _react2['default'].createElement(
	                                            'span',
	                                            { className: 'delete' },
	                                            _react2['default'].createElement('a', { onClick: handleDelete.bind(_this, child), className: 'iconfont icon-trash' })
	                                        )
	                                    )
	                                )
	                            )
