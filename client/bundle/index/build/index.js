...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loading = (function (_Component) {
	    ...
	    _createClass(Loading, [{
	        key: "render",
	        value: function render() {
	            var classes = (0, _classnames2["default"])("loading", {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionEs6 = __webpack_require__(551);
	    ...
	    _createClass(SearchBox, [{
	        ...
	        value: function renderHotWord() {
	            ...
	            if (hotwords) {
	                return hotwords.map(function (hotword, i) {
	                    return _react2["default"].createElement(
	                        "a",
	                        { href: "/search?k=" + hotword.name, key: i },
	                        hotword.name
	                    );
	                });
	            }
	        ...
	        value: function renderHistory() {
	            if (this.props.search.history && this.props.search.history.length > 0) {
	                var _history = this.props.search.history.map(function (keyword, i) {
	                    return _react2["default"].createElement(
	                        "a",
	                        { href: "/search?k=" + keyword, key: i },
	                        keyword
	                    );
	                });
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "i",
	                            { onClick: this.handlePurgeHistory.bind(this) },
	                            "清空记录"
	                        )
	                    ),
	                    _history
	        ...
	        key: "handlePurgeHistory",
	        value: function handlePurgeHistory(e) {
	            e && e.preventDefault();
	        ...
	        value: function renderAssociate() {
	            ...
	            var keyword = _props$search.keyword;
	            var associateWords = _props$search.associateWords;

	            if (associateWords && associateWords.length > 0) {
	                return associateWords.map(function (associateWord, i) {
	                    return _react2["default"].createElement(
	                        "div",
	                        { className: "searchOut", key: i },
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/search?k=" + associateWord.name },
	                            associateWord.name
	                        )
	                    );
	                });
	        ...
	        value: function render() {
	            ...
	            var resetClasses = (0, _classnames2["default"])("reset", {
	                active: !!keyword
	            });
	            return _react2["default"].createElement(
	                "div",
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "div",
	                            { className: resetClasses, onClick: this.handleReset.bind(this) },
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            { href: "javascript:void(null)",
	                                onClick: this.props.changeScene.bind(this, "index") },
	                            "取消"
	                        )
	                    )
	                ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.purgeSearchHistory = purgeSearchHistory;

	var _libUtilEs6 = __webpack_require__(288);

	var _constantEs6 = __webpack_require__(552);

	function requestChannel(param) {
	    return {
	        type: _constantEs6.REQUEST_CHANNEL,
	        param: param
	    };
	}
	...
	function responseChannel(param, res) {
	    return {
	        type: _constantEs6.RESPONSE_CHANNEL,
	        param: param,
	        res: res
	    };
	}

	function fetchChannel(param) {
	    return function (dispatch) {
	        dispatch(requestChannel(param));
	        (0, _libUtilEs6.apiRequest)("/channel", param).then(function (res) {
	            if (res.channelFetched) {
	                var _res$result = res.result;
	                var newRecommend = _res$result.newRecommend;
	                var singleRecommend = _res$result.singleRecommend;
	...
	function requestUpdateGoods(param) {
	    return {
	        type: _constantEs6.REQUEST_UPDATEGOODS,
	        param: param
	    };
	}
	...
	function responseUpdateGoods(param, res, floor, channelId) {
	    return {
	        type: _constantEs6.RESPONSE_UPDATEGOODS,
	        res: res,
	        param: param,
	        floor: floor, channelId: channelId
	    };
	}
	...
	function updateGoods(param, floor, channelId) {
	    return function (dispatch) {
	        ...
	        (0, _libUtilEs6.apiRequest)("/updategoods", param).then(function (res) {
	...
	function fetchSingleRecommend(param, channelId) {
	...
	function fetchNewRecommend(param, channelId) {
	    param = _Object$assign({}, param, {
	        activityType: "ACTIVITY_TJ"
	    });
	    return function (dispatch) {
	...
	function requestSearchHistory(param) {
	    return {
	        type: _constantEs6.REQUEST_SEARCHHISTORY,
	        param: param
	    };
	}
	...
	function responseSearchHistory(param, res) {
	    return {
	        type: _constantEs6.RESPONSE_SEARCHHISTORY,
	        param: param,
	        res: res
	    };
	}

	function fetchSearchHistory(param) {
	    return function (dispatch) {
	        dispatch(requestSearchHistory(param));
	        (0, _libUtilEs6.apiRequest)("/searchhistory", param).then(function (res) {
	...
	function startPurgeSearchHistory(param) {
	    return {
	        type: _constantEs6.START_PURGE_SEARCHHISTORY,
	        param: param
	    };
	}
	...
	function finishPurgeSearchHistory(param, res) {
	    return {
	        type: _constantEs6.FINISH_PURGE_SEARCHHISTORY,
	        param: param,
	        res: res
	    };
	}

	function purgeSearchHistory(param) {
	    return function (dispatch) {
	        dispatch(startPurgeSearchHistory(param));
	        (0, _libUtilEs6.apiRequest)("/purgesearchhistory", param).then(function (res) {
...
/***/ function(module, exports) {
	...
	var REQUEST_SEARCHHISTORY = "REQUEST_SEARCHHISTORY";
	exports.REQUEST_SEARCHHISTORY = REQUEST_SEARCHHISTORY;
	var RESPONSE_SEARCHHISTORY = "RESPONSE_SEARCHHISTORY";
	exports.RESPONSE_SEARCHHISTORY = RESPONSE_SEARCHHISTORY;
	var START_PURGE_SEARCHHISTORY = "START_PURGE_SEARCHHISTORY";
	exports.START_PURGE_SEARCHHISTORY = START_PURGE_SEARCHHISTORY;
	var FINISH_PURGE_SEARCHHISTORY = "FINISH_PURGE_SEARCHHISTORY";

	exports.FINISH_PURGE_SEARCHHISTORY = FINISH_PURGE_SEARCHHISTORY;
	...
	var REQUEST_CHANNEL = "REQUEST_CHANNEL";
	exports.REQUEST_CHANNEL = REQUEST_CHANNEL;
	var RESPONSE_CHANNEL = "RESPONSE_CHANNEL";

	exports.RESPONSE_CHANNEL = RESPONSE_CHANNEL;
	var REQUEST_UPDATEGOODS = "REQUEST_UPDATEGOODS";
	exports.REQUEST_UPDATEGOODS = REQUEST_UPDATEGOODS;
	var RESPONSE_UPDATEGOODS = "RESPONSE_UPDATEGOODS";
	exports.RESPONSE_UPDATEGOODS = RESPONSE_UPDATEGOODS;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkIndexAppJsx = __webpack_require__(570);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(571);
	...
	var _componentJsx = __webpack_require__(572);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function search(state, action) {
	    ...
	    switch (action.type) {
	        ...
	        case _constantEs6.REQUEST_SEARCHHISTORY:
	            return _Object$assign2({}, state, {
	                historyFetched: false,
	                historyFetching: true
	            });
	        case _constantEs6.RESPONSE_SEARCHHISTORY:
	            history = action.res.result;
	            var historyFetched = action.res.isFetched;
	            return _Object$assign2({}, state, {
	                history: history,
	                historyFetched: historyFetched,
	                historyFetching: false
	            });
	        case _constantEs6.START_PURGE_SEARCHHISTORY:
	            return _Object$assign2({}, state, {
	                historyPurged: false,
	                historyPurging: true
	            });
	        case _constantEs6.FINISH_PURGE_SEARCHHISTORY:
	...
	function index(state, action) {
	    ...
	    switch (action.type) {
	        ...
	        case _constantEs6.REQUEST_CHANNEL:
	            channels = channels.map(function (channel) {
	        ...
	        case _constantEs6.RESPONSE_CHANNEL:
	            var _action$res = action.res,
	                channelFetched = _action$res.channelFetched,
	                result = _action$res.result;
	        ...
	        case _constantEs6.REQUEST_UPDATEGOODS:
	            return _Object$assign2({}, state, {
	                goodsUpdated: false,
	                goodsUpdating: true
	            });
	        case _constantEs6.RESPONSE_UPDATEGOODS:
	            if (action.res.goodsUpdated) {
	                (function () {
	                    var _channels = [];
	                    channels.forEach(function (channel) {
	                        var _channel = _Object$assign2({}, channel);
	                        if (_channel.id = action.channelId) {
	                            if (action.floor === "flashbuys") {
	                                if (_channel["floors"]["flashbuys"]) {
	                                    _channel["floors"]["flashbuys"] = _channel["floors"]["flashbuys"].map(function (flashbuy) {
	                                        flashbuy["goods"] = floorGoods(flashbuy["goods"], action.res.result);
	                                        return flashbuy;
	                                    });
	                                }
	                            } else {
	                                _channel["floors"][action.floor]["goods"] = floorGoods(_channel["floors"][action.floor]["goods"], action.res.result);
	                            }
	                        }
	...
	function floorGoods(goods, updatedGoods) {
	    var _goods = goods.map(function (good) {
	        var updatedGood = updatedGoods[good.singleCode];
	        good = _Object$assign2({}, good, updatedGood);
	        return good;
	    });
	    return _goods;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialIndexJsx = __webpack_require__(573);

	var _partialIndexJsx2 = _interopRequireDefault(_partialIndexJsx);

	var _partialSearchJsx = __webpack_require__(550);
	...
	var IndexRouter = (function (_Component) {
	    ...
	    function IndexRouter() {
	        ...
	        _get(Object.getPrototypeOf(IndexRouter.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(IndexRouter, [{
	        key: "handleSceneChange",
	        value: function handleSceneChange(currentScene, prevScene) {
	            var _props = this.props;
	            var fetchHotWord = _props.fetchHotWord;
	            var fetchSearchHistory = _props.fetchSearchHistory;
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                ...
	                { onChange: this.handleSceneChange.bind(this), scrollable: false },
	                _react2["default"].createElement(
	...
	var Index = (function (_Component) {
	    ...
	    _createClass(Index, [{
	        ...
	        value: function render() {
	            ...
	            var activeIndex = _props$index.activeIndex;

	            var classes = (0, _classnames2["default"])({
	                "index-content": true
	            });
	            var tabs = channels.map(function (channel, i) {
	                var props = _Object$assign({}, _this.props, {
	                    active: i === _this.state.activeChannel
	                });
	                var channelFetching = channel.channelFetching;

	                if (!props.active && _lodash2["default"].isEmpty(channel.floors)) {
	                    channelFetching = channelFetching || true;
	                }
	                return _react2["default"].createElement(
	                    _componentTabsJsx.TabsItem,
	                    { title: channel.name, key: i },
	                    _react2["default"].createElement(
	                        _componentGotopJsx2["default"],
	                        { relative: true },
	                        _react2["default"].createElement(_floorJsx2["default"], _extends({ channel: channel }, props)),
	                        i > 0 ? _react2["default"].createElement(_commonLoadingJsx2["default"], { active: channelFetching }) : null
	                    )
	                );
	            });
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    { navbarSlidable: true, onSelect: this.handleSelect.bind(this) },
	                    tabs
	                ),
	                _react2["default"].createElement(_footerJsx2["default"], { activeIndex: "0" })
	            );
	        }
	    }]);
	    ...
	    _createClass(Header, [{
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement("a", { className: "indexSearch", href: "javascript:void(null)",
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/", className: activeIndex === "0" ? "nav_hover" : null },
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/polymer", className: activeIndex === "1" ? "nav_hover" : null },
	                            _react2["default"].createElement("i", null),
	                            "分类"
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/trendy", className: activeIndex === "2" ? "nav_hover" : null },
	                            _react2["default"].createElement("i", null),
	                            "爆款"
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/cart", className: activeIndex === "3" ? "nav_hover" : null },
	                            _react2["default"].createElement("i", null),
	                            "购物车"
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/membercenter", className: activeIndex === "4" ? "nav_hover" : null },
	                            _react2["default"].createElement("i", null),
	                            "个人中心"
	                        )
	                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentImageJsx = __webpack_require__(577);

	var _componentImageJsx2 = _interopRequireDefault(_componentImageJsx);

	var _componentScrollspyJsx = __webpack_require__(578);

	var _componentScrollspyJsx2 = _interopRequireDefault(_componentScrollspyJsx);
	...
	var Floor = (function (_Component) {
	    ...
	    _createClass(Floor, [{
	        ...
	        key: "updateFlashbuyGoods",
	        value: function updateFlashbuyGoods() {
	            var flashbuys = this.props.channel.floors.flashbuys;

	            var ids = [];
	            if (flashbuys) {
	                flashbuys.forEach(function (flashbuy) {
	                    flashbuy.goods.forEach(function (good) {
	        ...
	        value: function componentDidUpdate(prevProps) {
	            if (this.props.active && !prevProps.active) {
	                if (_lodash2["default"].isEmpty(this.props.channel.floors)) {
	                    var _props = this.props;
	                    var fetchChannel = _props.fetchChannel;
	        ...
	        value: function handleActive() {
	            ...
	            var fetchNewRecommend = _props2.fetchNewRecommend;
	            var fetchSingleRecommend = _props2.fetchSingleRecommend;
	            var _props$channel$floors = this.props.channel.floors;
	            var newRecommend = _props$channel$floors.newRecommend;
	            var singleRecommend = _props$channel$floors.singleRecommend;
	        ...
	        value: function renderSingleRecommend() {
	            var singleRecommend = this.props.channel.floors.singleRecommend;

	            if (singleRecommend && singleRecommend.goods && singleRecommend.goods.length > 0) {
	                var goods = singleRecommend.goods.map(function (good, i) {
	                    var destPrice = (0, _libUtilEs6.destPriceForGoods)(good).destPrice;
	                    var saleState = (0, _classnames2["default"])({
	                        "sale-out": good.stock === 0,
	                        "put-off": good.isOff === true
	                    });
	                    return _react2["default"].createElement(
	                        "a",
	                        { href: "/gooddetail/" + good.singleCode, className: "clearfix", key: i },
	                        _react2["default"].createElement("div", { className: saleState }),
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                { className: "nowPrice" },
	                                "¥",
	                                (0, _libUtilEs6.formatPrice)(destPrice)
	                            ),
	                            _react2["default"].createElement(
	                                "span",
	                                { className: "oldPrice" },
	        ...
	        value: function renderNewRecommend() {
	            var newRecommend = this.props.channel.floors.newRecommend;

	            if (newRecommend && newRecommend.goods && newRecommend.goods.length > 0) {
	                var goods = newRecommend.goods.map(function (good, i) {
	                    var destPrice = (0, _libUtilEs6.destPriceForGoods)(good).destPrice;
	                    var saleState = (0, _classnames2["default"])({
	                        "sale-out": good.stock === 0,
	                        "put-off": good.isOff === true
	        ...
	        value: function renderSlider() {
	            var slides = this.props.channel.floors.slides;
	        ...
	        value: function renderBadges() {
	            var badges = this.props.channel.floors.badges;

	            if (badges && badges.length > 0) {
	                badges = badges.map(function (badge, i) {
	                    return _react2["default"].createElement(
	                        "a",
	                        { href: badge.jumpUrl, key: i },
	                        _react2["default"].createElement(
	                            "span",
	                            null,
	                            _react2["default"].createElement("img", { src: badge.imageUrl }),
	                            _react2["default"].createElement(
	                                "p",
	                                null,
	                                badge.title
	        ...
	        value: function renderRushBuy() {
	            var rushbuys = this.props.channel.floors.rushbuys;
	            ...
	            if (rushbuys) {
	                return rushbuys.map(function (rushbuy, i) {
	                    var timer = _react2["default"].createElement(
	                        ...
	                        "距本期活动结束：",
	                        _react2["default"].createElement(_commonTimerJsx2["default"], { endTime: rushbuy.endTime, dayEnable: true,
	                            template: "<%= day %>天<%= hour %>时<%= minute %>分<%= second %>秒" })
	                    );
	                    var validTime = (0, _libUtilEs6.validTimeRegion)(rushbuy.startTime, rushbuy.endTime);
	                    if (validTime === -1) {
	                        timer = _react2["default"].createElement(
	                            ...
	                            "距本期活动开始：",
	                            _react2["default"].createElement(_commonTimerJsx2["default"], { endTime: rushbuy.startTime, dayEnable: true,
	                                template: "<%= day %>天<%= hour %>时<%= minute %>分<%= second %>秒" })
	                        );
	                    } else if (validTime === 1) {
	                        timer = _react2["default"].createElement(
	                    ...
	                    return _react2["default"].createElement(
	                        "a",
	                        { href: rushbuy.jumpUrl, key: i },
	                        _react2["default"].createElement("image", { src: rushbuy.imageUrl }),
	                        timer
	                    );
	                });
	            }
	        ...
	        value: function renderFlashBuy() {
	            var _props$channel$floors2 = this.props.channel.floors;
	            var flashbuys = _props$channel$floors2.flashbuys;
	            var flashbuyId = _props$channel$floors2.flashbuyId;

	            if (flashbuys) {
	                var goods = null;
	                flashbuys = flashbuys.forEach(function (flashbuy, i) {
	                    var validTime = (0, _libUtilEs6.validTimeRegion)(flashbuy.startTime, flashbuy.endTime);
	                    if (validTime === 0) {
	                        goods = flashbuy.goods.map(function (good, i) {
	                            var timer = _react2["default"].createElement(
	                                "p",
	                                null,
	                                "距本期闪购结束",
	                                _react2["default"].createElement(
	                                    "em",
	                                    null,
	                                    _react2["default"].createElement(_commonTimerJsx2["default"], { endTime: good.endTime, dayEnable: true,
	                                        template: "<i><%= day %></i>天<i><%= hour %></i>时<i><%= minute %></i>分<i><%= second %></i>秒" })
	                                )
	                            );
	                            var validTime = (0, _libUtilEs6.validTimeRegion)(good.startTime, good.endTime);
	                            if (validTime === -1) {
	                                timer = _react2["default"].createElement(
	                                    "p",
	                                    null,
	                                    ...
	                                    _react2["default"].createElement(
	                                        "em",
	                                        null,
	                                        _react2["default"].createElement(_commonTimerJsx2["default"], { endTime: good.startTime, dayEnable: true,
	                                            template: "<i><%= day %></i>天<i><%= hour %></i>时<i><%= minute %></i>分<i><%= second %></i>秒" })
	                                    )
	                                );
	                            } else if (validTime === 1) {
	        ...
	        value: function renderActivityOne() {
	            var activityOne = this.props.channel.floors.activityOne;
	                ...
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "a",
	                                { href: activityOne[0].jumpUrl },
	                                _react2["default"].createElement("img", { src: activityOne[0].imageUrl, alt: "" }),
	                                _react2["default"].createElement("span", null)
	                            )
	                        ),
	                        _react2["default"].createElement(
	                            "li",
	                            null,
	                            activityOne[1] ? _react2["default"].createElement(
	                                "a",
	                                { href: activityOne[1].jumpUrl },
	                                _react2["default"].createElement("img", { src: activityOne[1].imageUrl, alt: "" }),
	                                _react2["default"].createElement("span", null)
	                            ) : null,
	                            activityOne[2] ? _react2["default"].createElement(
	                                "a",
	                                { href: activityOne[2].jumpUrl },
	                                _react2["default"].createElement("img", { src: activityOne[2].imageUrl, alt: "" }),
	                                _react2["default"].createElement("span", null)
	                            ) : null
	                        )
	                    )
	        ...
	        value: function renderActivityTwo() {
	            var activityTwo = this.props.channel.floors.activityTwo;
	        ...
	        value: function renderActivityThree() {
	            var activityThree = this.props.channel.floors.activityThree;
	                ...
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "clearfix" },
	                            activityThree[1] ? _react2["default"].createElement(
	                                "a",
	                                { href: activityThree[1].jumpUrl },
	                                _react2["default"].createElement("img", { src: activityThree[1].imageUrl, alt: "" })
	                            ) : null,
	                            activityThree[2] ? _react2["default"].createElement(
	                                "a",
	                                { href: activityThree[2].jumpUrl },
	                                _react2["default"].createElement("img", { src: activityThree[2].imageUrl, alt: "" })
	                            ) : null
	                        ),
	                        activityThree[3] ? _react2["default"].createElement(
	                            "a",
	                            { href: activityThree[3].jumpUrl },
	        ...
	        key: "render",
	        value: function render() {
	            var channelFetching = this.props.channel.channelFetching;

	            if (!this.props.active && _lodash2["default"].isEmpty(this.props.channel.floors)) {
	                channelFetching = channelFetching || true;
	            }
	            return _react2["default"].createElement(
	                "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Image = (function (_Component) {
	    ...
	    _createClass(Image, [{
	        ...
	        key: "componentDidMount",
	        value: function componentDidMount() {
	            var imgNode = _reactDom2["default"].findDOMNode(this);
	        ...
	        value: function render() {
	            ...
	            var src = this.props.placeholder;
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "div",
	                    { key: src, className: "image-container" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScrollSpy = (function (_Component) {
	    ...
	    function ScrollSpy(props, context) {
	        ...
	        _get(Object.getPrototypeOf(ScrollSpy.prototype), "constructor", this).call(this, props, context);
	        this.state = {
	            inViewport: false
	        };
	    }
	    ...
	    _createClass(ScrollSpy, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            _libDomEs62["default"].bindEvent(this.getScrollElement(), "scroll", this.checkVisble.bind(this));
	        }
	    }, {
	        key: "componentWillUnmount",
	        value: function componentWillUnmount() {
	            _libDomEs62["default"].unbindEvent(this.getScrollElement(), "scroll", this.checkVisble.bind(this));
	            if (this._timer) {
	                clearTimeout(this._timer);
	            }
	        }
	        ...
	        key: "checkVisble",
	        value: function checkVisble() {
	            var _this = this;

	            // if(this.isMounted){
	            var _props = this.props;
	            var diffInViewport = _props.diffInViewport;
	            var scrollBy = _props.scrollBy;

	            var checkNode = _reactDom2["default"].findDOMNode(this);
	            var scrollNode = document.querySelector(scrollBy);
	            var isVisible = _libDomEs62["default"].inViewport(checkNode, scrollNode, diffInViewport);
	        ...
	        key: "render",
	        value: function render() {
	            var animation = this.state.inViewport ? this.props.animation : null;
	            var child = _react2["default"].Children.only(this.props.children);
	            return _react2["default"].cloneElement(child, _Object$assign({}, child.props, {
	                className: (0, _classnames2["default"])(child.props.className, animation),
