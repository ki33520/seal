...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkCouponAppJsx = __webpack_require__(486);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(487);
	...
	var _componentJsx = __webpack_require__(489);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(496);

	var actions = _interopRequireWildcard(_actionEs6);

	var CouponConnected = (0, _reactRedux.connect)(function (state) {
	    return state;
	...
	var CouponApp = (function (_Component) {
	    ...
	    _createClass(CouponApp, [{
	        ...
	        value: function render() {
	            ...
	            var couponType = _props$initialState.couponType;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantEs6 = __webpack_require__(488);

	function index(state, action) {
	    if (state === undefined) state = {};

	    switch (action.type) {
	        case _constantEs6.START_FETCH_COUPON:
	            return _Object$assign({}, state, {
	                isFetching: true,
	                isFetched: false,
	                isLoading: action.param.isLoading
	            });
	        case _constantEs6.FINISH_FETCH_COUPON:
	            var type = action.param.type;
	            var res = action.res;
	            var pagination = _extends({}, state.pagination);
	            var coupons = _.union(pagination[type].coupons, res.coupons);
	...
	function detail(state, action) {
	    ...
	    switch (action.type) {
	        case _constantEs6.START_FETCH_DETAIL:
	            return _Object$assign({}, state, {
	                isFetching: true,
	                isFetched: false,
	                coupon: null
	            });
	        case _constantEs6.FINISH_FETCH_DETAIL:
	            return _Object$assign({}, state, {
	                isFetching: false,
	                isFetched: true,
	                coupon: action.res
...
/***/ function(module, exports) {
	...
	var FINISH_FETCH_COUPON = "FINISH_FETCH_COUPON";
	exports.FINISH_FETCH_COUPON = FINISH_FETCH_COUPON;
	var START_FETCH_DETAIL = "START_FETCH_DETAIL";
	exports.START_FETCH_DETAIL = START_FETCH_DETAIL;
	var FINISH_FETCH_DETAIL = "FINISH_FETCH_DETAIL";
	exports.FINISH_FETCH_DETAIL = FINISH_FETCH_DETAIL;
	var FETCH_COUPON_ID = "FETCH_COUPON_ID";
	exports.FETCH_COUPON_ID = FETCH_COUPON_ID;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialIndexJsx = __webpack_require__(490);

	var _partialIndexJsx2 = _interopRequireDefault(_partialIndexJsx);

	var _partialDetailJsx = __webpack_require__(494);

	var _partialDetailJsx2 = _interopRequireDefault(_partialDetailJsx);

	var _partialRulesJsx = __webpack_require__(495);
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "detail" },
	                    _react2["default"].createElement(_partialDetailJsx2["default"], this.props)
	                )
	            );
	        }
	    }]);
	...
	var Coupon = (function (_React$Component) {
	    ...
	    _createClass(Coupon, [{
	        ...
	        value: function handleClick(index) {
	            ...
	            var pagination = _props$index.pagination;
	            var couponType = _props$index.couponType;

	            var type = couponType[index];
	            var _pagination$type = pagination[type];
	            var coupons = _pagination$type.coupons;
	            var pageIndex = _pagination$type.pageIndex;
	            var totalPage = _pagination$type.totalPage;
	        ...
	        value: function beginRefresh() {
	            ...
	            var pagination = _props$index2.pagination;
	            var couponType = _props$index2.couponType;
	            var isFetching = _props$index2.isFetching;

	            var index = this.state.activeIndex;
	            var type = couponType[index];
	            var totalPage = pagination[type].totalPage;
	            var pageIndex = Number(pagination[type].pageIndex);
	        ...
	        key: "fetchCouponsByParam",
	        value: function fetchCouponsByParam(couponType, pageIndex, isLoading) {
	        ...
	        key: "renderYouaCoupons",
	        value: function renderYouaCoupons(coupons) {
	            var _this = this;

	            if (coupons && coupons.length) {
	                return coupons.map(function (item, i) {
	                    return _this.renderYouaCoupon(item, 'y-' + i);
	                });
	            } else {
	        ...
	        key: "renderInvalidCoupons",
	        value: function renderInvalidCoupons(coupons) {
	            var _this2 = this;

	            if (coupons && coupons.length) {
	                return coupons.map(function (item, i) {
	                    return _this2.renderYouaCoupon(item, 'iy-' + i);
	                });
	            } else {
	        ...
	        key: "renderNoCoupon",
	        value: function renderNoCoupon(message) {
	            return _react2["default"].createElement(
	                "div",
	                { className: "empty" },
	        ...
	        key: "renderYouaCoupon",
	        value: function renderYouaCoupon(coupon, i) {
	            var canUse = !(coupon.used || coupon.expiried);
	            var row = (0, _classnames2["default"])("coupon", {
	                "youa-invalid": !canUse,
	                "haitao": canUse
	            });
	            var status = (0, _classnames2["default"])({
	                used: coupon.used,
	        ...
	        value: function render() {
	            ...
	            var pagination = _props$index3.pagination;
	            var couponType = _props$index3.couponType;
	            var isFetching = _props$index3.isFetching;
	            var isLoading = _props$index3.isLoading;

	            var index = this.state.activeIndex;
	            var type = couponType[index];
	            var totalPage = Number(pagination[type].totalPage);
	            var pageIndex = Number(pagination[type].pageIndex);
	            return _react2["default"].createElement(
	                "div",
	                ...
	                _react2["default"].createElement(
	                    ...
	                    { axis: "x", navbarSlidable: false, onSelect: this.handleClick.bind(this) },
	                    _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(_commonLoadingJsx2["default"], { active: isLoading })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CouponDetail = (function (_Component) {
	    ...
	    _createClass(CouponDetail, [{
	        ...
	        key: "renderQRcode",
	        value: function renderQRcode(coupon) {
	            if (coupon && coupon.qrCode) {
	                return _react2["default"].createElement(
	                    "div",
	                    { className: "qr" },
	                    _react2["default"].createElement("img", { src: "/client/asset/images/qr.png" }),
	        ...
	        key: "renderDetail",
	        value: function renderDetail(coupon) {
	            if (coupon) {
	                return _react2["default"].createElement(
	                    "div",
	                    null,
	        ...
	        value: function render() {
	            ...
	            var coupon = _props$detail.coupon;
	            var isFetching = _props$detail.isFetching;
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    _commonHeaderJsx2["default"],
	                    { onGoBack: this.handleBack.bind(this) },
	                    _react2["default"].createElement(
	                        "span",
	                        { className: "title" },
	                        "优惠券详情"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CouponRules = (function (_Component) {
	    ...
	    _createClass(CouponRules, [{
	        key: "handleBack",
	        value: function handleBack() {
	            var couponNo = this.props.rule.couponNo;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchCouponDetail = fetchCouponDetail;
	exports.fetchCouponId = fetchCouponId;
	...
	function requestCoupon(param) {
	    return {
	        type: _constantEs6.START_FETCH_COUPON,
	        param: param
	    };
	}
	...
	function receiveCoupon(param, res) {
	    return {
	        type: _constantEs6.FINISH_FETCH_COUPON,
	        res: res,
	        param: param
	    };
	}
	...
	function startFetchCouponDetail(param) {
	    return {
	        type: _constantEs6.START_FETCH_DETAIL,
	        param: param
	    };
	}
	function finishFetchCouponDetail(param, res) {
	    return {
	        type: _constantEs6.FINISH_FETCH_DETAIL,
	        param: param,
	        res: res
	    };
	}

	function fetchCoupons(param) {
	    return function (dispatch) {
	        dispatch(requestCoupon(param));
	        (0, _libUtilEs6.apiRequest)('/coupon', param).then(function (res) {
	            dispatch(receiveCoupon(param, res));
	        });
	    };
	}

	function fetchCouponDetail(param) {
	    return function (dispatch) {
	        dispatch(startFetchCouponDetail(param));
	        (0, _libUtilEs6.apiRequest)('/coupon/' + param.id, {}).then(function (res) {
	            dispatch(finishFetchCouponDetail(param, res));
	        });
	    };
	}

	function fetchCouponId(param) {
	    return {
	        type: _constantEs6.FETCH_COUPON_ID,
	        param: param
	    };
	}
