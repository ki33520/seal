	    ...
	    _createClass(OrderDetailRouter, [{
	        ...
	        value: function render() {
	            ...
	            if (currentRoute === "index") {
	                currentView = _react2["default"].createElement(_partialOrderdetailJsx2["default"], _extends({}, this.props, { key: currentRoute }));
	            } else if (currentRoute === "logistics") {
	                currentView = _react2["default"].createElement(_partialLogisticsJsx2["default"], _extends({}, this.props, { key: currentRoute }));
	            }
