...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkOrderdetailAppJsx = __webpack_require__(620);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(621);
	...
	var _componentJsx = __webpack_require__(623);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(622);
	...
	var OrderDetailApp = (function (_Component) {
	    _inherits(OrderDetailApp, _Component);
	    ...
	    _createClass(OrderDetailApp, [{
	        ...
	        value: function render() {
	            ...
	            var back_path = _props$initialState.back_path;
	            var systemTime = _props$initialState.systemTime;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function orderByParam(state, action) {
	    ...
	    switch (action.type) {
	        case _actionEs6.CHANGE_ORDER:
	            var order = _extends({}, state.order);
	        ...
	        case _actionEs6.CHANGE_FIELD:
	            ...
	            var order = _extends({}, state.order);
	            if (pid !== undefined) {
	                order.itemList.forEach(function (v, k) {
	                    if (v.id === pid) {
	                        v[name] = value;
	                    }
	                });
	        ...
	        case _actionEs6.REQUEST_ORDER:
	            return _Object$assign({}, state, {
	                orderChanging: true,
	                orderChanged: false,
	                msg: action.res ? action.res.msg : null
	            });
	        case _actionEs6.RESPONSE_ORDER:
	            return _Object$assign({}, state, {
	                orderChanging: false,
	                orderChanged: action.res.isFetched,
	                msg: action.res ? action.res.msg : null
	            }, action.res);
	        case _actionEs6.REQUEST_SAVECOMMENT:
	            return _Object$assign({}, state, {
	                saveCommentChanging: true,
	                saveCommentChanged: false,
	                msg: action.res ? action.res.msg : null
	            });
	        case _actionEs6.RESPONSE_SAVECOMMENT:
	        ...
	        case _actionEs6.REQUEST_ClOSEORDER:
	            return _Object$assign({}, state, {
	                closeOrderChanging: true,
	                closeOrderChanged: false,
	                msg: action.res ? action.res.msg : null
	            });
	        case _actionEs6.RESPONSE_ClOSEORDER:
	        ...
	        case _actionEs6.REQUEST_DELIVERYORDER:
	            return _Object$assign({}, state, {
	                deliveryOrderChanging: true,
	                deliveryOrderChanged: false,
	                msg: action.res ? action.res.msg : null
	            });
	        case _actionEs6.RESPONSE_DELIVERYORDER:
	            state.order.orderStatus = action.res.orderStatus ? action.res.orderStatus : state.order.orderStatus;
	        ...
	        case _actionEs6.REQUEST_PAYGATEWAY:
	            return _Object$assign({}, state, {
	                paygatewayFetching: true,
	                paygatewayFetched: false
	            });
	        case _actionEs6.RESPONSE_PAYGATEWAY:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchCloseOrder = fetchCloseOrder;
	...
	var RESPONSE_ORDER = "RESPONSE_ORDER";
	exports.RESPONSE_ORDER = RESPONSE_ORDER;
	var REQUEST_SAVECOMMENT = "REQUEST_SAVECOMMENT";
	exports.REQUEST_SAVECOMMENT = REQUEST_SAVECOMMENT;
	var RESPONSE_SAVECOMMENT = "RESPONSE_SAVECOMMENT";
	exports.RESPONSE_SAVECOMMENT = RESPONSE_SAVECOMMENT;
	...
	var REQUEST_ClOSEORDER = "REQUEST_ClOSEORDER";
	exports.REQUEST_ClOSEORDER = REQUEST_ClOSEORDER;
	var RESPONSE_ClOSEORDER = "RESPONSE_ClOSEORDER";
	exports.RESPONSE_ClOSEORDER = RESPONSE_ClOSEORDER;
	var REQUEST_DELIVERYORDER = "REQUEST_DELIVERYORDER";
	exports.REQUEST_DELIVERYORDER = REQUEST_DELIVERYORDER;
	var RESPONSE_DELIVERYORDER = "RESPONSE_DELIVERYORDER";
	exports.RESPONSE_DELIVERYORDER = RESPONSE_DELIVERYORDER;
	...
	exports.CHANGE_ORDER = CHANGE_ORDER;
	...
	function changeField(name, value, pid) {
	    return {
	        type: CHANGE_FIELD,
	        name: name,
	        value: value,
	...
	function saveComment(url, param) {
	    return function (dispatch) {
	...
	function fetchCloseOrder(url, param) {
	    return function (dispatch) {
	...
	function fetchDeliveryOrder(url, param) {
	    return function (dispatch) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialOrderdetailJsx = __webpack_require__(624);

	var _partialOrderdetailJsx2 = _interopRequireDefault(_partialOrderdetailJsx);

	var _partialLogisticsJsx = __webpack_require__(627);

	var _partialLogisticsJsx2 = _interopRequireDefault(_partialLogisticsJsx);

	var _partialCommentJsx = __webpack_require__(628);

	var _partialCommentJsx2 = _interopRequireDefault(_partialCommentJsx);

	var _director = __webpack_require__(565);

	var _commonSwitcherJsx = __webpack_require__(566);
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    { name: "index" },
	                    _react2["default"].createElement(_partialOrderdetailJsx2["default"], _extends({}, this.state, this.props))
	                ),
	                _react2["default"].createElement(
	                    _commonSwitcherJsx.SwitcherCase,
	                    { name: "logistics" },
	                    _react2["default"].createElement(_partialLogisticsJsx2["default"], _extends({}, this.state, this.props))
	                ),
	                _react2["default"].createElement(
	                    _commonSwitcherJsx.SwitcherCase,
	                    { name: "comment" },
	                    _react2["default"].createElement(_partialCommentJsx2["default"], _extends({}, this.state, this.props))
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _statusprogressJsx = __webpack_require__(625);

	var _statusprogressJsx2 = _interopRequireDefault(_statusprogressJsx);

	var _ordergoodsJsx = __webpack_require__(626);
	...
	var OrderDetail = (function (_Component) {
	    ...
	    _createClass(OrderDetail, [{
	        ...
	        value: function renderAddress(order) {
	            var _order$receiverObject = order.receiverObject;
	            var receiverName = _order$receiverObject.receiverName;
	            var receiverMobile = _order$receiverObject.receiverMobile;
	            var receiverProvince = _order$receiverObject.receiverProvince;
	            var receiverCity = _order$receiverObject.receiverCity;
	            var receiverDistrict = _order$receiverObject.receiverDistrict;
	            var receiverAddress = _order$receiverObject.receiverAddress;
	        ...
	        key: "handleDeliveryOrder",
	        value: function handleDeliveryOrder(e) {
	            var _this = this;

	            e && e.preventDefault();
	            var fetchDeliveryOrder = this.props.fetchDeliveryOrder;
	            var order = this.props.orderByParam.order;
	        ...
	        key: "handleCloseOrder",
	        value: function handleCloseOrder(e) {
	            var _this2 = this;

	            e && e.preventDefault();
	            var fetchCloseOrder = this.props.fetchCloseOrder;
	            var order = this.props.orderByParam.order;
	            var orderNo = order.orderNo;
	        ...
	        key: "handlePayGateway",
	        value: function handlePayGateway(e) {
	            e && e.preventDefault();
	            var fetchPayGateway = this.props.fetchPayGateway;
	            var order = this.props.orderByParam.order;
	            var orderNo = order.orderNo;
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            var fetchOrder = _props.fetchOrder;
	            var _props$orderByParam = this.props.orderByParam;
	            var order = _props$orderByParam.order;
	            var alertContent = _props$orderByParam.alertContent;
	            var orderId = order.orderId;

	            if (nextProps.orderByParam.closeOrderChanging === false && this.props.orderByParam.closeOrderChanging === true) {
	            ...
	            if (nextProps.orderByParam.deliveryOrderChanging === false && this.props.orderByParam.deliveryOrderChanging === true) {
	            ...
	            if (nextProps.orderByParam.saveCommentChanging === false && this.props.orderByParam.saveCommentChanging === true) {
	        ...
	        value: function componentDidUpdate(prevProps, prevState) {
	            ...
	            if (prevProps.orderByParam.paygatewayFetched === false && this.props.orderByParam.paygatewayFetched === true) {
	                setTimeout(function () {
	                    _reactDom2["default"].findDOMNode(_this3.refs["submitForm"]).submit();
	                }, 1000);
	            }
	        }
	    }, {
	        ...
	        value: function renderFooter() {
	            ...
	            var hasNotComment = _lodash2["default"].filter(itemList, function (o) {
	                return !o.hasComment;
	            });
	            switch (orderStatus) {
	                case "STATUS_NOT_PAY":
	                    var cashierParam = order.cashierParam;
	                    ...
	                    return _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(null);", onClick: this.handleCloseOrder.bind(this), className: "confirm_btn confirmBorder_btn" },
	                            "取消订单"
	                        ),
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(null)", onClick: this.handlePayGateway.bind(this), className: "confirm_btn" },
	                            "立即支付"
	                        ),
	                        _react2["default"].createElement(
	                            "form",
	                ...
	                case "STATUS_OUT_HOUSE":
	                    return _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/orderdetail/" + orderId + "#/logistics", className: "confirm_btn confirmBorder_btn" },
	                            "查看物流"
	                        ),
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(null);", onClick: this.handleDeliveryOrder.bind(this), className: "confirm_btn" },
	                            "确认收货"
	                        )
	                    );
	                case "STATUS_FINISHED":
	                    if (hasNotComment.length > 0) {
	                        return _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "a",
	                                { href: "/orderdetail/" + orderId + "#/comment", className: "confirm_btn confirmBorder_btn" },
	                                "评价晒单"
	                            )
	                        );
	                    } else {
	        ...
	        value: function timeOut() {
	            var changeOrder = this.props.changeOrder;
	            var order = this.props.orderByParam.order;
	        ...
	        key: "renderOutTime",
	        value: function renderOutTime() {
	            var _props$orderByParam2 = this.props.orderByParam;
	            var order = _props$orderByParam2.order;
	            var systemTime = _props$orderByParam2.systemTime;
	            var orderCrtTime = order.orderCrtTime;
	            var timeoutTime = order.timeoutTime;
	            var orderStatus = order.orderStatus;

	            var currentTime = (0, _moment2["default"])(new Date(systemTime));
	            var outTime = (0, _moment2["default"])(new Date(timeoutTime));

	            if (orderStatus === "STATUS_NOT_PAY" && timeoutTime) {
	                return _react2["default"].createElement(
	                    "span",
	                    null,
	                    _react2["default"].createElement(_commonTimerJsx2["default"], { onTimerExpire: this.timeOut.bind(this), endTime: outTime, referTime: currentTime, template: "<i><%= hour %></i>:<i><%= minute %></i>:<i><%= second %></i>" }),
	                    _react2["default"].createElement(
	                        "i",
	                        null,
	                        "后自动取消"
	        ...
	        key: "renderCountbox",
	        value: function renderCountbox() {
	            var order = this.props.orderByParam.order;
	            var orderStatus = order.orderStatus;

	            var logisticsFeeBox = order.logisticsFee === 0 ? _react2["default"].createElement(
	                "div",
	                { className: "red-box" },
	                "包邮"
	            ) : null;
	            var abroadFeeBox = order.abroadFee === 0 ? _react2["default"].createElement(
	                "div",
	                { className: "red-box" },
	                "包邮"
	            ) : null;
	            var tariffFeeBox = order.tariffFee === 0 ? _react2["default"].createElement(
	                "div",
	                { className: "red-box" },
	                "免税"
	            ) : null;
	            ...
	            if (orderStatus === "STATUS_CANCELED") {
	                ...
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "bottom-line clearfix" },
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "label" },
	                            "商品总价："
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "span",
	                                null,
	                                (0, _libUtilEs6.formatPrice)(order.salesTotalFee)
	                            )
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "span",
	                                null,
	                                (0, _libUtilEs6.formatPrice)(order.logisticsFee)
	                            )
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "span",
	                                null,
	                                (0, _libUtilEs6.formatPrice)(order.abroadFee)
	                            )
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "span",
	                                null,
	                                (0, _libUtilEs6.formatPrice)(order.tariffFee)
	                            )
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "bottom-line clearfix intro" },
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "label" },
	                            "优惠活动："
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "span",
	                                null,
	                                (0, _libUtilEs6.formatPrice)(order.promoFee)
	                            )
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "span",
	                                { id: "coupon_money" },
	                                (0, _libUtilEs6.formatPrice)(order.couponFee)
	                            )
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "bottom-line clearfix no-border" },
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "label" },
	                            paymentTitle
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                (0, _libUtilEs6.formatPrice)(order.paymentFee)
	                            )
	                        )
	                    )
	                );
	        ...
	        key: "render",
	        value: function render() {
	            var _props$orderByParam3 = this.props.orderByParam;
	            var order = _props$orderByParam3.order;
	            var back_path = _props$orderByParam3.back_path;
	            var alertActive = _props$orderByParam3.alertActive;
	            var alertContent = _props$orderByParam3.alertContent;

	            var back_url = back_path === null ? "/orderlist" : "/orderlist/" + back_path;
	            var class_detail = (0, _classnames2["default"])({
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "header",
	                    { className: "header" },
	                    _react2["default"].createElement("a", { href: back_url, className: "iconfont icon-back" }),
	                    _react2["default"].createElement(
	                        "span",
	                        { className: "title" },
	                        "订单详情"
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(_statusprogressJsx2["default"], _extends({ renderOutTime: this.renderOutTime.bind(this) }, order)),
	                    this.renderAddress(order),
	                    _react2["default"].createElement(_ordergoodsJsx2["default"], order),
	                    this.renderCountbox()
	                ),
	                this.renderFooter(),
	                _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StatusProgress = (function (_Component) {
	    ...
	    _createClass(StatusProgress, [{
	        ...
	        value: function render() {
	            var _props = this.props;
	            var orderStatusArr = _props.orderStatusArr;
	            var orderStatus = _props.orderStatus;
	            var renderOutTime = _props.renderOutTime;
	            var orderNo = _props.orderNo;

	            var imgUrl = undefined;
	            var rateText = [];
	            rateText = orderStatusArr.map(function (v, k) {
	                if (v.active === true) {
	                    ...
	                    if (orderStatus === "STATUS_CANCELED") {
	                        if (k === 0) {
	                            ...
	                            return _react2["default"].createElement("span", { key: k });
	                        }
	                    } else {
	                        return _react2["default"].createElement(
	                            "span",
	                            { key: k, className: "notTo" },
	                            v.text
	                        );
	                    }
	                }
	    ...
	    _createClass(OrderGoods, [{
	        ...
	        value: function renderGoods() {
	            ...
	            if (itemList.length > 0) {
	                var goodItems = itemList.map(function (v, k) {
	                    return _react2["default"].createElement(
	                        "div",
	                        { className: "clearfix", key: k },
	                        _react2["default"].createElement(
	                            "a",
	                            { className: "J_ytag cartlist", href: "/gooddetail/" + v.singleCode },
	                            _react2["default"].createElement(
	                                "span",
	                                { className: "img_wrap" },
	                                _react2["default"].createElement("img", { src: v.singleImageUrl })
	                            )
	                        ),
	                        _react2["default"].createElement(
	                            "div",
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                (0, _libUtilEs6.formatPrice)(v.salesPrice),
	                                _react2["default"].createElement(
	                                    "i",
	                                    { className: "x" },
	                                    "×"
	        ...
	        value: function render() {
	            var _props = this.props;
	            var productFee = _props.productFee;
	            var sendWareHouseName = _props.sendWareHouseName;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Logistics = (function (_Component) {
	    ...
	    function Logistics(props) {
	        ...
	        _get(Object.getPrototypeOf(Logistics.prototype), "constructor", this).call(this, props);
	        this.state = {
	            activeIndex: 0
	        };
	    }
	    ...
	    _createClass(Logistics, [{
	        key: "componentDidMount",
	        value: function componentDidMount() {
	            var fetchLogistics = this.props.fetchLogistics;
	            var order = this.props.orderByParam.order;
	        ...
	        key: "renderTrace",
	        value: function renderTrace(routes) {
	            if (routes.length > 0) {
	                return _react2["default"].createElement(
	                    "div",
	                    { className: "org-wuliuStatusList" },
	                    routes.map(function (v, k) {
	                        ...
	                        return _react2["default"].createElement(
	                            "div",
	                            { className: classes, key: k },
	                            _react2["default"].createElement(
	                                "div",
	                                { className: "org-wuLiuLeft" },
	                                _react2["default"].createElement("em", { className: "org-middle" })
	                            ),
	                            _react2["default"].createElement(
	                                "p",
	                                { className: "org-wuLiuFont org-wuLiuCur" },
	                                _react2["default"].createElement(
	                                    "span",
	                                    null,
	                                    v.context
	                                ...
	                                _react2["default"].createElement(
	                                    "span",
	                                    { className: "org-wuLiuTime" },
	                                    (0, _moment2["default"])(new Date(v.eventTime)).format("YYYY-MM-DD HH:mm:ss")
	                                )
	                            )
	                        );
	                    })
	                ...
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "org-wuliuStatus org-starBg org-curBg" },
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "org-wuLiuLeft" },
	                            _react2["default"].createElement("em", { className: "org-middle" })
	        ...
	        value: function renderContent(item) {
	            return _react2["default"].createElement(
	                "div",
	                { className: "logistics page-0 page-current" },
	                _react2["default"].createElement(
	                    "div",
	                    { className: "info" },
	                    _react2["default"].createElement(
	        ...
	        value: function render() {
	            ...
	            var _props$orderByParam = this.props.orderByParam;
	            var logistics = _props$orderByParam.logistics;
	            var order = _props$orderByParam.order;
	            var back_path = _props$orderByParam.back_path;

	            var back_url = back_path === null ? null : "/orderlist/" + back_path;
	            ...
	            var cnNumbers = ["一", "二", "三", "四", "五", "六", "七", "八", "九"];
	            var tabs = parcel.map(function (item, i) {
	                return _react2["default"].createElement(
	            ...
	            var slideTabs = _react2["default"].createElement(
	                _componentSlidetabsJsx.SlideTabs,
	                { axis: "x", onSelect: this.handleClick.bind(this), navbarSlidable: false },
	                tabs
	            );
	            if (parcel.length > 0) {
	                content = slideTabs;
	            ...
	            if (currentRoute === "logistics") {
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        { canBack: !back_url },
	                        back_url ? _react2["default"].createElement("a", { href: back_url, className: "iconfont icon-back" }) : back_url,
	                        _react2["default"].createElement(
	                            "span",
	                            { className: "title" },
	                            "物流信息"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Comment = (function (_Component) {
	    ...
	    _createClass(Comment, [{
	        key: "handleStar",
	        value: function handleStar(name, pid, val, e) {
	        ...
	        key: "handleContent",
	        value: function handleContent(name, pid, e) {
	            var changeField = this.props.changeField;
	        ...
	        key: "handleIsOpen",
	        value: function handleIsOpen(name, e) {
	            var changeField = this.props.changeField;
	        ...
	        value: function handleSave(e) {
	            ...
	            var _props$orderByParam = this.props.orderByParam;
	            var order = _props$orderByParam.order;
	            var isOpen = _props$orderByParam.isOpen;
	            var itemList = order.itemList;
	            ...
	            var obj = new Array();
	            hasNotComment.map(function (v, k) {
	                var rate = v.rate;
	                var id = v.id;
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            var _props$orderByParam2 = this.props.orderByParam;
	            var order = _props$orderByParam2.order;
	            var alertContent = _props$orderByParam2.alertContent;
	            var back_path = _props$orderByParam2.back_path;
	        ...
	        value: function renderItems(items) {
	            ...
	            return items.map(function (v, k) {
	                var singleImageUrl = v.singleImageUrl;
	                var singleTitle = v.singleTitle;
	                var salesPrice = v.salesPrice;
	                var id = v.id;
	                var rate = v.rate;
	                var hasComment = v.hasComment;

	                rate = rate ? rate : 5;
	                if (!hasComment) {
	                    var stars = [];
	                    for (var i = 1; i <= 5; i++) {
	                        var starClass = (0, _classnames2["default"])({
	                            "iconfont": true,
	                            "icon-star-empty": rate < i,
	                            "icon-star-full": rate >= i
	                        });
	                        stars.push(_react2["default"].createElement("div", { key: i, onTouchStart: _this.handleStar.bind(_this, "rate", id, i), className: starClass }));
	                    };
	                    return _react2["default"].createElement(
	                        "div",
	                        { className: "commentBaby_list", key: k },
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "J_moveRight" },
	                            _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "comment_area clearfix" },
	                            _react2["default"].createElement(
	                                "span",
	                                null,
	                        ...
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "comment_area_con clearfix" },
	                            _react2["default"].createElement(
	                                "div",
	                                { className: "textArea" },
	                                _react2["default"].createElement("textarea", { name: "form-content", onChange: _this.handleContent.bind(_this, "content", id), placeholder: "亲~留下此次购物的宝贵意见吧！字数在1-500个字之间", value: v.content || "" })
	                            )
	                        )
	                    );
	                }
	        ...
	        key: "renderConfirmBtns",
	        value: function renderConfirmBtns(items) {
	            if (items.length > 0) {
	                return _react2["default"].createElement(
	                    "div",
	                    { className: "confirmBtns" },
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement("input", { type: "checkbox", onChange: this.handleIsOpen.bind(this, "isOpen"), name: "form-isOpen", value: "", id: "form-isOpen" }),
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { href: "javascript:void(0);", onClick: this.handleSave.bind(this), className: "confirm_btn" },
	                        "提交评论"
	                    )
	                );
	            }
	        ...
	        value: function render() {
	            ...
	            if (currentRoute === "comment") {
	                return _react2["default"].createElement(
	                    "div",
	                    { className: "order-detail-content comment-content" },
	                    _react2["default"].createElement(
	                        _commonHeaderJsx2["default"],
	                        { canBack: !back_url },
	                        back_url ? _react2["default"].createElement("a", { href: back_url, className: "iconfont icon-back" }) : back_url,
