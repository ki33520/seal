	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/", className: activeIndex === "0" ? "nav-hover" : null },
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/polymer", className: activeIndex === "1" ? "nav-hover" : null },
	                            _react2["default"].createElement("i", null),
	                            "分类"
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/trendy", className: activeIndex === "2" ? "nav-hover" : null },
	                            _react2["default"].createElement("i", null),
	                            "爆款"
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/cart", className: activeIndex === "3" ? "nav-hover" : null },
	                            _react2["default"].createElement("i", null),
	                            "购物车"
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "/membercenter", className: activeIndex === "4" ? "nav-hover" : null },
	                            _react2["default"].createElement("i", null),
	                            "个人中心"
	                        )
	                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkTrendyAppJsx = __webpack_require__(673);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(674);
	...
	var _componentJsx = __webpack_require__(676);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(679);

	var actions = _interopRequireWildcard(_actionEs6);

	var TrendyConnected = (0, _reactRedux.connect)(function (state) {
	    return state;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantEs6 = __webpack_require__(675);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialIndexJsx = __webpack_require__(677);
	...
	var TrendyRouter = (function (_Component) {
	    _inherits(TrendyRouter, _Component);

	    function TrendyRouter() {
	        _classCallCheck(this, TrendyRouter);

	        _get(Object.getPrototypeOf(TrendyRouter.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(TrendyRouter, [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _goodlistJsx = __webpack_require__(678);

	var _goodlistJsx2 = _interopRequireDefault(_goodlistJsx);

	var _commonHeaderJsx = __webpack_require__(278);

	var _commonHeaderJsx2 = _interopRequireDefault(_commonHeaderJsx);

	var _commonFooterJsx = __webpack_require__(419);
	...
	var Trendy = (function (_React$Component) {
	    ...
	    _createClass(Trendy, [{
	        key: "beginRefresh",
	        value: function beginRefresh(index) {
	            var categories = this.props.trendy.categories;

	            var curentPage = categories[index].pageIndex;
	            var totalPage = categories[index].totalPage;
	            var nextPage = curentPage + 1;
	            var isFetching = categories[index].isFetching;
	            ...
	            var tabs = categories.map(function (category, i) {
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        { relative: true },
	                        _react2["default"].createElement(_goodlistJsx2["default"], { category: category }),
	                        _react2["default"].createElement(_componentRefresherJsx2["default"], { handleRefresh: _this.beginRefresh.bind(_this, i), active: category.isFetching }),
	                        category.pageIndex == category.totalPage ? _react2["default"].createElement(
	                            "div",
	                            { className: "no-more" },
	                            "已显示全部内容"
	                        ) : null,
	                        _react2["default"].createElement(_commonLoadingJsx2["default"], { active: category.isFetching })
	                    )
	                );
	            });
	            return _react2["default"].createElement(
	                "div",
	                { className: "trendy-content" },
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "btn-right", onClick: this.props.changeScene.bind(this, "search") },
	                        _react2["default"].createElement(_componentIconJsx2["default"], { icon: "search" })
	                    )
	                ),
	                _react2["default"].createElement(
	                    _componentSlidetabsJsx.SlideTabs,
	                    { axis: "x", onSelect: this.handleSelect.bind(this) },
	                    tabs
	                ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoodList = (function (_Component) {
	    _inherits(GoodList, _Component);

	    function GoodList() {
	        _classCallCheck(this, GoodList);

	        _get(Object.getPrototypeOf(GoodList.prototype), "constructor", this).apply(this, arguments);
	    }
	    ...
	    _createClass(GoodList, [{
	        ...
	        value: function renderGoods() {
	            ...
	            var list = this.props.category.list;
	            ...
	            if (list.length > 0) {
	                return list.map(function (goods, i) {
	                    ...
	                    var salesPrice = _this.filterPrice(goods);
	                    var originPrice = (0, _libUtilEs6.formatPrice)(goods.originPrice);
	                    return _react2["default"].createElement(
	                        "a",
	                        { href: "/gooddetail/" + goods.singleCode, className: "clearfix", key: i },
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    "i",
	                                    null,
	                                    _react2["default"].createElement("img", { src: goods.sourceImageUrl })
	                                ),
	                                goods.sourceName
	                            ),
	                            _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	function receiveGoods(param, res) {
	    return {
	        type: _constantEs6.RECEIVE_GOODS,
	        param: param,
	        res: res
	    };
	}
	...
	function requestGoods(param) {
	    return {
	        type: _constantEs6.REQUEST_GOODS,
	        param: param
	    };
	}
	...
	function fetchGoods(param) {
	    return function (dispath) {
	        ...
	        return (0, _libUtilEs6.apiRequest)("/trendyActivity", param, { method: "POST" }).then(function (res) {
