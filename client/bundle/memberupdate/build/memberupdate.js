...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkMemberupdateAppJsx = __webpack_require__(607);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(608);
	...
	var _componentJsx = __webpack_require__(610);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(609);
	...
	var MemberupdateApp = (function (_Component) {
	    ...
	    _createClass(MemberupdateApp, [{
	        ...
	        value: function render() {
	            ...
	            var memberInfo = _props$initialState.memberInfo;
	            var passwordByForm = _props$initialState.passwordByForm;
	            var membercardByForm = _props$initialState.membercardByForm;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$assign4 = __webpack_require__(272)["default"];
	...
	function basicByForm(state, action) {
	    ...
	    switch (action.type) {
	        case _actionEs6.CHANGE_FIELD:
	            ...
	            return _Object$assign4({}, state, _defineProperty({}, name, value));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MemberUpdate = (function (_Component) {
	    ...
	    _createClass(MemberUpdate, [{
	        ...
	        value: function handleSceneChange() {}
	    }, {
	        key: "render",
	        value: function render() {
	            var _state = this.state;
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    { name: "index" },
	                    _react2["default"].createElement(_partialUpdateJsx2["default"], this.props)
	                ),
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "basic" },
	                    _react2["default"].createElement(_partialUpdatebasicJsx2["default"], this.props)
	                ),
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "password" },
	                    _react2["default"].createElement(_partialUpdatepasswordJsx2["default"], this.props)
	                ),
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "membercard" },
	                    _react2["default"].createElement(_partialUpdatemembercardJsx2["default"], this.props)
	                )
	            );
	        }
	    }]);
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "div",
	                            null,
	                            _react2["default"].createElement("img", { src: basicByForm.imageUrl || "/client/asset/images/headpic.png" })
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        "li",
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(null)", onClick: changeScene.bind(this, "basic") },
	                            "基本信息"
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(null)", onClick: changeScene.bind(this, "password") },
	                            "修改登录密码"
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _datepickerJsx = __webpack_require__(613);
	...
	var UpdateBasic = (function (_Component) {
	    ...
	    function UpdateBasic(props) {
	        ...
	        var birthday = props.basicByForm.birthday;
	    ...
	    _createClass(UpdateBasic, [{
	        ...
	        key: "componentDidMount",
	        value: function componentDidMount() {
	            var birthday = this.props.basicByForm.birthday;

	            if (birthday) {
	                var fieldBirthday = this.state.year + "-" + this.state.month + '-' + this.state.day;
	        ...
	        value: function handleChangeBasic(e) {
	            e && e.preventDefault();
	            var _props = this.props;
	            var changeBasic = _props.changeBasic;
	            var basicByForm = _props.basicByForm;
	            var nickName = basicByForm.nickName;
	            var gender = basicByForm.gender;
	            var birthday = basicByForm.birthday;
	            var fieldnickName = basicByForm.fieldnickName;
	            var fieldgender = basicByForm.fieldgender;

	            gender = gender === "-1" ? null : gender;
	            this.formVerify({
	                fieldnickName: fieldnickName, fieldgender: fieldgender, birthday: birthday,
	        ...
	        key: "birthdayChange",
	        value: function birthdayChange(fieldName, type, value) {
	            var object = {};
	            object[type] = value;
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    { onGoBack: changeScene.bind(this, "index") },
	                    _react2["default"].createElement(
	                        "span",
	                        { className: "title" },
	                        "基本信息"
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement("input", { type: "text", placeholder: "请填写", maxLength: "12", name: "nickName", value: fieldnickName, onChange: this.handleFieldChange.bind(this, "nickName") })
	                    ),
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "tips" },
	                        "昵称允许输入2-12位字符，支持中英文、数字及“-”“_”“@”组合。"
	                    )
	                ),
	                _react2["default"].createElement(
	                    "div",
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "select",
	                            { value: fieldgender, name: "gender", onChange: this.handleFieldChange.bind(this, "gender") },
	                            _react2["default"].createElement(
	                                "option",
	                                { value: "-1" },
	                                "请选择"
	                ...
	                _react2["default"].createElement(
	                    "div",
	                    { className: "form-item" },
	                    _react2["default"].createElement(_datepickerJsx2["default"], _extends({}, this.state, { birthdayChange: this.birthdayChange.bind(this) })),
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "tips" },
	                        "填生日有惊喜哦！"
	...
	var Datepicker = (function (_Component) {
	    ...
	    _createClass(Datepicker, [{
	        ...
	        value: function render() {
	            ...
	            var day = _props.day;
	            var max = _props.max;
	            var birthdayChange = _props.birthdayChange;
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(_componentSelectedSelectedJsx2["default"], { placeholder: "请选择", className: "selected year", options: optionYear, closeOnSelect: true,
	                    maxHeight: "5rem",
	                ...
	                _react2["default"].createElement(_componentSelectedSelectedJsx2["default"], { placeholder: "请选择", className: "selected month", options: optionMonth, closeOnSelect: true,
	                    maxHeight: "5rem",
	                ...
	                _react2["default"].createElement(_componentSelectedSelectedJsx2["default"], { placeholder: "请选择", className: "selected day", options: optionDay, closeOnSelect: true,
	                    maxHeight: "5rem",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jshashes = __webpack_require__(615);
	...
	var UpdatePassword = (function (_Component) {
	    ...
	    _createClass(UpdatePassword, [{
	        ...
	        value: function handleFieldBlur(e) {
	            e && e.preventDefault();
	            var passwordByForm = this.props.passwordByForm;
	        ...
	        value: function handleChangePassword(e) {
	            ...
	            var SHA1 = new _jshashes2["default"].SHA1();
	            this.formVerify({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UpdateMemberCard = (function (_Component) {
	    ...
	    _createClass(UpdateMemberCard, [{
	        ...
	        value: function handleFieldBlur(e) {
	            e && e.preventDefault();
	            var membercardByForm = this.props.membercardByForm;
