	    ...
	    _createClass(Dialog, [{
	        ...
	        value: function renderTitle() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(_iconJsx2["default"], { icon: "warn" }),
	                this.props.title
	            );
	        }
	    }, {
	        ...
	        value: function renderButtons() {
	            var onlyConfirm = this.props.onlyConfirm;

	            return _react2["default"].createElement(
	                "div",
	                { className: "dialog-btns" },
	                onlyConfirm ? null : _react2["default"].createElement(
	                    "button",
	        ...
	        key: "render",
	        value: function render() {
	            var classes = (0, _classnames2["default"])("dialog-container", {
	                active: this.props.active
	            });
	            return _react2["default"].createElement(
	                "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActivityIndicator = (function (_Component) {
	    ...
	    function ActivityIndicator(props) {
	        ...
	        _get(Object.getPrototypeOf(ActivityIndicator.prototype), "constructor", this).call(this, props);
	    }
	    ...
	    _createClass(ActivityIndicator, [{
	        ...
	        value: function render() {
	            ...
	            var classes = (0, _classnames2["default"])("activity-indicator", { active: active });
	            var maskLayerStyle = {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "div",
	                    { className: "mask-layer", style: maskLayerStyle },
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "spinner" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkConfirmorderAppJsx = __webpack_require__(438);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionEs6 = __webpack_require__(479);

	var actions = _interopRequireWildcard(_actionEs6);

	var ConfirmOrderConnected = (0, _reactRedux.connect)(function (state) {
	    return _extends({}, state.orderByParam);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantEs6 = __webpack_require__(440);
	...
	function orderByParam(state, action) {
	    ...
	    switch (action.type) {
	        ...
	        case _constantEs6.REQUEST_SHIPFEE:
	            return _Object$assign({}, state, {
	                shipfeeFetching: true,
	                shipfeeFetched: false
	            });
	        case _constantEs6.RESPONSE_SHIPFEE:
	            order = _extends({}, state.order);
	        ...
	        case _constantEs6.START_SUBMITORDER:
	            return _Object$assign({}, state, {
	                orderSubmiting: true,
	                orderSubmited: false
	            });
	        case _constantEs6.FINISH_SUBMITORDER:
	            order = _extends({}, state.order);
	            if (action.res.orderSubmited) {
	                var orderNo = action.res.result.orderNo;
	        ...
	        case _constantEs6.START_VERIFYORDER:
	            return _Object$assign({}, state, {
	                orderVerifying: true,
	                orderVerified: false
	            });
	        case _constantEs6.FINISH_VERIFYORDER:
	            return _Object$assign({}, state, {
	        ...
	        case _constantEs6.REQUEST_PAYGATEWAY:
	            return _Object$assign({}, state, {
	                paygatewayFetching: true,
	                paygatewayFetched: false
	            });
	        case _constantEs6.RESPONSE_PAYGATEWAY:
	            // console.log('RESPONSE_PAYGATEWAY')
	            var cashierParam = action.res.isFetched ? action.res.result : {};
	            var order = _extends({}, state.order, { cashierParam: cashierParam });
	            return _Object$assign({}, state, {
	                order: order,
	                paygatewayFetching: true,
	...
	function calculateTotalFee(order) {
	    var totalFee = order.productFee + order.shipFee + order.abroadFee + order.tariffFee - order.promoFee - order.couponFee;
...
/***/ function(module, exports) {
	...
	var REQUEST_SHIPFEE = "REQUEST_SHIPFEE";
	exports.REQUEST_SHIPFEE = REQUEST_SHIPFEE;
	var RESPONSE_SHIPFEE = "RESPONSE_SHIPFEE";

	exports.RESPONSE_SHIPFEE = RESPONSE_SHIPFEE;
	...
	var REQUEST_PAYGATEWAY = "REQUEST_PAYGATEWAY";
	exports.REQUEST_PAYGATEWAY = REQUEST_PAYGATEWAY;
	var RESPONSE_PAYGATEWAY = "RESPONSE_PAYGATEWAY";

	exports.RESPONSE_PAYGATEWAY = RESPONSE_PAYGATEWAY;
	var START_VERIFYORDER = "START_VERIFYORDER";
	exports.START_VERIFYORDER = START_VERIFYORDER;
	var FINISH_VERIFYORDER = "FINISH_VERIFYORDER";
	exports.FINISH_VERIFYORDER = FINISH_VERIFYORDER;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialConfirmorderJsx = __webpack_require__(442);

	var _partialConfirmorderJsx2 = _interopRequireDefault(_partialConfirmorderJsx);

	var _receiverAppJsx = __webpack_require__(456);

	var _receiverAppJsx2 = _interopRequireDefault(_receiverAppJsx);

	var _partialCouponJsx = __webpack_require__(478);
	...
	var ConfirmOrderRouter = (function (_Component) {
	    ...
	    function ConfirmOrderRouter() {
	        _classCallCheck(this, ConfirmOrderRouter);

	        _get(Object.getPrototypeOf(ConfirmOrderRouter.prototype), "constructor", this).apply(this, arguments);
	    }
	    ...
	    _createClass(ConfirmOrderRouter, [{
	        ...
	        value: function handleChangeReceiver(receiver) {
	            ...
	            if (receiver) {
	                dispatch((0, _actionEs6.fetchShipFee)({
	        ...
	        value: function handleSceneChange(currentScene, param, prevScene) {
	            // switch(currentScene){
	            // case "receiver":
	            // this.refs["receiver"].
	            // }
	        ...
	        value: function render() {
	            ...
	            var receivers = _props$order.receivers;
	            var checkedReceiver = _props$order.checkedReceiver;

	            if (checkedReceiver) {
	                if (_lodash2["default"].some(receivers, { id: checkedReceiver.id }) === false) {
	                    receivers.push(checkedReceiver);
	                }
	                receivers = _lodash2["default"].sortBy(receivers, "id");
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentIconJsx = __webpack_require__(403);
	...
	var _componentFormCheckboxJsx = __webpack_require__(428);

	var _componentFormCheckboxJsx2 = _interopRequireDefault(_componentFormCheckboxJsx);

	var _componentSelectedSelectedJsx = __webpack_require__(443);
	...
	var _ordergoodsJsx = __webpack_require__(445);

	var _ordergoodsJsx2 = _interopRequireDefault(_ordergoodsJsx);

	var _invoiceJsx = __webpack_require__(454);

	var _invoiceJsx2 = _interopRequireDefault(_invoiceJsx);

	var _submitorderJsx = __webpack_require__(455);

	var _submitorderJsx2 = _interopRequireDefault(_submitorderJsx);

	var _componentAlertJsx = __webpack_require__(429);

	var _componentAlertJsx2 = _interopRequireDefault(_componentAlertJsx);

	var _componentDialogJsx = __webpack_require__(430);

	var _componentDialogJsx2 = _interopRequireDefault(_componentDialogJsx);
	...
	var ConfirmOrder = (function (_Component) {
	    ...
	    function ConfirmOrder(props) {
	        ...
	        _get(Object.getPrototypeOf(ConfirmOrder.prototype), "constructor", this).call(this, props);
	        this.state = {
	            dialogActive: false,
	            dialogContent: null
	        };
	    ...
	    _createClass(ConfirmOrder, [{
	        ...
	        value: function renderReceiver(receiver) {
	            if (receiver === null) {
	                return _react2["default"].createElement(
	                    "div",
	                    { className: "order-time noReceive", onClick: this.props.changeScene.bind(this, "receiver")
	                    },
	                    _react2["default"].createElement(
	                        "div",
	                        null,
	            ...
	            return _react2["default"].createElement(
	                "a",
	                { href: "javascript:void(null)", onClick: this.props.changeScene.bind(this, "receiver") },
	                _react2["default"].createElement(
	                    "div",
	                    ...
	                    _react2["default"].createElement(
	                        "p",
	                        null,
	                        (0, _libUtilEs6.formateIDCard)(receiver.idCard),
	                        _react2["default"].createElement(
	                            "em",
	                            null,
	                            "实名"
	        ...
	        value: function renderTotal(order) {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    order.shipFee > 0 ? null : _react2["default"].createElement(
	                        "div",
	                        { className: "red-box" },
	                        "包邮"
	                    ),
	                ...
	                _react2["default"].createElement(
	                    ...
	                    order.tariffFee > 0 ? null : _react2["default"].createElement(
	                        "div",
	                        { className: "red-box" },
	                        "免税"
	                    ),
	        ...
	        key: "verifyOrder",
	        value: function verifyOrder() {
	            var _props = this.props;
	            var order = _props.order;
	            var verifyOrder = _props.verifyOrder;
	        ...
	        value: function submitOrder() {
	            ...
	            var submitOrder = _props2.submitOrder;
	            var checkedCoupon = order.checkedCoupon;
	            var useBalance = order.useBalance;
	            var useTicket = order.useTicket;
	            var payPassword = order.payPassword;
	        ...
	        value: function componentDidUpdate(prevProps, prevState) {
	            ...
	            var paygatewayFetched = _props3.paygatewayFetched;
	            var fetchPayGateway = _props3.fetchPayGateway;
	            ...
	            if (prevProps.orderSubmiting === true && this.props.orderSubmiting === false) {
	                if (this.props.orderSubmited === true) {
	                    var orderNo = this.props.order.orderNo;

	                    var message = {
	                        orderNo: orderNo
	                    };
	                    fetchPayGateway((0, _libUtilEs6.base64EncodeForURL)((0, _libUtilEs6.urlParam)(message)));
	                }
	            }
	            if (prevProps.paygatewayFetched === false && this.props.paygatewayFetched === true) {
	                setTimeout(function () {
	                    // console.log('submitOrder')
	                    _reactDom2["default"].findDOMNode(_this.refs["SubmitOrder"].refs["submitForm"]).submit();
	                }, 10);
	            }
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            var alertActive = _props4.alertActive;
	            var alertContent = _props4.alertContent;

	            return _react2["default"].createElement(
	                _componentGotopJsx2["default"],
	                { relative: true, renderFixed: function () {
	                        return _react2["default"].createElement(_submitorderJsx2["default"], { order: order, orderSubmited: _this3.props.orderSubmited,
	                            submiting: _this3.props.orderVerifying || _this3.props.orderSubmiting || _this3.props.paygatewayFetching,
	                            onSubmit: _this3.verifyOrder.bind(_this3), ref: "SubmitOrder" });
	                    } },
	                _react2["default"].createElement(
	                    "div",
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "intro clearfix", onClick: this.props.changeScene.bind(this, "coupon") },
	                            _react2["default"].createElement(
	                                "span",
	                                null,
	                                "优惠券"
	                            ...
	                            _react2["default"].createElement(
	                                "span",
	                                null,
	                                order.coupons.length === 0 ? _react2["default"].createElement(
	                                    "em",
	                                    null,
	                                    "暂无可用优惠券"
	                                ) : order.checkedCoupon ? _react2["default"].createElement(
	                                    "em",
	                                    null,
	                                    order.checkedCoupon["couponName"]
	                                ) : null,
	                                _react2["default"].createElement("i", { className: "iconfont icon-right" })
	                            )
	                        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dropdownJsx = __webpack_require__(444);
	    ...
	    _createClass(Selected, [{
	        ...
	        value: function renderStatus(labels) {
	            return labels.map(function (label, i) {
	                return _react2["default"].createElement(
	                    "div",
	                    { className: "selected-label", key: i },
	                    label
	                );
	            });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentLazyloadLazyloadJsx = __webpack_require__(446);

	var _componentLazyloadLazyloadJsx2 = _interopRequireDefault(_componentLazyloadLazyloadJsx);

	var _componentLazyloadImageJsx = __webpack_require__(447);
	...
	var OrderGoods = (function (_Component) {
	    ...
	    _createClass(OrderGoods, [{
	        key: "renderGood",
	        value: function renderGood(good, parentIndex, goodIndex) {
	            var props = [];
	        ...
	        key: "renderGroup",
	        value: function renderGroup(promoList) {
	            var _this = this;

	            if (promoList.length > 0) {
	                return promoList.map(function (promo, i) {
	                    var goods = [];
	                    promo.goods.forEach(function (good, j) {
	                        goods.push(_this.renderGood(good, i, j));
	                    });
	                    var promoTitle = null;
	                    if (promo.promoType && promo.promoName) {
	                        promoTitle = _react2["default"].createElement(
	                            "div",
	                    ...
	                    return _react2["default"].createElement(
	                        "div",
	                        { className: "orderConfirm_l_box", key: i },
	                        promoTitle,
	                        _react2["default"].createElement(
	                            "div",
	        ...
	        key: "render",
	        value: function render() {
	            var promoList = this.props.promoList;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactLibReactCSSTransitionGroup = __webpack_require__(448);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroupChild = __webpack_require__(451);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(93);
	var ReactTransitionChildMapping = __webpack_require__(450);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SubmitOrder = (function (_Component) {
	    ...
	    _createClass(SubmitOrder, [{
	        key: "render",
	        value: function render() {
	            var submiting = this.props.submiting;
	            var cashierParam = this.props.order.cashierParam;

	            cashierParam = cashierParam || {};
	            var classes = (0, _classnames2["default"])("confirm_btn", {
	                submiting: submiting
	            });
	            return _react2["default"].createElement(
	                "div",
	                ...
	                _react2["default"].createElement(
	                    "a",
	                    { href: "javascript:void(0);", className: classes,
	                        onClick: this.props.onSubmit },
	                    submiting ? "提交中..." : "提交订单"
	                ),
	                _react2["default"].createElement(
	                    "form",
	                    { action: "http://cashier.e9448.com/cashier/v1/cashier", method: "POST", ref: "submitForm" },
	                    _react2["default"].createElement("input", { type: "hidden", name: "appId", value: cashierParam.appId }),
	                    _react2["default"].createElement("input", { type: "hidden", name: "channel", value: cashierParam.channel }),
	                    _react2["default"].createElement("input", { type: "hidden", name: "openId", value: cashierParam.openId }),
	                    _react2["default"].createElement("input", { type: "hidden", name: "terminalType", value: cashierParam.terminalType }),
	                    _react2["default"].createElement("input", { type: "hidden", name: "message", value: cashierParam.message }),
	                    _react2["default"].createElement("input", { type: "hidden", name: "t", value: cashierParam.t }),
	                    _react2["default"].createElement("input", { type: "hidden", name: "h", value: cashierParam.h })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentJsx = __webpack_require__(469);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(477);

	var actions = _interopRequireWildcard(_actionEs6);

	var ReceiverConnected = (0, _reactRedux.connect)(function (state) {
	    return state;
	})((0, _libReduxHelperEs6.wrapComponentWithActions)(_componentJsx2["default"], actions));
	...
	var ReceiverApp = (function (_React$Component) {
	    ...
	    _createClass(ReceiverApp, [{
	        ...
	        value: function render() {
	            ...
	            var checkable = _props$initialState.checkable;
	            var checkedReceiver = _props$initialState.checkedReceiver;
	            var defaultScene = _props$initialState.defaultScene;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantEs6 = __webpack_require__(468);
	...
	function updateReceiver(state, action) {
	    ...
	    switch (action.type) {
	        case _constantEs6.REQUEST_RECEIVER:
	            return _Object$assign({}, state, {
	                receiverFetching: true
	            });
	        case _constantEs6.RESPONSE_RECEIVER:
	            var receiver = null;
	        ...
	        case _constantEs6.CHANGE_FIELD:
	            if (action.scene === "updateReceiver") {
	                ...
	                receiver[_name] = value;
	                return _Object$assign({}, state, {
	                    receiver: receiver
	                });
	            }
	            return state;
	        case _constantEs6.REQUEST_PROVINCES:
	        case _constantEs6.RESPONSE_PROVINCES:
	        case _constantEs6.REQUEST_CITIES:
	        case _constantEs6.RESPONSE_CITIES:
	        case _constantEs6.REQUEST_DISTRICTS:
	        case _constantEs6.RESPONSE_DISTRICTS:
	            if (action.scene === "updateReceiver") {
	                return cascadeArea(state, action);
	            }
	            return state;
	        case _constantEs6.START_SAVERECEIVER:
	            return _Object$assign({}, state, {
	                receiverSaving: true,
	                receiverSaved: false
	            });
	        case _constantEs6.FINISH_SAVERECEIVER:
	        ...
	        case _commonConstantEs6.HIDE_ALERT:
	            return (0, _commonReducerEs6.alertReducer)(state, action);
	        case _commonConstantEs6.SHOW_ACTIVITYINDICATOR:
	        case _commonConstantEs6.HIDE_ACTIVITYINDICATOR:
	            return (0, _commonReducerEs6.activityIndicatorReducer)(state, action);
	        default:
	            return state;
	    }
	}
	    ...
	    switch (action.type) {
	        case _constantEs6.CHANGE_FIELD:
	            if (action.scene === "addReceiver") {
	                ...
	                receiver[_name2] = value;
	                return _Object$assign({}, state, {
	                    receiver: receiver
	                });
	            }
	            return state;
	        case _constantEs6.START_CREATERECEIVER:
	            return _Object$assign({}, state, {
	                receiverSaving: true,
	                receiverSaved: false
	            });
	        case _constantEs6.FINISH_CREATERECEIVER:
	            if (action.res.receiverSaved) {
	                receiver = _Object$assign({}, receiver, action.param, {
	...
	function receiverByUser(state, action) {
	    ...
	    var receivers = _Object$assign([], state.receivers);
	    switch (action.type) {
	        case _constantEs6.SELECT_RECEIVER:
	            return _Object$assign({}, state, {
	                checkedReceiver: action.receiver
	            });
	        case _constantEs6.CHANGE_RECEIVER:
	            receivers = receivers.map(function (_receiver) {
	                if (_receiver.id === action.receiver.id) {
	                    _receiver = _Object$assign({}, _receiver, action.receiver);
	                }
	                return _receiver;
	            });
	            var checkedReceiver = null;
	            if (state.checkedReceiver && state.checkedReceiver.id === action.receiver.id) {
	                checkedReceiver = _Object$assign({}, state.checkedReceiver, action.receiver);
	            }
	            return _Object$assign({}, state, { receivers: receivers, checkedReceiver: checkedReceiver });
	        case _constantEs6.PUSH_RECEIVER:
	            receivers.push(action.receiver);
	            checkedReceiver = action.receiver;
	            return _Object$assign({}, state, { receivers: receivers, checkedReceiver: checkedReceiver });
	        case _constantEs6.REQUEST_RECEIVERS:
	            return _Object$assign({}, state, {
	                receiversFetching: true,
	                receiversFetched: false
	            });
	        case _constantEs6.RESPONSE_RECEIVERS:
	            var receivers = null;
	            if (action.res.isFetched === true) {
	        ...
	        case _constantEs6.START_DELETERECEIVER:
	            return _Object$assign({}, state, {
	                receiverDeleting: true,
	                receiverDeleted: false
	            });
	        case _constantEs6.FINISH_DELETERECEIVER:
	            var receiverDeleted = action.res.receiverDeleted;
	            if (receiverDeleted) {
	                receivers = _lodash2["default"].reject(receivers, function (receiver) {
	        ...
	        case _constantEs6.START_SETDEFAULT:
	            return _Object$assign({}, state, {
	                receiverUpdating: true,
	                receiverUpdated: false
	            });
	        case _constantEs6.FINISH_SETDEFAULT:
	            var receiverUpdated = action.res.receiverUpdated;
	            if (receiverUpdated) {
	                receivers = _lodash2["default"].map(receivers, function (receiver) {
...
/***/ function(module, exports) {
	...
	var CHANGE_RECEIVER = "CHANGE_RECEIVER";
	exports.CHANGE_RECEIVER = CHANGE_RECEIVER;
	var PUSH_RECEIVER = "PUSH_RECEIVER";

	exports.PUSH_RECEIVER = PUSH_RECEIVER;
	var SELECT_RECEIVER = "SELECT_RECEIVER";
	exports.SELECT_RECEIVER = SELECT_RECEIVER;
	...
	var REQUEST_RECEIVERS = "REQUEST_RECEIVERS";
	exports.REQUEST_RECEIVERS = REQUEST_RECEIVERS;
	var RESPONSE_RECEIVERS = "RESPONSE_RECEIVERS";

	exports.RESPONSE_RECEIVERS = RESPONSE_RECEIVERS;
	var START_SAVERECEIVER = "START_SAVERECEIVER";
	exports.START_SAVERECEIVER = START_SAVERECEIVER;
	var FINISH_SAVERECEIVER = "FINISH_SAVERECEIVER";

	exports.FINISH_SAVERECEIVER = FINISH_SAVERECEIVER;
	var START_CREATERECEIVER = "START_CREATERECEIVER";
	exports.START_CREATERECEIVER = START_CREATERECEIVER;
	var FINISH_CREATERECEIVER = "FINISH_CREATERECEIVER";

	exports.FINISH_CREATERECEIVER = FINISH_CREATERECEIVER;
	var START_DELETERECEIVER = "START_DELETERECEIVER";
	exports.START_DELETERECEIVER = START_DELETERECEIVER;
	var FINISH_DELETERECEIVER = "FINISH_DELETERECEIVER";

	exports.FINISH_DELETERECEIVER = FINISH_DELETERECEIVER;
	var START_SETDEFAULT = "START_SETDEFAULT";
	exports.START_SETDEFAULT = START_SETDEFAULT;
	var FINISH_SETDEFAULT = "FINISH_SETDEFAULT";
	exports.FINISH_SETDEFAULT = FINISH_SETDEFAULT;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialReceiverJsx = __webpack_require__(470);

	var _partialReceiverJsx2 = _interopRequireDefault(_partialReceiverJsx);

	var _partialAddreceiverJsx = __webpack_require__(472);

	var _partialAddreceiverJsx2 = _interopRequireDefault(_partialAddreceiverJsx);

	var _partialUpdatereceiverJsx = __webpack_require__(475);
	...
	var ReceiverRouter = (function (_Component) {
	    ...
	    function ReceiverRouter() {
	        _classCallCheck(this, ReceiverRouter);

	        _get(Object.getPrototypeOf(ReceiverRouter.prototype), "constructor", this).apply(this, arguments);
	    }
	    ...
	    _createClass(ReceiverRouter, [{
	        ...
	        value: function handleSceneChange(currentScene, param, prevScene) {
	            var _props = this.props;
	            var fetchReceiver = _props.fetchReceiver;
	            var fetchReceivers = _props.fetchReceivers;
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "index" },
	                    _react2["default"].createElement(_partialReceiverJsx2["default"], _extends({}, this.props.receiverByUser, this.props))
	                ),
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "addreceiver" },
	                    _react2["default"].createElement(_partialAddreceiverJsx2["default"], _extends({}, this.props.addReceiver, this.props))
	                ),
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "updatereceiver" },
	                    _react2["default"].createElement(_partialUpdatereceiverJsx2["default"], _extends({}, this.props.updateReceiver, this.props))
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentFormRadioJsx = __webpack_require__(471);

	var _componentFormRadioJsx2 = _interopRequireDefault(_componentFormRadioJsx);
	...
	var Receiver = (function (_Component) {
	    ...
	    function Receiver(props) {
	        ...
	        _get(Object.getPrototypeOf(Receiver.prototype), "constructor", this).call(this, props);
	        this.state = {
	            dialogActive: false,
	    ...
	    _createClass(Receiver, [{
	        key: "handleCheck",
	        value: function handleCheck(receiver) {
	        ...
	        key: "handleDelete",
	        value: function handleDelete(receiver) {
	            var _this = this;

	            var _props = this.props;
	            var deleteReceiver = _props.deleteReceiver;
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            if (nextProps.receiverDeleted === true && this.props.receiverDeleted === false) {
	                var _props2 = this.props;
	                var checkedReceiver = _props2.checkedReceiver;
	                var checkable = _props2.checkable;
	                var receivers = nextProps.receivers;

	                if (checkable && _lodash2["default"].some(receivers, { id: checkedReceiver.id }) === false) {
	        ...
	        key: "handleCheckableGoBack",
	        value: function handleCheckableGoBack() {
	        ...
	        key: "setReceiverDefault",
	        value: function setReceiverDefault(receiver) {
	            var setDefault = this.props.setDefault;
	        ...
	        value: function renderReceivers() {
	            ...
	            var _props3 = this.props;
	            var receivers = _props3.receivers;
	            var checkable = _props3.checkable;
	            var checkedReceiver = _props3.checkedReceiver;

	            if (receivers.length > 0) {
	                return receivers.map(function (receiver, i) {
	                    var key = "receiver-" + i;
	                    var checked = checkedReceiver !== null ? checkedReceiver.id === receiver.id : false;
	                    var checkbox = checkable ? _react2["default"].createElement(_componentFormRadioJsx2["default"], { name: "receiver", checked: checked, checkedIcon: "checkbox-full", uncheckIcon: "checkbox-empty",
	                        onChange: _this2.handleCheck.bind(_this2, receiver) }) : null;
	                    var isDefault = receiver.isDefault === 1 ? _react2["default"].createElement(
	                        "i",
	                        null,
	                        "【默认】"
	                    ...
	                    return _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "toolsArea" },
	                            receiver.isDefault !== 1 ? _react2["default"].createElement(
	                                "em",
	                                { onClick: _this2.setReceiverDefault.bind(_this2, receiver) },
	                                "设为默认地址"
	                            ) : null,
	                            _react2["default"].createElement(
	                                "span",
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    { href: "javascript:void(null)",
	                                        onClick: _this2.props.changeScene.bind(_this2, "updatereceiver", { id: receiver.id }) },
	                            ...
	                            _react2["default"].createElement(
	                                "span",
	                                { className: "del", onClick: _this2.handleDelete.bind(_this2, receiver) },
	                                _react2["default"].createElement("em", null),
	                                "删除"
	                            )
	                        )
	            ...
	            return _react2["default"].createElement(
	                "div",
	                { className: "empty" },
	                _react2["default"].createElement("img", { src: "/client/asset/images/empty_address.png" }),
	                _react2["default"].createElement(
	                    "span",
	                    null,
	                    "快来添加您的收货地址吧！"
	                ...
	                _react2["default"].createElement(
	                    "a",
	                    { href: "javascript:void(null)", className: "empty_btn",
	                        onClick: this.props.changeScene.bind(this, "addreceiver") },
	                    "添加新地址"
	                )
	            );
	        }
	        ...
	        value: function render() {
	            ...
	            var handleAddReceiver = function handleAddReceiver() {
	                if (_this3.props.receivers.length >= 6) {
	                    _this3.props.alert("收货地址不能超过6个!", 2000);
	                } else {
	                    _this3.props.changeScene("addreceiver");
	                }
	            };
	            return _react2["default"].createElement(
	                "div",
	                { className: "receiver-content" },
	                this.props.checkable ? _react2["default"].createElement(
	                    _commonHeaderJsx2["default"],
	                    { onGoBack: this.handleCheckableGoBack.bind(this) },
	                    "选择收货地址"
	                ) : _react2["default"].createElement(
	                    _commonHeaderJsx2["default"],
	                    null,
	                ...
	                this.props.receivers.length > 0 ? _react2["default"].createElement(
	                    "div",
	                    { className: "addBtns" },
	                    _react2["default"].createElement(
	                        "a",
	                        { href: "javascript:void(null)",
	                            onClick: handleAddReceiver, className: "addBtn" },
	                        "添加新地址"
	                    )
	                ) : null,
	                _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Radio = (function (_Component) {
	    ...
	    _createClass(Radio, [{
	        key: "render",
	        value: function render() {
	            var checkedIcon = this.props.checkedIcon || "dot-circled";
	            var uncheckIcon = this.props.uncheckIcon || "circle-empty";
	            var _props = this.props;
	            var checked = _props.checked;
	            var name = _props.name;
	            var onChange = _props.onChange;

	            var classes = (0, _classnames2["default"])("radio", this.props.className);
	            return _react2["default"].createElement(
	                "div",
	                { className: classes },
	                _react2["default"].createElement("input", { type: "radio", name: name, onChange: onChange, defaultChecked: checked,
	                    ref: "checkInput" }),
	                _react2["default"].createElement(_iconJsx2["default"], { icon: checkedIcon, className: "checked" }),
	                _react2["default"].createElement(_iconJsx2["default"], { icon: uncheckIcon, className: "unchecked" })
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cascadeareaJsx = __webpack_require__(473);

	var _cascadeareaJsx2 = _interopRequireDefault(_cascadeareaJsx);

	var _commonActionEs6 = __webpack_require__(433);

	var _commonActivityindicatorJsx = __webpack_require__(431);

	var _commonActivityindicatorJsx2 = _interopRequireDefault(_commonActivityindicatorJsx);
	...
	var AddReceiver = (function (_Component) {
	    ...
	    _createClass(AddReceiver, [{
	        ...
	        value: function handleAreaChange(fieldName, fieldValue) {
	            var changeField = this.props.changeField;
	        ...
	        value: function loadProvinces() {
	            var fetchProvinces = this.props.fetchProvinces;
	        ...
	        value: function loadCities(province) {
	            var fetchCities = this.props.fetchCities;
	        ...
	        value: function loadDistricts(city) {
	            var fetchDistricts = this.props.fetchDistricts;
	        ...
	        key: "componentDidUpdate",
	        value: function componentDidUpdate(prevProps, prevState) {
	            if (this.props.active === true && prevProps.active === false && this.props.provinces.length === 1) {
	                this.loadProvinces();
	            }
	        }
	    }, {
	        ...
	        value: function handleSave(e) {
	            ...
	            var createReceiver = _props.createReceiver;
	            var showActivityIndicator = _props.showActivityIndicator;
	            ...
	            var idCard = _ref.idCard;
	            var mobileNumber = _ref.mobileNumber;
	            var address = _ref.address;
	            var isDefault = _ref.isDefault;
	            var provinceCode = _ref.provinceCode;
	            var cityCode = _ref.cityCode;
	            var districtCode = _ref.districtCode;

	            var provinceName = _lodash2["default"].result(_lodash2["default"].findWhere(provinces, { value: provinceCode }), "label");
	            var cityName = _lodash2["default"].result(_lodash2["default"].findWhere(cities, { value: cityCode }), "label");
	            var districtName = _lodash2["default"].result(_lodash2["default"].findWhere(districts, { value: districtCode }), "label");
	            createReceiver({
	                consignee: consignee, idCard: idCard, mobileNumber: mobileNumber, address: address,
	                isDefault: 0,
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            var hideActivityIndicator = _props2.hideActivityIndicator;
	            ...
	            if (nextProps.receiverSaving === false && this.props.receiverSaving === true) {
	                ...
	                if (nextProps.receiverSaved === true) {
	                    ...
	                    setTimeout(function () {
	                        ...
	                        var onCheck = _props3.onCheck;
	                        var receiver = _props3.receiver;
	                        var checkable = _props3.checkable;

	                        if (checkable) {
	                            _this.props.selectReceiver(receiver);
	                            onCheck(receiver);
	                            // console.log('receiver',receiver)
	                            _this.props.receiverByUser.changeScene("index");
	                            _this.props.resetScene();
	                        } else {
	                            _this.props.changeScene("index");
	                        }
	                    }, 2000);
	        ...
	        value: function render() {
	            var _props4 = this.props;
	            var saveSuccess = _props4.saveSuccess;
	            var alertActive = _props4.alertActive;
	            var alertContent = _props4.alertContent;
	            var activityIndicatorActive = _props4.activityIndicatorActive;
	            var receiver = _props4.receiver;

	            var _ref2 = receiver === null ? {} : receiver;

	            var consignee = _ref2.consignee;
	            var idCard = _ref2.idCard;
	            var mobileNumber = _ref2.mobileNumber;
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { className: "screening", href: "javascript:void(0);", onClick: this.handleSave.bind(this) },
	                        "保存"
	                    )
	                ),
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "div",
	                                { className: "receiver-form-field" },
	                                _react2["default"].createElement("input", { type: "text", value: idCard,
	                                    placeholder: "填写后，我们会加密处理",
	                                    onChange: this.handleFieldChange.bind(this, "idCard") })
	                            )
	                        )
	                    ),
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "div",
	                                { className: "receiver-form-field" },
	                                _react2["default"].createElement("input", { type: "text", value: mobileNumber,
	                                    placeholder: "请输入您的手机号",
	                                    onChange: this.handleFieldChange.bind(this, "mobileNumber") })
	                            )
	                        ),
	                        _react2["default"].createElement(_cascadeareaJsx2["default"], _extends({ loadCities: this.loadCities.bind(this),
	                ...
	                _react2["default"].createElement(_commonActivityindicatorJsx2["default"], { active: activityIndicatorActive }),
	                _react2["default"].createElement(
	                    _componentAlertJsx2["default"],
	                    { active: alertActive },
	                    alertContent
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CascadeArea = (function (_Component) {
	    ...
	    _createClass(CascadeArea, [{
	        ...
	        value: function handleDistrictChange(districtCode) {
	            var handleAreaChange = this.props.handleAreaChange;

	            handleAreaChange("districtCode", districtCode);
	        }
	    }, {
	        key: "handleProvinceChange",
	        value: function handleProvinceChange(provinceCode) {
	            var _props = this.props;
	            var loadCities = _props.loadCities;
	            var handleAreaChange = _props.handleAreaChange;
	        ...
	        value: function handleCityChange(cityCode) {
	            var _props2 = this.props;
	            var loadDistricts = _props2.loadDistricts;
	            var handleAreaChange = _props2.handleAreaChange;
	        ...
	        value: function renderProvince() {
	            var _props3 = this.props;
	            var provinces = _props3.provinces;
	            var receiver = _props3.receiver;

	            var province = receiver === null ? "" : receiver.provinceCode;
	            if (provinces.length > 1) {
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "receiver-form-field" },
	                        _react2["default"].createElement(_componentSelectedSelectedJsx2["default"], { options: provinces, closeOnSelect: true,
	                            maxHeight: "5rem",
	        ...
	        value: function renderCity() {
	            var _props4 = this.props;
	            var cities = _props4.cities;
	            var receiver = _props4.receiver;

	            var city = receiver === null ? "" : receiver.cityCode;
	            return _react2["default"].createElement(
	                "div",
	                { className: "receiver-form-row" },
	                _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "div",
	                    { className: "receiver-form-field" },
	                    _react2["default"].createElement(_componentSelectedSelectedJsx2["default"], { options: cities, closeOnSelect: true,
	                        maxHeight: "5rem",
	        ...
	        value: function renderDistrict() {
	            ...
	            var districts = _props5.districts;
	            var receiver = _props5.receiver;

	            var district = receiver === null ? "" : receiver.districtCode;
	            return _react2["default"].createElement(
	                "div",
	                { className: "receiver-form-row" },
	                _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "div",
	                    { className: "receiver-form-field" },
	                    _react2["default"].createElement(_componentSelectedSelectedJsx2["default"], { options: districts, closeOnSelect: true,
	                        maxHeight: "5rem",
	...
	var UpdateReceiver = (function (_Component) {
	    ...
	    _createClass(UpdateReceiver, [{
	        ...
	        value: function handleSave(e) {
	            ...
	            var _props = this.props;
	            var receiver = _props.receiver;
	            var saveReceiver = _props.saveReceiver;
	            var provinces = _props.provinces;
	            var cities = _props.cities;
	            var districts = _props.districts;
	            var showActivityIndicator = _props.showActivityIndicator;
	            ...
	            var mobileNumber = receiver.mobileNumber;
	            var idCard = receiver.idCard;
	            var address = receiver.address;
	            var isDefault = receiver.isDefault;
	            var provinceCode = receiver.provinceCode;
	            var cityCode = receiver.cityCode;
	            var districtCode = receiver.districtCode;

	            var provinceName = _lodash2["default"].result(_lodash2["default"].findWhere(provinces, { value: provinceCode }), "label");
	            var cityName = _lodash2["default"].result(_lodash2["default"].findWhere(cities, { value: cityCode }), "label");
	            var districtName = _lodash2["default"].result(_lodash2["default"].findWhere(districts, { value: districtCode }), "label");
	            saveReceiver({
	                id: id, consignee: consignee, mobileNumber: mobileNumber, idCard: idCard, address: address,
	                isDefault: isDefault,
	                provinceCode: provinceCode, cityCode: cityCode, districtCode: districtCode,
	                provinceName: provinceName, cityName: cityName, districtName: districtName
	            });
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            if (nextProps.receiverSaving === false && this.props.receiverSaving === true) {
	                ...
	                if (nextProps.receiverSaved === true) {
	                    alert("提交成功!", 1500);
	                    setTimeout(function () {
	                        return _this.props.changeScene("index");
	                    }, 2000);
	                } else {
	                    alert(nextProps.errMsg, 1500);
	                }
	        ...
	        value: function render() {
	            var _props3 = this.props;
	            var saveSuccess = _props3.saveSuccess;
	            var alertActive = _props3.alertActive;
	            var alertContent = _props3.alertContent;
	            var receiver = _props3.receiver;
	            var activityIndicatorActive = _props3.activityIndicatorActive;
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { className: "screening", href: "javascript:void(null)", onClick: this.handleSave.bind(this) },
	                        "保存"
	                    )
	                ),
	                _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.selectReceiver = selectReceiver;
	exports.fetchReceivers = fetchReceivers;
	...
	Object.defineProperty(exports, "showActivityIndicator", {
	    enumerable: true,
	    get: function get() {
	        return _commonActionEs6.showActivityIndicator;
	    }
	});
	Object.defineProperty(exports, "hideActivityIndicator", {
	    enumerable: true,
	    get: function get() {
	        return _commonActionEs6.hideActivityIndicator;
	    }
	});

	function changeReceiver(receiver) {
	    return {
	        type: _constantEs6.CHANGE_RECEIVER,
	        receiver: receiver
	    };
	}
	...
	function pushReceiver(receiver) {
	    return {
	        type: _constantEs6.PUSH_RECEIVER,
	        receiver: receiver
	    };
	}
	...
	function selectReceiver(receiver) {
	    return {
	        type: _constantEs6.SELECT_RECEIVER,
	        receiver: receiver
	    };
	}
	...
	function requestReceivers() {
	    return {
	        type: _constantEs6.REQUEST_RECEIVERS
	    };
	}

	function responseReceivers(res) {
	    return {
	        type: _constantEs6.RESPONSE_RECEIVERS,
	        res: res
	    };
	}
	...
	function fetchReceivers() {
	    return function (dispatch) {
	        ...
	        (0, _libUtilEs6.apiRequest)("/receivers").then(function (res) {
	...
	function requestReceiver() {
	    return {
	        type: _constantEs6.REQUEST_RECEIVER
	    };
	}

	function responseReceiver(res) {
	    return {
	        type: _constantEs6.RESPONSE_RECEIVER,
	        res: res
	    };
	}
	...
	function changeField(name, value, scene) {
	    return {
	        type: _constantEs6.CHANGE_FIELD,
	        name: name,
	        value: value,
	...
	function requestProvinces(param, scene) {
	    return {
	        type: _constantEs6.REQUEST_PROVINCES,
	        scene: scene,
	        param: param
	    };
	}
	...
	function responseProvinces(param, res, scene) {
	    return {
	        type: _constantEs6.RESPONSE_PROVINCES,
	        param: param,
	        res: res,
	        scene: scene,
	        responseAt: Date.now()
	...
	function fetchProvinces(param, scene) {
	    return function (dispatch) {
	        dispatch(requestProvinces(param, scene));
	        (0, _libUtilEs6.apiRequest)("/cascadearea", _Object$assign({}, param, {
	            api: "findProvince"
	        })).then(function (res) {
	...
	function requestCities(param, scene) {
	    return {
	        type: _constantEs6.REQUEST_CITIES,
	        scene: scene,
	        param: param
	    };
	}
	...
	function responseCities(param, res, scene) {
	    return {
	        type: _constantEs6.RESPONSE_CITIES,
	        param: param,
	        res: res,
	        scene: scene,
	        responseAt: Date.now()
	...
	function fetchCities(param, scene) {
	    return function (dispatch) {
	...
	function requestDistricts(param, scene) {
	    return {
	        type: _constantEs6.REQUEST_DISTRICTS,
	        scene: scene,
	        param: param
	    };
	}
	...
	function responseDistricts(param, res, scene) {
	    return {
	        type: _constantEs6.RESPONSE_DISTRICTS,
	        param: param,
	        res: res,
	        scene: scene,
	        responseAt: Date.now()
	...
	function fetchDistricts(param, scene) {
	    return function (dispatch) {
	...
	function startSaveReceiver(param) {
	    return {
	        type: _constantEs6.START_SAVERECEIVER,
	        param: param
	    };
	}
	...
	function finishSaveReceiver(param, res) {
	    return {
	        type: _constantEs6.FINISH_SAVERECEIVER,
	        param: param,
	        res: res,
	        finishAt: Date.now()
	    };
	...
	function startCreateReceiver(param) {
	    return {
	        type: _constantEs6.START_CREATERECEIVER,
	        param: param
	    };
	}
	...
	function finishCreateReceiver(param, res) {
	    return {
	        type: _constantEs6.FINISH_CREATERECEIVER,
	        param: param,
	        res: res,
	        finishAt: Date.now()
	    };
	...
	function createReceiver(param) {
	    return function (dispatch) {
	        dispatch(startCreateReceiver(param));
	        (0, _libUtilEs6.apiRequest)("/createreceiver", param, {
	            method: "POST"
	        }).then(function (res) {
	            if (res.receiverSaved) {
	                dispatch(pushReceiver(_Object$assign({}, param, {
	                    id: res.result
	                })));
	            }
	...
	function startDeleteReceiver(param) {
	    return {
	        type: _constantEs6.START_DELETERECEIVER,
	        param: param
	    };
	}
	...
	function finishDeleteReceiver(param, res) {
	    return {
	        type: _constantEs6.FINISH_DELETERECEIVER,
	        param: param,
	        res: res,
	        finishAt: Date.now()
	    };
	...
	function deleteReceiver(param) {
	    return function (dispatch) {
	        dispatch(startDeleteReceiver(param));
	        (0, _libUtilEs6.apiRequest)("/deletereceiver", param, {
	            method: "POST"
	        }).then(function (res) {
	...
	function startSetDefault(param) {
	    return {
	        type: _constantEs6.START_SETDEFAULT,
	        param: param
	    };
	}
	...
	function finishSetDefault(param, res) {
	    return {
	        type: _constantEs6.FINISH_SETDEFAULT,
	        param: param,
	        res: res,
	        finishAt: Date.now()
	    };
	...
	function setDefault(param) {
	    return function (dispatch) {
	        ...
	        (0, _libUtilEs6.apiRequest)("/setdefaultreceiver", param, {
	            method: "POST"
	        }).then(function (res) {
	...
	var Coupon = (function (_Component) {
	    ...
	    _createClass(Coupon, [{
	        ...
	        value: function handleCheck(coupon) {
	            ...
	            var checkedCoupon = _props.checkedCoupon;
	        ...
	        value: function renderCouponRow() {
	            ...
	            var _props2 = this.props;
	            var coupons = _props2.coupons;
	            var checkedCoupon = _props2.checkedCoupon;
	            ...
	            if (coupons.length > 0) {
	                return coupons.map(function (coupon, i) {
	                    ...
	                    return _react2["default"].createElement(
	                        "div",
	                        { className: "coupon haitao hover", key: key,
	                            onClick: _this.handleCheck.bind(_this, coupon) },
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "left" },
	                            _react2["default"].createElement(
	                        ...
	                        checkedCoupon && checkedCoupon.couponNo === coupon.couponNo ? _react2["default"].createElement("div", { className: "selected" }) : null
	                    );
	                });
	            }
	            return _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.calculateTotalFee = calculateTotalFee;
	exports.submitOrder = submitOrder;
	exports.verifyOrder = verifyOrder;
	exports.fetchShipFee = fetchShipFee;
	exports.fetchPayGateway = fetchPayGateway;
	...
	function changeCoupon(checkedCoupon) {
	    return {
	        type: _constantEs6.CHANGE_COUPON,
	...
	function calculateTotalFee() {
	    return {
	        type: _constantEs6.CALCULATE_TOTALFEE
	    };
	}

	function startSubmitOrder(param) {
	    return {
	        type: _constantEs6.START_SUBMITORDER,
	        param: param
	    };
	}
	...
	function finishSubmitOrder(param, res) {
	    return {
	        type: _constantEs6.FINISH_SUBMITORDER,
	        param: param,
	        res: res,
	        finishAt: Date.now()
	    };
	...
	function startVerifyOrder(param) {
	    return {
	        type: _constantEs6.START_VERIFYORDER,
	        param: param
	    };
	}
	...
	function finishVerifyOrder(param, res) {
	    return {
	        type: _constantEs6.FINISH_VERIFYORDER,
	        param: param,
	        res: res,
	        responseAt: Date.now()
	    };
	...
	function verifyOrder(param) {
	    return function (dispatch) {
	        dispatch(startVerifyOrder(param));
	        (0, _libUtilEs6.apiRequest)("/verifyorder", param, { method: "POST" }).then(function (res) {
	...
	function requestShipFee(param) {
	    return {
	        type: _constantEs6.REQUEST_SHIPFEE,
	        param: param
	    };
	}
	...
	function responseShipFee(param, res) {
	    return {
	        type: _constantEs6.RESPONSE_SHIPFEE,
	        param: param,
	        res: res,
	        responseAt: Date.now()
	    };
	...
	function fetchShipFee(param) {
	    return function (dispatch) {
	        dispatch(requestShipFee(param));
	        (0, _libUtilEs6.apiRequest)("/shipfee", param).then(function (res) {
	...
	function requestPayGateway(param) {
	    return {
	        type: _constantEs6.REQUEST_PAYGATEWAY,
	        param: param
	    };
	}
	...
	function responsePayGateway(param, res) {
	    return {
	        type: _constantEs6.RESPONSE_PAYGATEWAY,
	        param: param,
	        res: res,
	        responseAt: Date.now()
	    };
	...
	function fetchPayGateway(param) {
	    return function (dispatch) {
	        dispatch(requestPayGateway(param));
	        (0, _libUtilEs6.apiRequest)("/paygateway/" + param, {}).then(function (res) {
	            if (!res.isFetched) {
	                dispatch((0, _commonActionEs6.alert)("获取订单信息失败!", 3000));
	            }
