...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkGoodlistAppJsx = __webpack_require__(541);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(542);
	...
	var _componentJsx = __webpack_require__(544);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(553);

	var actions = _interopRequireWildcard(_actionEs6);

	var GoodListConnected = (0, _reactRedux.connect)(function (state) {
	    return state;
	...
	var GoodListApp = (function (_Component) {
	    ...
	    _createClass(GoodListApp, [{
	        ...
	        value: function render() {
	            ...
	            var totalPage = _props$initialState.totalPage;
	            var filters = _props$initialState.filters;
	            var params = _props$initialState.params;
	            var list = _props$initialState.list;
	            var keyword = _props$initialState.keyword;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantEs6 = __webpack_require__(543);
	...
	function index(state, action) {
	    ...
	    switch (action.type) {
	        case _constantEs6.START_FETCH_GOODS:
	            return _Object$assign2({}, state, {
	                isFetching: true,
	                isFetched: false
	            });
	        case _constantEs6.FINISH_FETCH_GOODS:
	            return _Object$assign2({}, state, {
	                isFetching: false,
	        ...
	        case _constantEs6.START_REQUEST_GOODS:
	            return _Object$assign2({}, state, {
	                isFetching: true,
	                isFetched: false
	            });
	        case _constantEs6.FINISH_REQUEST_GOODS:
	            var list = [];
	            state.list.forEach(function (item) {
	                list.push(item);
	            });
	            action.res.list.forEach(function (item) {
	                list.push(item);
	            });
	            return _Object$assign2({}, state, {
	                isFetching: false,
	        ...
	        case _constantEs6.TOGGLE_CHECKED:
	            var filters = _extends({}, state.filters);
	            var _action$params = action.params,
	                name = _action$params.name,
	                values = _action$params.values;

	            filters[name] = values;
	            return _Object$assign2({}, state, {
	                filters: filters
	            });
	        case _constantEs6.RESET_FILTER:
	            ...
	            categoryNames.forEach(function (item, i) {
	                categoryNames[i] = _Object$assign2({}, item, { isChecked: false });
	            });
	            brandNames.forEach(function (item, i) {
	                brandNames[i] = _Object$assign2({}, item, { isChecked: false });
	            });
	            areaNames.forEach(function (item, i) {
	                areaNames[i] = _Object$assign2({}, item, { isChecked: false });
	            });
	            return _Object$assign2({}, state, {
	                filters: { categoryNames: categoryNames, brandNames: brandNames, areaNames: areaNames }
	            });
	        default:
	            return state;
	    }
...
/***/ function(module, exports) {
	...
	var START_FETCH_GOODS = "START_FETCH_GOODS";
	exports.START_FETCH_GOODS = START_FETCH_GOODS;
	var FINISH_FETCH_GOODS = "FINISH_FETCH_GOODS";
	exports.FINISH_FETCH_GOODS = FINISH_FETCH_GOODS;
	var START_REQUEST_GOODS = "START_REQUEST_GOODS";
	exports.START_REQUEST_GOODS = START_REQUEST_GOODS;
	var FINISH_REQUEST_GOODS = "FINISH_REQUEST_GOODS";
	exports.FINISH_REQUEST_GOODS = FINISH_REQUEST_GOODS;
	var TOGGLE_CHECKED = "TOGGLE_CHECKED";
	exports.TOGGLE_CHECKED = TOGGLE_CHECKED;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialIndexJsx = __webpack_require__(545);

	var _partialIndexJsx2 = _interopRequireDefault(_partialIndexJsx);

	var _indexPartialSearchJsx = __webpack_require__(550);

	var _indexPartialSearchJsx2 = _interopRequireDefault(_indexPartialSearchJsx);
	...
	var IndexRouter = (function (_Component) {
	    ...
	    _createClass(IndexRouter, [{
	        ...
	        value: function handleSceneChange(currentScene, prevScene) {
	            var fetchHotWord = this.props.fetchHotWord;
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "search" },
	                    _react2["default"].createElement(_indexPartialSearchJsx2["default"], this.props)
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sidebarJsx = __webpack_require__(546);

	var _sidebarJsx2 = _interopRequireDefault(_sidebarJsx);

	var _goodItemJsx = __webpack_require__(547);

	var _goodItemJsx2 = _interopRequireDefault(_goodItemJsx);

	var _goodStoreJsx = __webpack_require__(548);

	var _goodStoreJsx2 = _interopRequireDefault(_goodStoreJsx);

	var _filterJsx = __webpack_require__(549);
	...
	var GoodListApp = (function (_React$Component) {
	    ...
	    _createClass(GoodListApp, [{
	        ...
	        key: "toggleFilterPopup",
	        value: function toggleFilterPopup(type) {
	            this.setState({
	                filterType: type
	            });
	        }
	        ...
	        key: "toggleChecked",
	        value: function toggleChecked(name, values) {
	            this.props.toggleChecked({ name: name, values: values });
	        }
	    }, {
	        key: "handlerSave",
	        value: function handlerSave(isHaveGoods) {
	            var _props$index = this.props.index;
	            var params = _props$index.params;
	            var filters = _props$index.filters;
	            var categoryNames = filters.categoryNames;
	            var brandNames = filters.brandNames;
	            var areaNames = filters.areaNames;

	            var _params = _Object$assign({}, params, {
	        ...
	        key: "toggleSort",
	        value: function toggleSort(order) {
	            var params = this.props.index.params;

	            var _params = _Object$assign({}, params, order, { pageIndex: 1 });
	            this.props.fetchGoods(_params);
	        }
	    }, {
	        key: "beginRefresh",
	        value: function beginRefresh() {
	            var _props$index2 = this.props.index;
	            var params = _props$index2.params;
	            var totalPage = _props$index2.totalPage;
	            var isFetching = _props$index2.isFetching;

	            var curentPage = params.pageIndex;
	        ...
	        key: "render",
	        value: function render() {
	            var _props$index3 = this.props.index;
	            var keyword = _props$index3.keyword;
	            var totalPage = _props$index3.totalPage;
	            var filters = _props$index3.filters;
	            var list = _props$index3.list;
	            var params = _props$index3.params;
	            var isFetching = _props$index3.isFetching;
	            ...
	            list.forEach(function (item, i) {
	                goodList.push(_react2["default"].createElement(_goodItemJsx2["default"], { goods: item, key: 'good-' + i }));
	            });
	            var popup = (0, _classnames2["default"])({
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "div",
	                                { className: searchBox },
	                                _react2["default"].createElement("input", { type: "search", defaultValue: keyword,
	                        ...
	                        _react2["default"].createElement(_goodStoreJsx2["default"], { toggleSort: this.toggleSort.bind(this) }),
	                        _react2["default"].createElement(
	                            "div",
	                    ...
	                    _react2["default"].createElement(_sidebarJsx2["default"], {
	                    ...
	                    _react2["default"].createElement(_componentRefresherJsx2["default"], { handleRefresh: this.beginRefresh.bind(this), active: isFetching }),
	                    pageIndex == totalPage ? _react2["default"].createElement(
	                        "div",
	                        { className: "no-more" },
	                        "已显示全部内容"
	                    ) : null
	...
	var Sidebar = (function (_Component) {
	    ...
	    _createClass(Sidebar, [{
	        ...
	        value: function handleSave() {
	            var isHaveGoods = this.state.isHaveGoods;
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "span",
	                        { className: "btn-right", onClick: this.handleSave.bind(this) },
	                        "确定"
	                    )
	                ),
	                _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "dl",
	                        { onClick: this.props.toggleFilter.bind(this, 'category') },
	                        _react2["default"].createElement(
	                            "dt",
	                            null,
	                            "类别"
	                    ...
	                    _react2["default"].createElement(
	                        "dl",
	                        { onClick: this.props.toggleFilter.bind(this, 'brand') },
	                        _react2["default"].createElement(
	                            "dt",
	                            null,
	                            "品牌"
	                    ...
	                    _react2["default"].createElement(
	                        "dl",
	                        { onClick: this.props.toggleFilter.bind(this, 'area') },
	                        _react2["default"].createElement(
	                            "dt",
	                            null,
	                            "国家"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoodItem = (function (_Component) {
	    ...
	    _createClass(GoodItem, [{
	        key: "filterPrice",
	        value: function filterPrice(goods) {
	            if (goods.useMobilePrice && goods.mobilePrice > 0) {
	                return (0, _libUtilEs6.formatPrice)(goods.mobilePrice);
	            } else {
	                return (0, _libUtilEs6.formatPrice)(goods.salesPrice);
	            }
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            ...
	            var soldOut = (0, _classnames2["default"])({
	                "sale-out": goods.localStock > 0 ? false : true
	            });
	            var saleIcon = (0, _classnames2["default"])({
	                "mobile-price": goods.useMobilePrice
	            });
	            var salesPrice = this.filterPrice(goods);
	            var originPrice = (0, _libUtilEs6.formatPrice)(goods.originPrice);
	            return _react2["default"].createElement(
	                "a",
	                { href: "/gooddetail/" + goods.singleCode },
	                _react2["default"].createElement(
	                    "div",
	                    { className: "clearfix" },
	                    _react2["default"].createElement("div", { className: soldOut }),
	                    _react2["default"].createElement("div", { className: saleIcon }),
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "i",
	                            null,
	                            _react2["default"].createElement("img", { src: goods.sourceImageUrl, alt: "" })
	                        ),
	                        goods.sourceName
	                    ),
	                    _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoodSorter = (function (_Component) {
	    ...
	    function GoodSorter(props) {
	        ...
	        this.state = {
	            viewType: _constantEs6.SORT_DESC,
	            sortType: _constantEs6.SORT_NORMAL
	        };
	    }
	    ...
	    _createClass(GoodSorter, [{
	        ...
	        value: function sortBy(type) {
	            var toggleSort = this.props.toggleSort;

	            switch (type) {
	                case _constantEs6.SORT_NORMAL:
	                    toggleSort({
	                        sortType: _constantEs6.SORT_NORMAL,
	                        viewType: _constantEs6.SORT_DESC
	                    });
	                    break;
	                case _constantEs6.SORT_PRICE:
	                    toggleSort({
	                        sortType: _constantEs6.SORT_PRICE,
	                        viewType: this.state.viewType
	                    });
	                    break;
	                case _constantEs6.SORT_SALES:
	                    toggleSort({
	                        sortType: _constantEs6.SORT_SALES,
	                        viewType: _constantEs6.SORT_DESC
	                    });
	                    break;
	            }
	        ...
	        value: function render() {
	            var _state = this.state;
	            var sortType = _state.sortType;
	            var viewType = _state.viewType;

	            var normal = (0, _classnames2["default"])('normal', {
	                "active": sortType === _constantEs6.SORT_NORMAL
	            });
	            var price = (0, _classnames2["default"])("price", {
	                "active": sortType === _constantEs6.SORT_PRICE && viewType === _constantEs6.SORT_DESC,
	                "price-asc": sortType === _constantEs6.SORT_PRICE && viewType === _constantEs6.SORT_ASC
	            });
	            var sales = (0, _classnames2["default"])('sales', {
	                "active": sortType === _constantEs6.SORT_SALES
	            });
	            return _react2["default"].createElement(
	                "div",
	                null,
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { href: "javascript:;", className: normal, onClick: this.sortBy.bind(this, _constantEs6.SORT_NORMAL) },
	                        _react2["default"].createElement("i", null),
	                        "默认"
	                    ),
	                    _react2["default"].createElement(
	                        "a",
	                        { href: "javascript:;", className: price, onClick: this.sortBy.bind(this, _constantEs6.SORT_PRICE) },
	                        _react2["default"].createElement("i", null),
	                        "价格"
	                    ),
	                    _react2["default"].createElement(
	                        "a",
	                        { href: "javascript:;", className: sales, onClick: this.sortBy.bind(this, _constantEs6.SORT_SALES) },
	                        _react2["default"].createElement("i", null),
	                        "销量"
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Filter = (function (_Component) {
	    ...
	    _createClass(Filter, [{
	        ...
	        key: "renderNav",
	        value: function renderNav(items) {
	            var _this = this;
	            ...
	            var menu = items.map(function (item, i) {
	                ...
	                return _react2["default"].createElement(
	                    "dl",
	                    { onClick: _this.handleCheck.bind(_this, i), key: key },
	                    _react2["default"].createElement(
	                        "dt",
	                        null,
	                        item.name
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "span",
	                        { className: "btn-right", onClick: handleGoBack.bind(this) },
	                        "确定"
	                    )
	                ),
	                this.renderNav(list)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.requestGoods = requestGoods;
	...
	function startFetchGoods(param) {
	    return {
	        type: _constantEs6.START_FETCH_GOODS,
	        param: param
	    };
	}
	...
	function finishFetchGoods(param, res) {
	    return {
	        type: _constantEs6.FINISH_FETCH_GOODS,
	        param: param,
	        res: res
	    };
	}
	function startRequestGoods(param) {
	    return {
	        type: _constantEs6.START_REQUEST_GOODS,
	        param: param
	    };
	}
	...
	function finishRequestGoods(param, res) {
	    return {
	        type: _constantEs6.FINISH_REQUEST_GOODS,
	        param: param,
	        res: res
	    };
	}

	function fetchGoods(param) {
	    return function (dispath) {
	        dispath(startFetchGoods(param));
	        return (0, _libUtilEs6.apiRequest)('/search', param).then(function (res) {
	...
	function toggleChecked(params) {
	    return {
	        type: _constantEs6.TOGGLE_CHECKED,
	        params: params
	    };
	}
	...
	function resetFilter(params) {
	    return {
	        type: _constantEs6.RESET_FILTER,
	        params: params
	    };
	}
