...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkMembercenterAppJsx = __webpack_require__(582);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(583);
	...
	var _componentJsx = __webpack_require__(585);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(584);
	...
	var MemberCenter = (function (_Component) {
	    ...
	    _createClass(MemberCenter, [{
	        ...
	        value: function renderBanner() {
	            var _props$memberCenterByUser = this.props.memberCenterByUser;
	            var isLogined = _props$memberCenterByUser.isLogined;
	            var member = _props$memberCenterByUser.member;
	            var api = _props$memberCenterByUser.api;

	            if (isLogined === false) {
	                var loginUrl = api.loginUrl;
	                var registerUrl = api.registerUrl;
	                ...
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement("img", { src: member.imageUrl || "/client/asset/images/headpic.png" })
	                        ),
	                        _react2["default"].createElement("a", { className: "user-qr", href: "javascript:void(0);", onClick: this.togglePopupActive.bind(this) })
	                    ),
	                    _react2["default"].createElement(
	                        "span",
	                        null,
	        ...
	        value: function renderLogout() {
	            var _props$memberCenterByUser2 = this.props.memberCenterByUser;
	            var isLogined = _props$memberCenterByUser2.isLogined;
	            var api = _props$memberCenterByUser2.api;
	            var ua = _props$memberCenterByUser2.ua;

	            var microMessenger = ua.toLowerCase().match(/MicroMessenger/i) == "micromessenger" ? true : false;
	            if (isLogined === false || microMessenger) {
	                return null;
	            } else {
	                var logoutUrl = api.logoutUrl;
	                ...
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { className: "logoutBtn", href: logoutUrl },
	                        _react2["default"].createElement(
	                            "dl",
	                            null,
	                            _react2["default"].createElement(
	        ...
	        key: "renderOrderBanner",
	        value: function renderOrderBanner() {
	            var countOrder = this.props.memberCenterByUser.countOrder;

	            var count = {};
	            _lodash2["default"].forIn(countOrder, function (v, k) {
	                if (v > 0) {
	                    count[k] = v < 100 ? _react2["default"].createElement(
	                        "i",
	                        null,
	                        v
	                    ) : _react2["default"].createElement(
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "a",
	                    { href: "/orderlist/1", className: "userGoods_1" },
	                ...
	                _react2["default"].createElement(
	                    "a",
	                    { href: "/orderlist/2", className: "userGoods_2" },
	                    _react2["default"].createElement("em", null),
	                    _react2["default"].createElement(
	                        "span",
	                        null,
	                ...
	                _react2["default"].createElement(
	                    "a",
	                    { href: "/orderlist/3", className: "userGoods_3" },
	                    _react2["default"].createElement("em", null),
	                    _react2["default"].createElement(
	                        "span",
	                        null,
	                ...
	                _react2["default"].createElement(
	                    "a",
	                    { href: "/orderlist/4", className: "userGoods_4" },
	                    _react2["default"].createElement("em", null),
	                    _react2["default"].createElement(
	                        "span",
	                        null,
	        ...
	        key: "renderPopQr",
	        value: function renderPopQr() {
	            var _props$memberCenterByUser3 = this.props.memberCenterByUser;
	            var member = _props$memberCenterByUser3.member;
	            var isLogined = _props$memberCenterByUser3.isLogined;
	            ...
	            if (isLogined === false) {
	                ...
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "center" },
	                        _react2["default"].createElement("img", { src: member.promoterQr })
	                    ),
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "bottom" },
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(_componentMasklayerJsx2["default"], { visible: this.state.maskActive, handleClick: this.togglePopupActive.bind(this) }),
	                this.renderPopQr()
	            );
	        }
	    }]);
