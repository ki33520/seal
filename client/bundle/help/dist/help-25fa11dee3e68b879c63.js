...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkHelpAppJsx = __webpack_require__(394);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(395);
	...
	var _componentJsx = __webpack_require__(397);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	function selector(state) {
	    var helpInfo = state.helpInfo;
	    var feedbackByForm = state.feedbackByForm;
	...
	var HelpListConnected = (0, _reactRedux.connect)(selector)(_componentJsx2["default"]);
	...
	var HelpApp = (function (_Component) {
	    ...
	    _createClass(HelpApp, [{
	        key: "render",
	        value: function render() {
	            var helpInfo = this.props.initialState.helpInfo;
	            ...
	            return _react2["default"].createElement(
	                ...
	                { store: store },
	                _react2["default"].createElement(HelpListConnected, null)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionEs6 = __webpack_require__(396);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialMainJsx = __webpack_require__(398);

	var _partialMainJsx2 = _interopRequireDefault(_partialMainJsx);

	var _partialNormalJsx = __webpack_require__(399);

	var _partialNormalJsx2 = _interopRequireDefault(_partialNormalJsx);

	var _partialShipmentJsx = __webpack_require__(400);

	var _partialShipmentJsx2 = _interopRequireDefault(_partialShipmentJsx);

	var _partialTariffJsx = __webpack_require__(401);

	var _partialTariffJsx2 = _interopRequireDefault(_partialTariffJsx);

	var _partialParcelJsx = __webpack_require__(402);

	var _partialParcelJsx2 = _interopRequireDefault(_partialParcelJsx);

	var _partialOnlineserviceJsx = __webpack_require__(403);

	var _partialOnlineserviceJsx2 = _interopRequireDefault(_partialOnlineserviceJsx);

	var _partialFeedbackJsx = __webpack_require__(404);
	    ...
	    _createClass(HelpList, [{
	        ...
	        value: function render() {
	            ...
	            if (currentRoute === "index") {
	                currentView = _react2["default"].createElement(_partialMainJsx2["default"], _extends({}, this.props, { key: currentRoute }));
	            } else if (currentRoute === "normal") {
	                currentView = _react2["default"].createElement(_partialNormalJsx2["default"], _extends({}, this.props, { key: currentRoute }));
	            } else if (currentRoute === "shipment") {
	                currentView = _react2["default"].createElement(_partialShipmentJsx2["default"], _extends({}, this.props, { key: currentRoute }));
	            } else if (currentRoute === "tariff") {
	                currentView = _react2["default"].createElement(_partialTariffJsx2["default"], _extends({}, this.props, { key: currentRoute }));
	            } else if (currentRoute === "parcel") {
	                currentView = _react2["default"].createElement(_partialParcelJsx2["default"], _extends({}, this.props, { key: currentRoute }));
	            } else if (currentRoute === "onlineservice") {
	                currentView = _react2["default"].createElement(_partialOnlineserviceJsx2["default"], _extends({}, this.props, { key: currentRoute }));
	            } else if (currentRoute === "feedback") {
	                currentView = _react2["default"].createElement(_partialFeedbackJsx2["default"], _extends({}, this.props, { key: currentRoute }));
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelpMain = (function (_Component) {
	    ...
	    _createClass(HelpMain, [{
	        key: "render",
	        value: function render() {
	            var helpInfo = this.props.helpInfo;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Normal = (function (_Component) {
	    ...
	    function Normal(props) {
	        ...
	        _get(Object.getPrototypeOf(Normal.prototype), "constructor", this).call(this, props);
	    }
	    ...
	    _createClass(Normal, [{
	        ...
	        key: "handleChangeFeedback",
	        value: function handleChangeFeedback(e) {
	            e && e.preventDefault();
	            var _props = this.props;
	            var dispatch = _props.dispatch;
	            var feedbackByForm = _props.feedbackByForm;
	            var feedback = feedbackByForm.feedback;

	            dispatch((0, _actionEs6.changeFeedback)("/sendfeedback", {
	                feedback: feedback
	            }));
	        }
	    }, {
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            ...
	            if (nextProps.feedbackByForm.feedbackChanging === false && this.props.feedbackByForm.feedbackChanging === true) {
	                if (nextProps.feedbackByForm.feedbackChanged === true) {
	                    ...
	                    dispatch((0, _commonActionEs6.alert)(nextProps.feedbackByForm.errMsg, 2000));
	                }
	            }
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            var _props$feedbackByForm = this.props.feedbackByForm;
	            var feedback = _props$feedbackByForm.feedback;
	            var alertContent = _props$feedbackByForm.alertContent;
	            var alertActive = _props$feedbackByForm.alertActive;
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "span",
	                        { className: "btn-right", onClick: this.handleChangeFeedback.bind(this) },
	                        _react2["default"].createElement(
	                            "a",
	                            null,
	                            "保存"
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "feedback" },
	                        _react2["default"].createElement("textarea", { value: feedback, onChange: this.handleFieldChange.bind(this, "feedback"), placeholder: "请输入您反馈的内容，我们将不断改进" })
	                    )
	                ),
	                _react2["default"].createElement(
