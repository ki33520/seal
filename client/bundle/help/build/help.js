...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkHelpAppJsx = __webpack_require__(557);

	var _sharedChunkHelpAppJsx2 = _interopRequireDefault(_sharedChunkHelpAppJsx);
	...
	function bootstrap() {
	    ...
	    _reactDom2["default"].render(_react2["default"].createElement(_sharedChunkHelpAppJsx2["default"], { initialState: initialState }), document.getElementById('help-content'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(558);
	...
	var _componentJsx = __webpack_require__(560);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(559);
	...
	var HelpApp = (function (_Component) {
	    _inherits(HelpApp, _Component);

	    function HelpApp() {
	        _classCallCheck(this, HelpApp);

	        _get(Object.getPrototypeOf(HelpApp.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(HelpApp, [{
	        key: "render",
	        value: function render() {
	            var questionCategory = this.props.initialState.questionCategory;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function questionByForm(state, action) {
					...
					switch (action.type) {
									case _actionEs6.REQUEST_QUESTION:
													var questionList = _extends({}, state.questionList);
									...
									case _actionEs6.RESPONSE_QUESTION:
													var questionList = _extends({}, state.questionList);
	...
	function feedbackByForm(state, action) {
					...
					switch (action.type) {
									...
									case _actionEs6.START_CHANGE_FEEDBACK:
													return _Object$assign2({}, state, {
																	feedbackChanging: true,
																	feedbackChanged: false
													});
									case _actionEs6.FINISH_CHANGE_FEEDBACK:
													return _Object$assign2({}, state, {
	...
	var rootReducer = (0, _redux.combineReducers)({
					questionCategory: questionCategory,
					questionByForm: questionByForm,
					feedbackByForm: feedbackByForm
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CHANGE_FIELD = "CHANGE_FIELD";
	exports.CHANGE_FIELD = CHANGE_FIELD;
	var REQUEST_QUESTION = "REQUEST_QUESTION";
	exports.REQUEST_QUESTION = REQUEST_QUESTION;
	var RESPONSE_QUESTION = "RESPONSE_QUESTION";
	exports.RESPONSE_QUESTION = RESPONSE_QUESTION;
	var START_CHANGE_FEEDBACK = "START_CHANGE_FEEDBACK";
	exports.START_CHANGE_FEEDBACK = START_CHANGE_FEEDBACK;
	var FINISH_CHANGE_FEEDBACK = "FINISH_CHANGE_FEEDBACK";

	exports.FINISH_CHANGE_FEEDBACK = FINISH_CHANGE_FEEDBACK;
	...
	function fetchQuestion(url, param) {
	    return function (dispatch) {
	...
	function changeFeedback(url, param) {
	    return function (dispatch) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialMainJsx = __webpack_require__(561);

	var _partialMainJsx2 = _interopRequireDefault(_partialMainJsx);

	var _partialQuestionJsx = __webpack_require__(562);

	var _partialQuestionJsx2 = _interopRequireDefault(_partialQuestionJsx);

	var _partialOnlineserviceJsx = __webpack_require__(563);

	var _partialOnlineserviceJsx2 = _interopRequireDefault(_partialOnlineserviceJsx);

	var _partialFeedbackJsx = __webpack_require__(564);

	var _partialFeedbackJsx2 = _interopRequireDefault(_partialFeedbackJsx);
	...
	var HelpList = (function (_Component) {
	    _inherits(HelpList, _Component);

	    function HelpList(props) {
	        _classCallCheck(this, HelpList);

	        _get(Object.getPrototypeOf(HelpList.prototype), "constructor", this).call(this, props);
	        var questionCategory = props.questionCategory;
	    }

	    _createClass(HelpList, [{
	        key: "handleSceneChange",
	        value: function handleSceneChange(currentScene, value) {
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    { name: "index" },
	                    _react2["default"].createElement(_partialMainJsx2["default"], this.props)
	                ),
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "question" },
	                    _react2["default"].createElement(_partialQuestionJsx2["default"], this.props)
	                ),
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "onlineservice" },
	                    _react2["default"].createElement(_partialOnlineserviceJsx2["default"], this.props)
	                ),
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "feedback" },
	                    _react2["default"].createElement(_partialFeedbackJsx2["default"], this.props)
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelpMain = (function (_Component) {
	    _inherits(HelpMain, _Component);

	    function HelpMain() {
	        _classCallCheck(this, HelpMain);

	        _get(Object.getPrototypeOf(HelpMain.prototype), "constructor", this).apply(this, arguments);
	    }
	    ...
	    _createClass(HelpMain, [{
	        ...
	        value: function renderQuestion() {
	            ...
	            var _props = this.props;
	            var questionCategory = _props.questionCategory;
	            var changeScene = _props.changeScene;
	            var result = questionCategory.result;
	                ...
	                _react2["default"].createElement(
	                    ...
	                    result.map(function (v, k) {
	                        return _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "a",
	                                { href: "javascript:void(null)", onClick: changeScene.bind(_this, "question", v) },
	                                k + 1 + ".",
	                                v.catalogName
	                            )
	                        );
	...
	var Question = (function (_Component) {
	    ...
	    _createClass(Question, [{
	        ...
	        value: function beginRefresh() {
	            ...
	            var fetchQuestion = _props.fetchQuestion;
	            var _props$questionByForm = this.props.questionByForm;
	            var questionList = _props$questionByForm.questionList;
	            var isFetching = _props$questionByForm.isFetching;
	        ...
	        value: function renderList() {
	            var _props$questionByForm2 = this.props.questionByForm;
	            var questionList = _props$questionByForm2.questionList;
	            var isFetching = _props$questionByForm2.isFetching;

	            if (questionList && questionList.list.length > 0) {
	                var list = questionList.list;
	        ...
	        value: function render() {
	            ...
	            var _props$questionByForm3 = this.props.questionByForm;
	            var questionList = _props$questionByForm3.questionList;
	            var isFetching = _props$questionByForm3.isFetching;
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "header",
	                    { className: "header" },
	                    _react2["default"].createElement("a", { href: "javascript:void(null)", onClick: changeScene.bind(this, "index"), className: "iconfont icon-back" }),
	                    _react2["default"].createElement(
	                        "span",
	                        { className: "title" },
	                        questionList && questionList.catalogName
	                    )
	                ),
	                _react2["default"].createElement(
	                    "div",
	                    { className: "question-list-wrap" },
	                    _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Normal = (function (_Component) {
	    ...
	    function Normal() {
	        ...
	        _get(Object.getPrototypeOf(Normal.prototype), "constructor", this).apply(this, arguments);
	    }
