...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkPolymerAppJsx = __webpack_require__(642);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(643);
	...
	var _componentJsx = __webpack_require__(645);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(654);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantsEs6 = __webpack_require__(644);
	...
	function allCategory(state, action) {
	    ...
	    switch (action.type) {
	        case _constantsEs6.REQUEST_CATEGORYACTIVITY:
	            return _Object$assign2({}, state, {
	                categoryActivityFetched: false,
	                categoryActivityFetching: true
	            });
	        case _constantsEs6.RESPONSE_CATEGORYACTIVITY:
	...
	function categoryBrands(state, action) {
	    ...
	    switch (action.type) {
	        ...
	        case _constantsEs6.RESPONSE_CATEGORYBRANDS:
	            ...
	            return _Object$assign2({}, state, _extends({}, categorybrands, {
	...
	function search(state, action) {
	    ...
	    switch (action.type) {
	        ...
	        case _constantsEs6.REQUEST_ASSOICATEWORD:
	            return _Object$assign2({}, state, {
	                associateWordFetched: false,
	                associateWordFetching: true
	            });
	        case _constantsEs6.RESPONSE_ASSOICATEWORD:
...
/***/ function(module, exports) {
	...
	var REQUEST_CATEGORYACTIVITY = "REQUEST_CATEGORYACTIVITY";
	exports.REQUEST_CATEGORYACTIVITY = REQUEST_CATEGORYACTIVITY;
	var RESPONSE_CATEGORYACTIVITY = "RESPONSE_CATEGORYACTIVITY";

	exports.RESPONSE_CATEGORYACTIVITY = RESPONSE_CATEGORYACTIVITY;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialPolymerJsx = __webpack_require__(646);

	var _partialPolymerJsx2 = _interopRequireDefault(_partialPolymerJsx);

	var _partialAllbrandsJsx = __webpack_require__(651);

	var _partialAllbrandsJsx2 = _interopRequireDefault(_partialAllbrandsJsx);

	var _partialSearchJsx = __webpack_require__(653);
	...
	var PolymerRouter = (function (_Component) {
	    ...
	    function PolymerRouter() {
	        _classCallCheck(this, PolymerRouter);

	        _get(Object.getPrototypeOf(PolymerRouter.prototype), "constructor", this).apply(this, arguments);
	    }
	    ...
	    _createClass(PolymerRouter, [{
	        ...
	        value: function handleSceneChange(currentScene, prevScene) {
	            ...
	            var fetchAllBrands = _props.fetchAllBrands;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentSwiperJsx = __webpack_require__(647);

	var _categoryJsx = __webpack_require__(648);

	var _categoryJsx2 = _interopRequireDefault(_categoryJsx);

	var _brandJsx = __webpack_require__(649);

	var _brandJsx2 = _interopRequireDefault(_brandJsx);

	var _originJsx = __webpack_require__(650);
	...
	var Polymer = (function (_Component) {
	    ...
	    _createClass(Polymer, [{
	        ...
	        key: "render",
	        value: function render() {
	            var changeScene = this.props.changeScene;
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(null)", onClick: changeScene.bind(this, "search") },
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        _componentSwiperJsx.Swiper,
	                        { onSelect: this.handleSelect.bind(this) },
	                        _react2["default"].createElement(
	                            _componentSwiperJsx.SwiperItem,
	                            { control: function () {
	                                    return _react2["default"].createElement(
	                                        "b",
	                                        null,
	                            ...
	                            _react2["default"].createElement(_categoryJsx2["default"], _extends({}, this.props.allCategory, this.props))
	                        ),
	                        _react2["default"].createElement(
	                            _componentSwiperJsx.SwiperItem,
	                            { control: function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Swiper = (function (_Component) {
	    ...
	    _createClass(Swiper, [{
	        ...
	        value: function renderControl() {
	            ...
	            var controlItems = [];
	            _react2["default"].Children.forEach(this.props.children, function (child, i) {
	                var classes = (0, _classnames2["default"])("swiper-control-item", {
	                    active: i === _this2.state.activeIndex
	                });
	                var control = child.props.control;

	                controlItems.push(_react2["default"].createElement(
	                    "span",
	        ...
	        key: "renderSlidingContent",
	        value: function renderSlidingContent() {
	            var contentItems = _react2["default"].Children.map(this.props.children, this.renderContent.bind(this));
	            return _react2["default"].createElement(
	                "div",
	                { className: "swiper-sliding-content" },
	                contentItems
	            );
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            var contentClasses = (0, _classnames2["default"])("swiper-content", {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    this.props.contentSliding ? this.renderSlidingContent() : _react2["default"].Children.map(this.props.children, this.renderContent.bind(this))
	                )
	            );
	        }
	    }]);
	...
	var SwiperItem = (function (_Component2) {
	    _inherits(SwiperItem, _Component2);

	    function SwiperItem() {
	        _classCallCheck(this, SwiperItem);

	        _get(Object.getPrototypeOf(SwiperItem.prototype), "constructor", this).apply(this, arguments);
	    }
	    ...
	    _createClass(SwiperItem, [{
	        ...
	        value: function render() {
	            ...
	            var classes = (0, _classnames2["default"])("swiper-item", {
	                active: active
	            });
	            return _react2["default"].createElement(
	                "div",
	    ...
	    _createClass(Category, [{
	        ...
	        value: function renderCategory(category) {
	            var children = category.children.map(function (child, i) {
	                return _react2["default"].createElement(
	                    "a",
	                    { href: "/search?categoryName=" + child.name, className: "cg", key: i },
	                    _react2["default"].createElement("img", { src: child.imageUrl }),
	                    _react2["default"].createElement(
	                        "div",
	                        null,
	                        child.name
	            ...
	            return _react2["default"].createElement(
	                "div",
	                { className: "rightCon" },
	                category.activity ? _react2["default"].createElement(
	                    "a",
	                    { href: category.activity.jumpUrl, className: "ad" },
	                    _react2["default"].createElement("img", { src: category.activity.imageUrl })
	                ) : null,
	                _react2["default"].createElement(
	                    "div",
	                    { className: "content" },
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    _componentSwiperJsx.Swiper,
	                    { axis: "y", onSelect: this.handleSelect.bind(this) },
	                    tabs
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Brand = (function (_Component) {
	    ...
	    _createClass(Brand, [{
	        ...
	        value: function renderRecommendBrands() {
	            ...
	            if (recommendBrands) {
	                return recommendBrands.map(function (brand, i) {
	                    return _react2["default"].createElement(
	                        "a",
	                        { href: "/search?brandName=" + brand.chineseName, key: i },
	                        _react2["default"].createElement(
	                            "div",
	                            null,
	            ...
	            if (categories) {
	                return categories.map(function (category, i) {
	                    var brands = category.brands.map(function (brand, k) {
	                        return _react2["default"].createElement(
	                            "a",
	                            { href: "/search?brandName=" + brand.chineseName, key: k },
	                            _react2["default"].createElement(
	                                "div",
	                                null,
	                                _react2["default"].createElement("img", { src: brand.imageUrl })
	        ...
	        key: "render",
	        value: function render() {
	            var isFetching = _lodash2["default"].isEmpty(this.props.categoryBrands) ? true : this.props.categoryBrands.categoryBrandsFetching;
	            return _react2["default"].createElement(
	                "div",
	                { className: "poly_2" },
	                _react2["default"].createElement(
	                    "a",
	                    { href: "javascript:void(null)", onClick: this.props.changeScene.bind(this, "allbrands"),
	                        className: "allBrand" },
	                    "全部品牌",
	                ...
	                this.renderCategory(),
	                _react2["default"].createElement(_commonLoadingJsx2["default"], { active: isFetching })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Origin = (function (_Component) {
	    ...
	    _createClass(Origin, [{
	        ...
	        value: function renderOrigin() {
	            ...
	            if (origins) {
	                return origins.map(function (origin, i) {
	                    return _react2["default"].createElement(
	                        "a",
	                        { href: "/search?areaName=" + origin.name, key: i },
	        ...
	        key: "render",
	        value: function render() {
	            var isFetching = _lodash2["default"].isEmpty(this.props.allOrigin) ? true : this.props.allOrigin.originFetching;
	            return _react2["default"].createElement(
	                "div",
	                null,
	                _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentScrollnavJsx = __webpack_require__(652);
	    ...
	    _createClass(AllBrands, [{
	        ...
	        value: function renderBrand() {
	            ...
	            if (brands) {
	                ...
	                var _loop = function (key) {
	                    var brandGroupItems = [];
	                    brands[key].forEach(function (brand, i) {
	                        brandGroupItems.push(_react2["default"].createElement(
	                            "li",
	                            { key: i },
	                            _react2["default"].createElement(
	                                "a",
	                                { href: "/search?brandName=" + brand.chineseName },
	                                brand.chineseName
	                            )
	                        ));
	                    });
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(_commonLoadingJsx2["default"], { active: this.props.allBrand.brandsFetching })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchCategoryActivity = fetchCategoryActivity;
	...
	function responseCategoryActivity(param, res) {
	    return {
	        type: _constantsEs6.RESPONSE_CATEGORYACTIVITY,
	        param: param,
	        res: res
	    };
	}
	...
	function requestCategoryActivity(param) {
	    return {
	        type: _constantsEs6.REQUEST_CATEGORYACTIVITY,
	        param: param
	    };
	}

	function fetchCategoryActivity(param) {
	    return function (dispath) {
	        dispath(requestCategoryActivity(param));
	        return (0, _libUtilEs6.apiRequest)("/categoryactivity", param).then(function (res) {
	...
	function requestAssociateWord(param) {
	    return {
	        type: _constantsEs6.REQUEST_ASSOICATEWORD,
	        param: param
	    };
	}
	...
	function responseAssociateWord(param, res) {
	    return {
	        type: _constantsEs6.RESPONSE_ASSOICATEWORD,
	        param: param,
	        res: res
	    };
	}
