...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkFlashbuyAppJsx = __webpack_require__(504);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerEs6 = __webpack_require__(505);
	...
	var _componentJsx = __webpack_require__(507);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(506);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FlashBuy = (function (_Component) {
	    ...
	    _createClass(FlashBuy, [{
	        key: "filterPrice",
	        value: function filterPrice(goods, status) {
	            if (goods.flashPrice && goods.flashPrice > 0 && status === 'ing') {
	                return (0, _libUtilEs6.formatPrice)(goods.flashPrice);
	        ...
	        key: "renderGoods",
	        value: function renderGoods(groupGoods, status) {
	            var _this = this;

	            if (groupGoods.length > 0) {
	                return groupGoods.map(function (goods, i) {
	                    var saleState = (0, _classnames2["default"])({
	                        "sale-out": goods.localStock < 1 && goods.onSale,
	                        "put-off": !goods.onSale
	                    });
	                    var salesPrice = _this.filterPrice(goods, status);
	        ...
	        key: "renderFlashing",
	        value: function renderFlashing() {
	            var _this2 = this;

	            var flashGoods = this.props.flashBuy.groupGoods.flashGoods;

	            if (flashGoods.length > 0) {
	                return flashGoods.map(function (goods, i) {
	                    return _react2["default"].createElement(
	                        "div",
	                        { className: "flashList", key: "gi-" + i },
	                        _react2["default"].createElement(
	                            "div",
	                            ...
	                            _react2["default"].createElement(
	                                "p",
	                                null,
	                                _react2["default"].createElement(_commonTimerJsx2["default"], { endTime: goods.endTime, dayEnable: true,
	                        ...
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "flashBuy" },
	                            _this2.renderGoods(goods.goodsList, 'ing')
	                        )
	                    );
	                });
	            }
	        ...
	        key: "renderPreFlash",
	        value: function renderPreFlash() {
	            var _this3 = this;

	            var preFlashGoods = this.props.flashBuy.groupGoods.preFlashGoods;

	            if (preFlashGoods.length > 0) {
	                return preFlashGoods.map(function (goods, i) {
	                    return _react2["default"].createElement(
	                        "div",
	                        { className: "willFlash", key: "gr-" + i },
	                        _react2["default"].createElement(
	                            "div",
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "div",
	                                { className: "flashBuy" },
	                                _this3.renderGoods(goods.goodsList, 'pre')
	                            ),
	        ...
	        key: "render",
	        value: function render() {
	            var flashing = this.renderFlashing();
	            var preflash = this.renderPreFlash();
	            var emptyMsg = null;
	            if (flashing === null && preflash === null) {
	                emptyMsg = _react2["default"].createElement(
	                    "div",
