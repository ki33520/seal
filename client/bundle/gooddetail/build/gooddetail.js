...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$assign = __webpack_require__(272)["default"];
	...
	exports.destPriceForGoods = destPriceForGoods;
	exports.formatPrice = formatPrice;
	exports.formateIDCard = formateIDCard;
	exports.validTimeRegion = validTimeRegion;
	exports.registerPullDownEvent = registerPullDownEvent;
	exports.disableHistoryForwardCacheThen = disableHistoryForwardCacheThen;
	...
	var _md5 = __webpack_require__(294);
	...
	function destPriceForGoods(goods) {
	...
	function formatPrice(price) {
	    ...
	    if (_lodash2["default"].isNumber(price) === false) {
	        if (_lodash2["default"].isString(price)) {
	            if (/^(\d+)(\.)?(\d)*$/.test(price) === false) {
	                return "0.00";
	            }
	        }
	        price = parseFloat(price);
	        if (_lodash2["default"].isNaN(price)) {
	            return "0.00";
	        }
	    }
	...
	function formateIDCard(idCard) {
	    idCard = _lodash2["default"].words(idCard, /\w{1}/g);
	    idCard = _lodash2["default"].map(idCard, function (v, i) {
	        if (i > 5 && i < 14) {
	            v = "*";
	        }
	        return v;
	...
	function validTimeRegion(startTime, endTime) {
	    if ((0, _moment2["default"])().isBefore(startTime) === true) {
	        return -1;
	    } else if ((0, _moment2["default"])().isAfter(endTime) === true) {
	        return 1;
	    } else {
	        return 0;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(){
	  var crypt = __webpack_require__(295),
	      utf8 = __webpack_require__(296).utf8,
	      isBuffer = __webpack_require__(297),
	      bin = __webpack_require__(296).bin,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libDomEs6 = __webpack_require__(400);
	...
	var Refresher = (function (_React$Component) {
	    ...
	    _createClass(Refresher, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            this.scrollNode = _reactDom2["default"].findDOMNode(this).parentNode;
	            // console.log('scrollNode',this.scrollNode)
	            _libDomEs62["default"].bindEvent(this.scrollNode, "scroll", function (e) {
	                _this.handleScroll(_this.scrollNode);
	            });
	        }
	    }, {
	        key: "handleScroll",
	        value: function handleScroll(scrollNode) {
	            var _props = this.props;
	            var handleRefresh = _props.handleRefresh;
	            var threshold = _props.threshold;

	            var scrollTop = _libDomEs62["default"].scrollTop(scrollNode);
	        ...
	        value: function componentWillUnmount() {
	            ...
	            _libDomEs62["default"].unbindEvent(this.scrollNode, "scroll", function (e) {
	                _this2.handleScroll(_this2.scrollNode);
	            });
	        }
	    }, {
	        key: "render",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _domRequestAnimationFrame = __webpack_require__(401);
	...
	var dom = {
	  ...
	  registerPullDownEvent: function registerPullDownEvent(callback) {
	    var _this = this;

	    var self;
	    this.bindEvent(window, 'scroll', function () {
	      var scrollTop = _this.scrollTop(window);
	      if (document.documentElement.clientHeight + scrollTop >= document.documentElement.scrollHeight) {
	        callback();
	      }
	    });
...
/***/ function(module, exports) {
	...
	if(typeof window !== "undefined"){
	  ...
	  window.requestAnimationFrame.call(window,function() {});
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _iconJsx = __webpack_require__(403);
	...
	var GoTop = (function (_Component) {
	    ...
	    _createClass(GoTop, [{
	        key: "toggleVisble",
	        value: function toggleVisble(scrollTop) {
	            if (scrollTop > 50) {
	        ...
	        value: function handleScroll() {
	            var scrollTop = _libDomEs62["default"].scrollTop(this.scrollNode);
	        ...
	        value: function componentDidMount() {
	            ...
	            if (this.props.relative) {
	                this.scrollNode = _reactDom2["default"].findDOMNode(this.refs["scrollNode"]);
	            }
	            _libDomEs62["default"].bindEvent(this.scrollNode, 'scroll', _lodash2["default"].debounce(this.handleScroll.bind(this), 10));
	        }
	    }, {
	        key: "componentWillUnmount",
	        value: function componentWillUnmount() {
	            _libDomEs62["default"].unbindEvent(this.scrollNode, 'scroll', _lodash2["default"].debounce(this.handleScroll.bind(this), 10));
	        }
	    }, {
	        key: "backToTop",
	        value: function backToTop() {
	            _libDomEs62["default"].scrollTop(this.scrollNode, 0);
	        ...
	        value: function renderButton() {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "a",
	                    { href: null, onClick: this.backToTop.bind(this) },
	                    _react2["default"].createElement(_iconJsx2["default"], { icon: "up" })
	                )
	            );
	        }
	    }, {
	        ...
	        value: function render() {
	            if (this.props.relative) {
	                var renderFixed = this.props.renderFixed;
	                ...
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "back-to-top-inner", ref: "scrollNode" },
	                        this.props.children
	                    )
	                );
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defineProperty = __webpack_require__(404)["default"];
...
/***/ function(module, exports) {
	...
	var SHOW_ACTIVITYINDICATOR = "SHOW_ACTIVITYINDICATOR";
	exports.SHOW_ACTIVITYINDICATOR = SHOW_ACTIVITYINDICATOR;
	var HIDE_ACTIVITYINDICATOR = "HIDE_ACTIVITYINDICATOR";

	exports.HIDE_ACTIVITYINDICATOR = HIDE_ACTIVITYINDICATOR;
	var CHANGE_SCENE = "CHANGE_SCENE";
	exports.CHANGE_SCENE = CHANGE_SCENE;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.activityIndicatorReducer = activityIndicatorReducer;
	exports.sceneReducer = sceneReducer;

	var _constantEs6 = __webpack_require__(416);

	function alertReducer(state, action) {
	    if (state === undefined) state = {};

	    switch (action.type) {
	        case _constantEs6.SHOW_ALERT:
	            return _Object$assign({}, state, {
	                alertActive: true,
	                alertContent: action.content
	            });
	        case _constantEs6.HIDE_ALERT:
	            return _Object$assign({}, state, {
	                alertActive: false,
	                alertContent: action.content
	            });
	...
	function activityIndicatorReducer(state, action) {
	    if (state === undefined) state = {};

	    switch (action.type) {
	        case _constantEs6.SHOW_ACTIVITYINDICATOR:
	            return _Object$assign({}, state, {
	                activityIndicatorContent: action.content,
	                activityIndicatorActive: true
	            });
	        case _constantEs6.HIDE_ACTIVITYINDICATOR:
	            return _Object$assign({}, state, {
	...
	function sceneReducer(state, action) {
	    ...
	    switch (action.type) {
	        case CHANGE_SCENE:
	            var prevScene = state.currentScene || null;
	            var currentScene = action.scene;
	            return _Object$assign({}, state, {
	                prevScene: prevScene, currentScene: currentScene
	            });
	        default:
	            return state;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Number$isNaN = __webpack_require__(422)["default"];

	var _Number$isFinite = __webpack_require__(425)["default"];
	...
	var NumberPicker = (function (_Component) {
	    ...
	    _createClass(NumberPicker, [{
	        ...
	        value: function handleChange(e) {
	            ...
	            if (_Number$isNaN(inputValue) || _Number$isFinite(inputValue)) {
	                return;
	            }
	            this.setState({
	                value: inputValue
	        ...
	        value: function render() {
	            ...
	            var minimum = _props3.minimum;
	            var maximum = _props3.maximum;

	            var classes = (0, _classnames2["default"])("number-picker", {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement("input", { type: type, readOnly: readonly, onChange: this.handleChange.bind(this), value: this.state.value }),
	                _react2["default"].createElement(
	                    "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(19).Number.isNaN;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(19).Number.isFinite;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.hideActivityIndicator = hideActivityIndicator;
	...
	function showActivityIndicator(content) {
	    return {
	        type: _constantEs6.SHOW_ACTIVITYINDICATOR,
	        content: content
	    };
	}

	function hideActivityIndicator(content) {
	    return {
	        type: _constantEs6.HIDE_ACTIVITYINDICATOR,
	        content: content
	    };
	}

	function changeScene(param) {
	    return {
	        type: _constantEs6.CHANGE_SCENE,
	        param: param
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _from = __webpack_require__(460);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SceneGroup = (function (_Component) {
	    _inherits(SceneGroup, _Component);

	    function SceneGroup(props) {
	        _classCallCheck(this, SceneGroup);

	        _get(Object.getPrototypeOf(SceneGroup.prototype), "constructor", this).call(this, props);
	        this.state = {
	    ...
	    _createClass(SceneGroup, [{
	        key: "handleChange",
	        value: function handleChange(scene, param, e) {
	            var _this = this;

	            var prevScene = this.state.currentScene;
	            this.setState({
	                currentScene: scene,
	                prevScene: prevScene
	            }, function () {
	                setTimeout(function () {
	                    return _this.props.onChange(scene, param, prevScene);
	                }, 300);
	            });
	        }
	    }, {
	        ...
	        key: "renderScene",
	        value: function renderScene(child, i) {
	            var _state = this.state;
	            var currentScene = _state.currentScene;
	            var prevScene = _state.prevScene;
	        ...
	        key: "render",
	        value: function render() {
	            var classes = (0, _classnames2["default"])("scene-group", {
	                "animation-disabled": this.state.prevScene === null
	            });
	            return _react2["default"].createElement(
	                "div",
	                { className: classes },
	                _react2["default"].Children.map(this.props.children, this.renderScene.bind(this))
	            );
	        }
	    }]);
	...
	var Scene = (function (_Component2) {
	    ...
	    _createClass(Scene, [{
	        ...
	        value: function render() {
	            ...
	            var changeScene = _props.changeScene;
	            var resetScene = _props.resetScene;
	            var scrollable = _props.scrollable;

	            var classes = (0, _classnames2["default"])("scene", {
	                scrollable: scrollable,
	                active: active,
	                prev: prev
	            });
	            var child = _react2["default"].Children.only(this.props.children);
	            child = _react2["default"].cloneElement(child, _Object$assign({}, child.props, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slidableJsx = __webpack_require__(492);
	...
	var _libDomNobounceScrollEs6 = __webpack_require__(474);
	    ...
	    _createClass(SlideTabs, [{
	        ...
	        value: function handleSelect(i, e) {
	            ...
	            this.setState({
	                ...
	                if (_this.props.contentSlidable === false) {
	                    var transform = null;
	                    if (_this.props.axis === "x") {
	                        var translateX = _this.state.activeIndex * window.innerWidth > 0 ? -(_this.state.activeIndex * window.innerWidth) : 0;
	                        translateX = window.px2rem ? window.px2rem(translateX) + "rem" : translateX + "px";
	                        transform = "translate3D(" + translateX + ",0,0)";
	                    }
	                    var contentNode = _reactDom2["default"].findDOMNode(_this.refs["contentNode"]);
	        ...
	        value: function render() {
	            ...
	            var tabsContent = _react2["default"].createElement(
	                "div",
	                { className: "slide-tabs-content slide-tabs-content-fixed", ref: "contentNode"
	                },
	            ...
	            if (this.props.contentSlidable === true) {
	                tabsContent = _react2["default"].createElement(
	                    _slidableJsx2["default"],
	                    { axis: this.props.axis, ref: "contentNode",
	...
	var SlideTabsItem = (function (_Component2) {
	    ...
	    _createClass(SlideTabsItem, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            var itemStyle = {};
	            var itemWidth = contentNode.parentNode.parentNode.offsetWidth;
	            var itemHeight = contentNode.parentNode.parentNode.offsetHeight;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libDomRequestAnimationFrame = __webpack_require__(401);
	...
	var Slidable = (function (_Component) {
	    ...
	    _createClass(Slidable, [{
	        ...
	        value: function handleTouchEnd(e) {
	            ...
	            if (this.startTouchX !== clientX || this.startTouchY !== clientY) {
	                var _ret2 = (function () {
	                    ...
	                    _this3.endTouchY = clientY;
	                    _this3.endTouchX = clientX;
	                    var inTouchableRegion = _libDomEs62["default"].inTouchableRegion(clientX, clientY, e.currentTarget);
	                    if (_this3.props.onlyInside && !inTouchableRegion) {
	                        return {
	                            v: undefined
	                        };
	                    }
	                    ...
	                    // "x":"y";
	                    if (_this3.moveDirection !== axis) {
	                        return {
	                            v: undefined
	                        };
	                    }
	                    var activeIndex = _this3.state.activeIndex;
	                    var itemNode = _reactDom2["default"].findDOMNode(_this3).firstChild;
	                    if (axis === "y") {
	                        ...
	                        _this3.translateY = activeIndex * itemNode.offsetHeight > 0 ? -(activeIndex * itemNode.offsetHeight) : 0;
	                    } else if (axis === "x") {
	                        ...
	                        _this3.translateX = activeIndex * itemNode.offsetWidth > 0 ? -(activeIndex * itemNode.offsetWidth) : 0;
	                    }
	                    _this3.checkBound();
	                    ...
	                    var transitionTouch = _this3.transitionTouch.bind(_this3, animateDuration);
	                    ...
	                    transitionTouch();
	                    // rAF(this.transitionTouch.bind(this,animateDuration))
	                    _libDomEs62["default"].removeClass(_reactDom2["default"].findDOMNode(_this3), "sliding");
	                })();
	        ...
	        value: function handleTouchMove(e) {
	            ...
	            var moveY = Math.abs(clientY - this.startTouchY);
	            var moveX = Math.abs(clientX - this.startTouchX);
	            if (axis === "x" && moveX < 3) {
	                // return
	            } else if (axis === "y" && moveY < 3) {
	                    // return
	                }
	            var touchAngle = Math.atan2(moveY, moveX) * 180 / Math.PI;
	            // console.log('touchAngle',touchAngle,moveY,moveX)
	            var moveDirection = touchAngle < 15 ? "x" : "y";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabs = (function (_Component) {
	    ...
	    _createClass(Tabs, [{
	        ...
	        value: function renderNavBar() {
	            ...
	            var navItems = titles.map(function (title, i) {
	                var classes = (0, _classnames2["default"])({
	...
	var TabsItem = (function (_Component2) {
	    ...
	    function TabsItem() {
	        ...
	        _get(Object.getPrototypeOf(TabsItem.prototype), "constructor", this).apply(this, arguments);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = (function (_Component) {
	    ...
	    _createClass(Timer, [{
	        key: "restOfTime",
	        value: function restOfTime(duration) {
	            if (duration <= 0) {
	        ...
	        key: "tickTack",
	        value: function tickTack() {
	            var _this = this;

	            var _props = this.props;
	            var endTime = _props.endTime;
	            var referTime = _props.referTime;
	            var format = _props.format;

	            var diffTime = 0;
	            if (referTime) {
	                diffTime = (0, _moment2["default"])(referTime, format).diff((0, _moment2["default"])());
	            }
	            var interval = function interval() {
	                var nowTime = (0, _moment2["default"])();
	                if (endTime) {
	                    var duration = (0, _moment2["default"])(endTime, format) - nowTime + diffTime;
	                    _this.setState({
	                        duration: duration
	                    });
	                }
	                _this.timeout = setTimeout(interval, 1000);
	            };
	            interval();
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            var _restOfTime = this.restOfTime(duration);

	            var day = _restOfTime.day;
	            var hour = _restOfTime.hour;
	            var minute = _restOfTime.minute;
	            var second = _restOfTime.second;

	            var compiled = _lodash2["default"].template(this.props.template);
	            var durationContent = compiled({
	                day: day, hour: hour, minute: minute, second: second
	            });
	            return _react2["default"].createElement("span", { className: "timer", dangerouslySetInnerHTML: { __html: durationContent } });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sharedChunkGooddetailAppJsx = __webpack_require__(514);
	...
	Object.assign = _Object$assign || __webpack_require__(407);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _interopRequireWildcard = __webpack_require__(412)["default"];
	...
	var _reducerEs6 = __webpack_require__(515);
	...
	var _componentJsx = __webpack_require__(517);

	var _componentJsx2 = _interopRequireDefault(_componentJsx);

	var _actionEs6 = __webpack_require__(535);

	var actions = _interopRequireWildcard(_actionEs6);

	var GoodDetailConnected = (0, _reactRedux.connect)(function (state) {
	    return state;
	...
	var GoodDetailApp = (function (_Component) {
	    ...
	    _createClass(GoodDetailApp, [{
	        ...
	        value: function render() {
	            ...
	            var isAuthorized = _props$initialState.isAuthorized;
	            var loginUrl = _props$initialState.loginUrl;

	            var initialState = {
	                goodById: {
	                    isAuthorized: isAuthorized, loginUrl: loginUrl,
	                    good: good
	                },
	                cartByUser: {
	                    cartCount: cartCount
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$assign2 = __webpack_require__(272)["default"];
	...
	var _constantEs6 = __webpack_require__(516);

	var _commonConstantEs6 = __webpack_require__(416);

	var _commonReducerEs6 = __webpack_require__(417);
	...
	function goodById(state, action) {
	    ...
	    var good = _extends({}, state.good);
	    switch (action.type) {
	        case _constantEs6.TOGGLE_ATTR:
	            good = toggleAttr(good, action.attrName, action.attrValue);
	            return _Object$assign2({}, state, {
	                attrToggled: true,
	                good: good
	            });
	        case _constantEs6.REQUEST_GOOD:
	            return _Object$assign2({}, state, {
	                goodFetching: true,
	                isFetched: false
	            });
	        case _constantEs6.RESPONSE_GOOD:
	            good = _Object$assign2({}, good, _lodash2["default"].omit(action.res.result, ["slides", "attrs"]));
	            return _Object$assign2({}, state, {
	                goodFetching: false,
	                isFetched: action.res.isFetched,
	                good: good
	            });
	        case _constantEs6.REQUEST_ISCOLLECTED:
	            return _Object$assign2({}, state, {
	                isFetching: true,
	                isFetched: false
	            });
	        case _constantEs6.RESPONSE_ISCOLLECTED:
	            var result = action.res.result || false;
	            return _Object$assign2({}, state, {
	                isCollected: result,
	                isFetching: false,
	                isFetched: action.res.isFetched
	            });
	        case _constantEs6.START_TOGGLE_COLLECTED:
	            return _Object$assign2({}, state, {
	                isToggling: true
	            });
	        case _constantEs6.FINISH_TOGGLE_COLLECTED:
	            var isCollected = state.isCollected;
	        ...
	        case _constantEs6.REQUEST_COMMENTS:
	            return _Object$assign2({}, state, {
	                commentsFetching: true,
	                commentsFetched: false
	            });
	        case _constantEs6.RESPONSE_COMMENTS:
	            if (action.res.commentsFetched) {
	                good.comments["list"] = _lodash2["default"].union(good.comments["list"], action.res.pagination.list);
	        ...
	        case _constantEs6.REQUEST_SHOWUPS:
	            return _Object$assign2({}, state, {
	                showupFetching: true,
	                showupFetched: false
	            });
	        case _constantEs6.RESPONSE_SHOWUPS:
	            if (action.res.commentsFetched) {
	                good.showups["list"] = _lodash2["default"].union(good.showups["list"], action.res.pagination.list);
	        ...
	        case _constantEs6.SELECT_COMMENTIMAGE:
	            return _Object$assign2({}, state, {
	...
	function toggleAttr(good, selectedAttrName, selectedAttrValue) {
	    var _good = _Object$assign2({}, good);
	    var isAttrSelected = false;
	    _good.attrs[selectedAttrName].map(function (v) {
	    ...
	    var selectedAttrs = {};
	    for (var attrName in _good.attrs) {
	        var attrValues = _good.attrs[attrName];
	        if (_lodash2["default"].some(attrValues, { selected: true, disabled: false })) {
	            selectedAttrs[attrName] = _lodash2["default"].findWhere(attrValues, { selected: true }).value;
	        }
	    }

	    // if(isAttrSelected){
	    var isNeedValidateStock = false;
	    if (_lodash2["default"].keys(selectedAttrs).length >= _lodash2["default"].keys(_good.attrs).length - 1) {
	        isNeedValidateStock = true;
	    }

	    var _loop = function (attrName) {
	        var attrValues = _good.attrs[attrName];
	        if (attrName === selectedAttrName) {
	            return "continue";
	        }
	        _good.attrs[attrName] = attrValues.map(function (attrValue) {
	            var _selectedAttrs = _Object$assign2({}, selectedAttrs, _defineProperty({}, attrName, attrValue.value));
	            // console.log('selectedAttrs',_selectedAttrs)
	            var isAttrPairExist = _lodash2["default"].some(_good.items, function (item) {
	                return _lodash2["default"].isEqual(_lodash2["default"].pick(item.attrs, _lodash2["default"].keys(_selectedAttrs)), _selectedAttrs);
	            });
	            attrValue.disabled = !isAttrPairExist;
	            if (isNeedValidateStock && isAttrPairExist && isAttrSelected) {
	                var validItem = _lodash2["default"].find(_good.items, function (item) {
	                    // console.log(item.attrs,_selectedAttrs)
	                    return _lodash2["default"].isEqual(item.attrs, _selectedAttrs);
	                });
	    ...
	    if (_lodash2["default"].keys(selectedAttrs).length === _lodash2["default"].keys(_good.attrs).length) {
	        var selectedItem = _lodash2["default"].findWhere(_good.items, { 'attrs': selectedAttrs });
	...
	function cartByUser(state, action) {
	    ...
	    switch (action.type) {
	        case _constantEs6.REQUEST_CARTCOUNT:
	            return _Object$assign2({}, state, {
	                isFetching: true,
	                isFetched: false
	            });
	        case _constantEs6.RESPONSE_CARTCOUNT:
	            var cartCount = action.res.result;
	            return _Object$assign2({}, state, {
	                cartCount: cartCount,
	                isFetching: false,
	                isFetched: action.res.isFetched
	            });
	        case _constantEs6.START_ADD_CART:
	            return _Object$assign2({}, state, {
	                cartAdding: true,
	                cartAdded: false
	            });
	        case _constantEs6.FINISH_ADD_CART:
	            var cartCount = state.cartCount;
	            var buyed = action.param.buyed;
	        ...
	        case _commonConstantEs6.SHOW_ALERT:
	        case _commonConstantEs6.HIDE_ALERT:
...
/***/ function(module, exports) {
	...
	var RESPONSE_GOOD = "RESPONSE_GOOD";

	exports.RESPONSE_GOOD = RESPONSE_GOOD;
	...
	var START_TOGGLE_COLLECTED = "START_TOGGLE_COLLECTED";
	exports.START_TOGGLE_COLLECTED = START_TOGGLE_COLLECTED;
	var FINISH_TOGGLE_COLLECTED = "FINISH_TOGGLE_COLLECTED";

	exports.FINISH_TOGGLE_COLLECTED = FINISH_TOGGLE_COLLECTED;
	var TOGGLE_ATTR = "TOGGLE_ATTR";

	exports.TOGGLE_ATTR = TOGGLE_ATTR;
	var REQUEST_CARTCOUNT = "REQUEST_CARTCOUNT";
	exports.REQUEST_CARTCOUNT = REQUEST_CARTCOUNT;
	var RESPONSE_CARTCOUNT = "RESPONSE_CARTCOUNT";

	exports.RESPONSE_CARTCOUNT = RESPONSE_CARTCOUNT;
	var REQUEST_ISCOLLECTED = "REQUEST_ISCOLLECTED";
	exports.REQUEST_ISCOLLECTED = REQUEST_ISCOLLECTED;
	var RESPONSE_ISCOLLECTED = "RESPONSE_ISCOLLECTED";

	exports.RESPONSE_ISCOLLECTED = RESPONSE_ISCOLLECTED;
	var REQUEST_COMMENTS = "REQUEST_COMMENTS";
	exports.REQUEST_COMMENTS = REQUEST_COMMENTS;
	var RESPONSE_COMMENTS = "RESPONSE_COMMENTS";

	exports.RESPONSE_COMMENTS = RESPONSE_COMMENTS;
	var REQUEST_SHOWUPS = "REQUEST_SHOWUPS";
	exports.REQUEST_SHOWUPS = REQUEST_SHOWUPS;
	var RESPONSE_SHOWUPS = "RESPONSE_SHOWUPS";

	exports.RESPONSE_SHOWUPS = RESPONSE_SHOWUPS;
	var SELECT_COMMENTIMAGE = "SELECT_COMMENTIMAGE";
	exports.SELECT_COMMENTIMAGE = SELECT_COMMENTIMAGE;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partialGooddetailJsx = __webpack_require__(518);

	var _partialGooddetailJsx2 = _interopRequireDefault(_partialGooddetailJsx);

	var _partialCommentJsx = __webpack_require__(531);

	var _partialCommentJsx2 = _interopRequireDefault(_partialCommentJsx);

	var _partialTariffJsx = __webpack_require__(533);

	var _partialTariffJsx2 = _interopRequireDefault(_partialTariffJsx);

	var _partialThumbnailJsx = __webpack_require__(534);

	var _partialThumbnailJsx2 = _interopRequireDefault(_partialThumbnailJsx);

	var _commonSceneJsx = __webpack_require__(476);

	var GoodDetailRouter = (function (_Component) {
	    _inherits(GoodDetailRouter, _Component);

	    function GoodDetailRouter() {
	        _classCallCheck(this, GoodDetailRouter);

	        _get(Object.getPrototypeOf(GoodDetailRouter.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(GoodDetailRouter, [{
	        key: "handleSceneChange",
	        value: function handleSceneChange(currentScene, param) {
	            var fetchComments = this.props.fetchComments;
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                _commonSceneJsx.SceneGroup,
	                { onChange: this.handleSceneChange.bind(this) },
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "index", scrollable: false },
	                    _react2["default"].createElement(_partialGooddetailJsx2["default"], this.props)
	                ),
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "comment" },
	                    _react2["default"].createElement(_partialCommentJsx2["default"], this.props)
	                ),
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "tariff" },
	                    _react2["default"].createElement(_partialTariffJsx2["default"], this.props)
	                ),
	                _react2["default"].createElement(
	                    _commonSceneJsx.Scene,
	                    { name: "thumbnail" },
	                    _react2["default"].createElement(_partialThumbnailJsx2["default"], this.props)
	                )
	            );
	        }
	    }]);

	    return GoodDetailRouter;
	})(_react.Component);

	exports["default"] = GoodDetailRouter;
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libUtilEs6 = __webpack_require__(288);

	var _componentSliderSliderJsx = __webpack_require__(519);

	var _componentSliderSliderJsx2 = _interopRequireDefault(_componentSliderSliderJsx);

	var _componentSliderSlideJsx = __webpack_require__(520);

	var _componentSliderSlideJsx2 = _interopRequireDefault(_componentSliderSlideJsx);

	var _componentPullhookJsx = __webpack_require__(521);

	var _componentPullhookJsx2 = _interopRequireDefault(_componentPullhookJsx);

	var _componentAlertJsx = __webpack_require__(429);
	...
	var _commonTimerJsx = __webpack_require__(509);

	var _commonTimerJsx2 = _interopRequireDefault(_commonTimerJsx);

	var _commonShareJsx = __webpack_require__(522);

	var _commonShareJsx2 = _interopRequireDefault(_commonShareJsx);

	var _componentSlidetabsJsx = __webpack_require__(491);

	var _componentTabsJsx = __webpack_require__(508);

	var _componentMasklayerJsx = __webpack_require__(420);

	var _componentMasklayerJsx2 = _interopRequireDefault(_componentMasklayerJsx);

	var _componentGotopJsx = __webpack_require__(402);

	var _componentGotopJsx2 = _interopRequireDefault(_componentGotopJsx);

	var _componentStickyJsx = __webpack_require__(523);

	var _componentStickyJsx2 = _interopRequireDefault(_componentStickyJsx);

	var _promotionsJsx = __webpack_require__(524);

	var _promotionsJsx2 = _interopRequireDefault(_promotionsJsx);

	var _originJsx = __webpack_require__(525);

	var _originJsx2 = _interopRequireDefault(_originJsx);

	var _specificationJsx = __webpack_require__(526);

	var _specificationJsx2 = _interopRequireDefault(_specificationJsx);

	var _toolbarJsx = __webpack_require__(527);

	var _toolbarJsx2 = _interopRequireDefault(_toolbarJsx);
	...
	var GoodDetail = (function (_Component) {
	    ...
	    _createClass(GoodDetail, [{
	        key: "togglePopup",
	        value: function togglePopup(trigger, e) {
	            e && e.preventDefault();
	            this.setState({
	                trigger: trigger,
	        ...
	        value: function componentDidMount() {
	            ...
	            var _props = this.props;
	            var fetchCartCount = _props.fetchCartCount;
	            var fetchIsCollected = _props.fetchIsCollected;
	            var fetchComments = _props.fetchComments;
	            var fetchShowups = _props.fetchShowups;
	            var _props$goodById$good = this.props.goodById.good;
	            var selectedItem = _props$goodById$good.selectedItem;
	            var attrs = _props$goodById$good.attrs;
	            var code = _props$goodById$good.code;
	            var productCode = _props$goodById$good.productCode;

	            _lodash2["default"].each(selectedItem.attrs, function (v, k) {
	                // let selectedAttr = _.findWhere(attrs,{attrName:k})
	                var selectedAttrValue = _lodash2["default"].findWhere(attrs[k], {
	                    value: v
	                });
	                _this.handleAttrToggle(k, selectedAttrValue);
	            });
	            fetchCartCount();
	            fetchIsCollected({
	                singleCode: code
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            if (nextProps.goodById.attrToggled) {
	                ...
	                if (this.props.goodById.good.selectedItem === null || nextProps.goodById.good.selectedItem.code !== this.props.goodById.good.selectedItem.code) {
	                    this.setState({
	        ...
	        key: "componentDidUpdate",
	        value: function componentDidUpdate(prevProps) {
	            var selectedItem = this.props.goodById.good.selectedItem;

	            var prevSelectedItem = prevProps.goodById.good.selectedItem;
	        ...
	        key: "handleAttrToggle",
	        value: function handleAttrToggle(selectedAttrName, selectedAttrValue, e) {
	            e && e.preventDefault();
	        ...
	        value: function handleBuyedChanged(buyed) {
	            var good = this.props.goodById.good;
	        ...
	        value: function addToCart(e) {
	            ...
	            var addCart = _props2.addCart;
	            var good = this.props.goodById.good;

	            if (good.stock === 0) {
	                return;
	            }
	            var buyed = this.state.buyed;

	            if (good.selectedItem === null) {
	                var attrName = _lodash2["default"].findKey(good.attrs, function (attr) {
	                    return _lodash2["default"].some(attr, { selected: true }) === false;
	                ...
	                if (good.flashbuy['active']) {
	                    var singleCode = good.selectedItem.code;
	                    var queryParam = (0, _libUtilEs6.base64Encode)((0, _libUtilEs6.urlParam)({
	                        itemIds: singleCode,
	                        buyeds: buyed
	                    }));
	        ...
	        key: "toggleCollected",
	        value: function toggleCollected(e) {
	            e && e.preventDefault();
	            var toggleCollected = this.props.toggleCollected;
	            var _props$goodById = this.props.goodById;
	            var good = _props$goodById.good;
	            var isCollected = _props$goodById.isCollected;
	            var isAuthorized = _props$goodById.isAuthorized;
	            var loginUrl = _props$goodById.loginUrl;
	            ...
	            if (good.flashbuy['active']) {
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "em",
	                        null,
	                        _react2["default"].createElement(_commonTimerJsx2["default"], { endTime: good.flashbuy['endTime'], dayEnable: true,
	            ...
	            if (good["useMobilePrice"] && !good.flashbuy["active"]) {
	                ...
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        { className: "nowPrice" },
	                        "¥",
	                        (0, _libUtilEs6.formatPrice)(salePrice)
	                    ),
	                    _react2["default"].createElement(
	                        "span",
	                        { className: "exclusive" },
	        ...
	        value: function renderToolbar() {
	            var cartCount = this.props.cartByUser.cartCount;
	            var good = this.props.goodById.good;
	            var buyed = this.state.buyed;

	            return _react2["default"].createElement(_toolbarJsx2["default"], { cartCount: cartCount, good: good,
	        ...
	        value: function render() {
	            var cartCount = this.props.cartByUser.cartCount;
	            var _props$goodById2 = this.props.goodById;
	            var good = _props$goodById2.good;
	            var isCollected = _props$goodById2.isCollected;
	            var buyed = this.state.buyed;
	            ...
	            var isCollectedClasses = (0, _classnames2["default"])("iconfont", {
	                "icon-xinman": isCollected,
	                "icon-xin": !isCollected
	            });
	            return _react2["default"].createElement(
	                _componentGotopJsx2["default"],
	                { relative: true, renderFixed: this.renderToolbar.bind(this),
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { className: "globa", href: "/" },
	                            _react2["default"].createElement("i", null)
	                        ),
	                        _react2["default"].createElement("a", { className: "goods_share", onClick: this.toggleShare.bind(this) })
	                    ),
	                    _react2["default"].createElement(
	                        "div",
	                        { className: upperClasses },
	                        good.slides.length > 0 ? _react2["default"].createElement(
	                            _componentSliderSliderJsx2["default"],
	                            { effect: "roll", autoPlay: false, loop: true, speed: 200 },
	                            slides
	                        ) : null,
	                        _react2["default"].createElement(
	                            "div",
	                            ...
	                            _react2["default"].createElement(
	                                "a",
	                                { className: "goods_fav", onClick: this.toggleCollected.bind(this) },
	                                _react2["default"].createElement("i", { className: isCollectedClasses }),
	                                "收藏"
	                            )
	                        ),
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                { className: "oldPrice" },
	                                "市场价¥",
	                                (0, _libUtilEs6.formatPrice)(good.originPrice)
	                            ),
	                            this.renderCountdown()
	                        ),
	                        _react2["default"].createElement(_promotionsJsx2["default"], { promotions: good.promotions }),
	                        _react2["default"].createElement(
	                            "a",
	                            { onClick: this.props.changeScene.bind(this, "comment", { productCode: good.productCode }),
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(
	                                    ...
	                                    null,
	                                    "(",
	                                    good.comments ? good.comments.totalCount : 0,
	                                    ")"
	                                )
	                            ),
	                            _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(_originJsx2["default"], _extends({ good: good }, this.props)),
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "assure" },
	                            _react2["default"].createElement("img", { src: "/client/asset/images/assure.gif" })
	                        ),
	                        this.state.downVisble ? null : _react2["default"].createElement(
	                            "div",
	                            { className: "teyla" },
	                            "上拉显示商品详情"
	                        )
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        { active: this.props.cartByUser.alertActive },
	                        this.props.cartByUser.alertContent
	                    ),
	                    _react2["default"].createElement(_componentMasklayerJsx2["default"], { visible: this.state.popupActive }),
	                    _react2["default"].createElement(
	                        _commonShareJsx2["default"],
	                        { active: this.state.shareActive, onClose: this.toggleShare.bind(this) },
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "center" },
	                            _react2["default"].createElement("img", { src: good.sharedQRCode })
	                        ),
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "bottom" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toConsumableArray = __webpack_require__(458)["default"];
	...
	var Slider = (function (_Component) {
	    ...
	    _createClass(Slider, [{
	        ...
	        value: function handleTouchMove(e) {
	            ...
	            var touchAngle = Math.atan2(moveY, moveX) * 180 / Math.PI;
	            var moveDirection = touchAngle < 45 ? "horizontal" : "vertical";
	            // let moveDirection =  moveY > moveX ?"y":"x"
	            if (this.moveDirection && this.moveDirection !== moveDirection) {
	                return;
	            }
	...
	var Share = (function (_Component) {
	    ...
	    _createClass(Share, [{
	        ...
	        value: function render() {
	            ...
	            var classes = (0, _classnames2["default"])("pop-qr", {
	                active: active
	            });
	            return _react2["default"].createElement(
	                "div",
	                { className: "share" },
	                _react2["default"].createElement(_componentMasklayerJsx2["default"], { visible: active }),
	                _react2["default"].createElement(
	                    "div",
	                    { className: classes },
	                    _react2["default"].createElement("div", { className: "btn-close iconfont icon-close", onClick: onClose }),
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "top" },
	                        this.props.title
	...
	var Sticky = (function (_Component) {
	    ...
	    _createClass(Sticky, [{
	        ...
	        value: function checkPosition() {
	            var scrollTop = _libDomEs62["default"].scrollTop(this.scrollEl);
	            var offsets = {};
	            var _props = this.props;
	            var top = _props.top;
	            ...
	            offsets = top !== undefined ? _Object$assign({}, offsets, {
	                top: top
	            }) : offsets;
	            offsets = bottom !== undefined ? _Object$assign({}, offsets, {
	                bottom: bottom
	            }) : offsets;
	            offsets = left !== undefined ? _Object$assign({}, offsets, {
	                left: left
	            }) : offsets;
	            offsets = right !== undefined ? _Object$assign({}, offsets, {
	                right: right
	            }) : offsets;
	            var holder = _reactDom2["default"].findDOMNode(this.refs.holder);
	            var checkResult = scrollTop > 0;
	            var stickerStyle = _Object$assign({}, offsets, {
	                position: "absolute",
	            ...
	            if (checkResult === true) {
	                ...
	                var currentTop = top + scrollTop + "px";
	                if (bottom && !top) {
	                    currentTop = this.scrollEl.clientHeight - bottom + scrollTop + "px";
	                }
	                stickerStyle = _Object$assign({}, stickerStyle, {
	        ...
	        key: "componentDidMount",
	        value: function componentDidMount() {
	            this.scrollEl = this.props.target === undefined ? _reactDom2["default"].findDOMNode(this).parentNode : _reactDom2["default"].findDOMNode(this.props.target);
	            this.checkPosition();
	            // const ownerWindow = dom.ownerWindow(React.findDOMNode(this.refs.sticker));
	            _libDomEs62["default"].bindEvent(this.scrollEl, "scroll", this.checkPosition.bind(this));
	        }
	    }, {
	        key: "componentWillUnmount",
	        value: function componentWillUnmount() {
	            _libDomEs62["default"].unbindEvent(this.scrollEl, "scroll", this.checkPosition.bind(this));
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                "div",
	                { className: "sticky", style: this.state.stickerStyle },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentDropdownJsx = __webpack_require__(444);
	...
	var Promotions = (function (_Component) {
	    ...
	    _createClass(Promotions, [{
	        ...
	        value: function render() {
	            var promotions = [],
	                promotionBriefs = [];
	            if (_lodash2["default"].isEmpty(this.props.promotions)) {
	                return null;
	            }
	...
	var Origin = (function (_Component) {
	    ...
	    _createClass(Origin, [{
	        ...
	        value: function render() {
	            ...
	            var useOutlandLogistics = good.useOutlandLogistics;
	            var outlandLogisticsFee = good.outlandLogisticsFee;

	            var logistics = useOutlandLogistics ? _react2["default"].createElement(
	                "em",
	                null,
	                "¥",
	                (0, _libUtilEs6.formatPrice)(outlandLogisticsFee)
	            ) : "包邮";
	            return _react2["default"].createElement(
	                "div",
	                { className: "overView" },
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "i",
	                            null,
	                            _react2["default"].createElement("img", { src: good.originFlag, alt: "" })
	                        ),
	                        good.originName
	                    )
	                ),
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(null)", onClick: this.props.changeScene.bind(this, "tariff"),
	                                className: "tariff" },
	                            _react2["default"].createElement(
	                                "span",
	                                null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentPopupJsx = __webpack_require__(528);

	var _componentPopupJsx2 = _interopRequireDefault(_componentPopupJsx);

	var _componentNumberpickerJsx = __webpack_require__(421);
	...
	var _attributesJsx = __webpack_require__(529);

	var _attributesJsx2 = _interopRequireDefault(_attributesJsx);
	...
	var Toolbar = (function (_Component) {
	    ...
	    _createClass(Toolbar, [{
	        ...
	        value: function render() {
	            ...
	            var handleBuyedChanged = _props.handleBuyedChanged;
	            var handleAttrToggle = _props.handleAttrToggle;
	            var popupActive = _props.popupActive;
	            var trigger = _props.trigger;
	            var togglePopup = _props.togglePopup;
	            var cartCount = _props.cartCount;
	            var selectedAttr = _props.selectedAttr;
	            var buyed = _props.buyed;
	            var good = _props.good;

	            var handleConfirm = trigger && trigger === "addToCart" ? addToCart : directBuy;

	            var buylimit = good.buyLimit > good.stock ? good.stock : good.buyLimit;
	            var canAddCart = good["canAddCart"];
	            if (good.stock === 0 || good.flashbuy["active"]) {
	                canAddCart = false;
	            }
	            // console.log('canAddCart',canAddCart)
	            var addCartClasses = (0, _classnames2["default"])("goods_add", {
	                "disabled": !canAddCart
	            });
	            var directBuyClasses = (0, _classnames2["default"])("goods_buy", {
	                "disabled": good.stock === 0
	            });
	            return _react2["default"].createElement(
	                "div",
	                { className: "good-detail-toolbar" },
	                _react2["default"].createElement(
	                    "div",
	                    { className: "good-detail-btn" },
	                    _react2["default"].createElement(
	                        "a",
	                    ...
	                    _react2["default"].createElement(
	                        "a",
	                        { href: "javascript:void(null)", onClick: togglePopup.bind(this, "addToCart"), className: addCartClasses },
	                        "加入购物车"
	                    ),
	                    _react2["default"].createElement(
	                        "a",
	                        { href: "javascript:void(0);", onClick: togglePopup.bind(this, "directBuy"), className: directBuyClasses },
	                        good.stock === 0 ? "已抢光" : "立即购买"
	                    )
	                ),
	                _react2["default"].createElement(
	                    _componentPopupJsx2["default"],
	                    { direction: "bottom", active: popupActive },
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "con" },
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement("i", { className: "iconfont icon-close-circled", onClick: togglePopup.bind(this, null) })
	                        ),
	                        _react2["default"].createElement(_attributesJsx2["default"], { attrs: good.attrs,
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement(_componentNumberpickerJsx2["default"], { value: buyed, onChange: handleBuyedChanged,
	                                    step: good.buyedStep,
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(0);", onClick: handleConfirm, className: "goodsSureBtn" },
	                            "确定"
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentPopoverJsx = __webpack_require__(530);
	...
	var Attributes = (function (_Component) {
	    ...
	    function Attributes() {
	        ...
	        _get(Object.getPrototypeOf(Attributes.prototype), "constructor", this).apply(this, arguments);
	    }
	    ...
	    _createClass(Attributes, [{
	        ...
	        value: function render() {
	            ...
	            var _props = this.props;
	            var onAttrChange = _props.onAttrChange;
	            var attrs = _props.attrs;

	            var attrContent = [];

	            var _loop = function (attrName) {
	                var attrValues = attrs[attrName];
	                if (attrValues.length === 0) {
	                    return {
	                        v: null
	                    };
	                }
	                attrValues = attrValues.map(function (attrValue, j) {
	                    var classes = (0, _classnames2["default"])({
	                    ...
	                    return _react2["default"].createElement(
	                        ...
	                        { className: classes,
	                            href: "javascript:void(null)",
	                            key: j,
	                            onClick: onAttrChange.bind(_this, attrName, attrValue)
	                        },
	                        attrValue.value
	                    );
	                });
	                attrContent.push(_react2["default"].createElement(
	                    "div",
	                    { className: "property", key: attrName },
	                    _react2["default"].createElement(
	                        "div",
	                        { className: "divider-title" },
	                        _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentRefresherJsx = __webpack_require__(399);

	var _componentRefresherJsx2 = _interopRequireDefault(_componentRefresherJsx);

	var _commonSwipelistJsx = __webpack_require__(532);

	var _commonSwipelistJsx2 = _interopRequireDefault(_commonSwipelistJsx);

	var GoodComment = (function (_Component) {
	    _inherits(GoodComment, _Component);

	    function GoodComment(props) {
	        _classCallCheck(this, GoodComment);

	        _get(Object.getPrototypeOf(GoodComment.prototype), "constructor", this).call(this, props);
	    }

	    _createClass(GoodComment, [{
	        key: "renderStars",
	        value: function renderStars(rate) {
	            var stars = [];
	            for (var i = 0; i < 5; i++) {
	                var star = undefined;
	                if (i < rate) {
	                    star = _react2["default"].createElement("li", { key: i, className: "iconfont icon-star-full" });
	                } else {
	                    star = _react2["default"].createElement("li", { key: i, className: "iconfont icon-star-empty" });
	                }
	                stars.push(star);
	            };
	            return _react2["default"].createElement(
	        ...
	        value: function renderComments() {
	            ...
	            var comments = this.props.goodById.good.comments;

	            if (comments && comments["list"].length > 0) {
	                var commentsContent = comments["list"].map(function (comment, i) {
	                    var commentImages = comment["commentImages"].map(function (img, i) {
	                        return _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(null)",
	                                onClick: function () {
	                                    _this.props.changeScene("thumbnail", { index: i, list: comment["commentImages"] });
	                                },
	                                key: i },
	                    ...
	                    return _react2["default"].createElement(
	                        "div",
	                        { className: "comList", key: i },
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "comList_title" },
	                            _react2["default"].createElement("img", { src: comment.avatar }),
	                            _react2["default"].createElement(
	                                "span",
	                                null,
	                                comment.isOpen === 1 ? comment.nickName : "匿名用户"
	                            ),
	                            _react2["default"].createElement(
	                                "em",
	                                null,
	                        ...
	                        _this.renderStars(comment.rate),
	                        _react2["default"].createElement(
	                            "p",
	                            null,
	                            comment.content
	            ...
	            return _react2["default"].createElement(
	                "div",
	                { className: "empty" },
	                _react2["default"].createElement("img", { src: "/client/asset/images/empty_goodsComment.png" }),
	                _react2["default"].createElement(
	                    "span",
	                    null,
	                    "目前还没有任何评论哟~"
	        ...
	        key: "renderShowups",
	        value: function renderShowups() {
	            var _this2 = this;

	            var showups = this.props.goodById.good.showups;

	            if (showups && showups["list"].length > 0) {
	                var showupsContent = showups["list"].map(function (comment, i) {
	                    var commentImages = comment["commentImages"].map(function (img, i) {
	                        return _react2["default"].createElement(
	                            "a",
	                            { href: "javascript:void(null)",
	                                onClick: function () {
	                                    _this2.props.changeScene("thumbnail", { index: i, list: comment["commentImages"] });
	                                },
	                                key: i },
	                            _react2["default"].createElement("img", { src: img })
	                        );
	                    ...
	                    return _react2["default"].createElement(
	                        ...
	                        _this2.renderStars(comment.rate),
	                        _react2["default"].createElement(
	                            "p",
	                            null,
	                            comment.content
	            ...
	            return _react2["default"].createElement(
	                "div",
	                { className: "empty" },
	                _react2["default"].createElement("img", { src: "/client/asset/images/empty_goodsSun.png" }),
	                _react2["default"].createElement(
	                    "span",
	                    null,
	                    "目前还没有任何晒单哟~"
	        ...
	        key: "componentDidMount",
	        value: function componentDidMount() {
	            var productCode = this.props.goodById.good.productCode;

	            this.props.fetchComments({ productCode: productCode });
	            this.props.fetchShowups({ productCode: productCode });
	        }
	    }, {
	        key: "handleRefreshComments",
	        value: function handleRefreshComments() {
	            var _props$goodById$good$comments = this.props.goodById.good.comments;
	            var pageIndex = _props$goodById$good$comments.pageIndex;
	            var totalPage = _props$goodById$good$comments.totalPage;
	            var _props$goodById$good = this.props.goodById.good;
	            var commentsFetching = _props$goodById$good.commentsFetching;
	            var productCode = _props$goodById$good.productCode;
	        ...
	        key: "handleRefreshShowups",
	        value: function handleRefreshShowups() {
	            var _props$goodById$good$showups = this.props.goodById.good.showups;
	            var pageIndex = _props$goodById$good$showups.pageIndex;
	            var totalPage = _props$goodById$good$showups.totalPage;
	            var _props$goodById$good2 = this.props.goodById.good;
	            var showupFetching = _props$goodById$good2.showupFetching;
	            var productCode = _props$goodById$good2.productCode;
	        ...
	        key: "render",
	        value: function render() {
	            var _props$goodById$good3 = this.props.goodById.good;
	            var commentsFetching = _props$goodById$good3.commentsFetching;
	            var showupFetching = _props$goodById$good3.showupFetching;
	            var comments = _props$goodById$good3.comments;
	            var showups = _props$goodById$good3.showups;
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    _commonHeaderJsx2["default"],
	                    { onGoBack: this.props.changeScene.bind(this, "index") },
	                    "商品评论"
	                ),
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            { relative: true },
	                            this.renderComments(),
	                            _react2["default"].createElement(_componentRefresherJsx2["default"], { active: commentsFetching, handleRefresh: this.handleRefreshComments.bind(this) }),
	                            comments.pageIndex == comments.totalPage && comments.totalPage > 1 ? _react2["default"].createElement(
	                                "div",
	                                { className: "no-more" },
	                                "已显示全部内容"
	                            ) : null
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            { relative: true },
	                            this.renderShowups(),
	                            _react2["default"].createElement(_componentRefresherJsx2["default"], { active: showupFetching, handleRefresh: this.handleRefreshShowups.bind(this) }),
	                            showups.pageIndex == showups.totalPage && showups.length > 1 ? _react2["default"].createElement(
	                                "div",
	                                { className: "no-more" },
	                                "已显示全部内容"
	                            ) : null
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Swipelist = (function (_Component) {
	    _inherits(Swipelist, _Component);

	    function Swipelist() {
	        _classCallCheck(this, Swipelist);

	        _get(Object.getPrototypeOf(Swipelist.prototype), "constructor", this).apply(this, arguments);
	    }
	    ...
	    _createClass(Swipelist, [{
	        ...
	        value: function componentDidUpdate() {
	            var _props = this.props;
	            var imgList = _props.imgList;
	            var activeIndex = _props.activeIndex;

	            if (imgList && imgList.length > 0) {
	                _reactDom2["default"].findDOMNode(this.refs["swipelist"]).children[0].children[activeIndex].click();
	            }
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            var _props2 = this.props;
	            var imgList = _props2.imgList;
	            var activeIndex = _props2.activeIndex;
	            var canBack = _props2.canBack;
	            var onGoBack = _props2.onGoBack;

	            if (imgList) {
	                return _react2["default"].createElement(
	                    "div",
	                    { className: "swipe-list" },
	                    _react2["default"].createElement("a", { href: "javascript:void(null)", onClick: onGoBack, className: "iconfont icon-back" }),
	                    _react2["default"].createElement(
	                        _componentSlidetabsJsx.SlideTabs,
	                        { ref: "swipelist", axis: "x", activeIndex: activeIndex, contentSlidable: imgList.length > 1, navbarSlidable: false },
	                        imgList.map(function (v, k) {
	                            var t = k + 1 + " / " + imgList.length;
	                            return _react2["default"].createElement(
	                                _componentSlidetabsJsx.SlideTabsItem,
	                                { key: k, navigator: function () {
	                                        return _react2["default"].createElement(
	                                            "span",
	                                            { className: "header" },
	                                            _react2["default"].createElement(
	                                ...
	                                _react2["default"].createElement("img", { key: Math.random(), src: v })
	                            );
	                        })
	                    )
	                );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tariff = (function (_Component) {
	  ...
	  function Tariff(props) {
	    ...
	    _get(Object.getPrototypeOf(Tariff.prototype), "constructor", this).call(this, props);
	  }
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "table",
	            { className: "w-table para", border: "0", cellSpacing: "0", cellPadding: "0" },
	            _react2["default"].createElement(
	              "tbody",
	              null,
	              _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Thumbnail = (function (_Component) {
	    ...
	    _createClass(Thumbnail, [{
	        ...
	        value: function render() {
	            var _props$goodById = this.props.goodById;
	            var selectedCommentImageIndex = _props$goodById.selectedCommentImageIndex;
	            var selectedCommentImages = _props$goodById.selectedCommentImages;

	            return _react2["default"].createElement(
	                "div",
	                { className: "comment-thumbnail" },
	                _react2["default"].createElement(_commonSwipelistJsx2["default"], { onGoBack: this.props.changeScene.bind(this, "comment"), imgList: selectedCommentImages, activeIndex: selectedCommentImageIndex })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchGood = fetchGood;
	exports.addCart = addCart;
	exports.toggleCollected = toggleCollected;
	exports.fetchIsCollected = fetchIsCollected;
	exports.fetchComments = fetchComments;
	exports.fetchShowups = fetchShowups;
	exports.selectCommentImage = selectCommentImage;

	var _libUtilEs6 = __webpack_require__(288);

	var _constantEs6 = __webpack_require__(516);

	var _commonActionEs6 = __webpack_require__(433);

	function toggleAttr(attrName, attrValue) {
	    return {
	        type: _constantEs6.TOGGLE_ATTR,
	        attrName: attrName,
	        attrValue: attrValue
	    };
	}
	...
	function requestCartCount() {
	    return {
	        type: _constantEs6.REQUEST_CARTCOUNT
	    };
	}

	function responseCartCount(res) {
	    return {
	        type: _constantEs6.RESPONSE_CARTCOUNT,
	        res: res
	    };
	}
	...
	function fetchCartCount() {
	    return function (dispatch) {
	        ...
	        return (0, _libUtilEs6.apiRequest)("/cartcount").then(function (res) {
	            if (res.logined === false) {
	                res.result = (0, _libUtilEs6.getLocalCartCount)();
	            }
	...
	function requestGood(param) {
	    return {
	        type: _constantEs6.REQUEST_GOOD,
	        param: param
	    };
	}
	...
	function responseGood(param, res) {
	    return {
	        type: _constantEs6.RESPONSE_GOOD,
	        param: param,
	        res: res
	    };
	}
	...
	Object.defineProperty(exports, "alert", {
	    enumerable: true,
	    get: function get() {
	        return _commonActionEs6.alert;
	    }
	});

	function fetchGood(param) {
	    return function (dispatch) {
	        dispatch(requestGood(param));
	        return (0, _libUtilEs6.apiRequest)("/gooddetail/" + param.id, {}).then(function (res) {
	...
	function startAddCart(param) {
	    return {
	        type: _constantEs6.START_ADD_CART,
	        param: param
	    };
	}
	...
	function finishAddCart(param, res) {
	    return {
	        type: _constantEs6.FINISH_ADD_CART,
	        param: param,
	        res: res,
	        finishAt: Date.now()
	    };
	...
	function addCart(param) {
	    return function (dispatch) {
	        ...
	        (0, _libUtilEs6.apiRequest)("/addcart", param).then(function (res) {
	            if (res.logined === false) {
	                (0, _libUtilEs6.saveLocalCart)(param.itemId, param.buyed, false);
	                res.cartAdded = true;
	            } else {
	                if (res.cartAdded) {
	                    dispatch((0, _commonActionEs6.alert)("添加购物车成功!", 3000));
	                } else {
	                    dispatch((0, _commonActionEs6.alert)(res.errMsg, 3000));
	                }
	            }
	...
	function startToggleCollected(param) {
	    return {
	        type: _constantEs6.START_TOGGLE_COLLECTED,
	        param: param
	    };
	}
	...
	function finishToggleCollected(param, res) {
	    return {
	        type: _constantEs6.FINISH_TOGGLE_COLLECTED,
	        param: param,
	        res: res,
	        finishAt: Date.now()
	    };
	...
	function toggleCollected(param) {
	    return function (dispatch) {
	        dispatch(startToggleCollected(param));
	        (0, _libUtilEs6.apiRequest)("/togglecollected", param).then(function (res) {
	            var alertMsg = "";
	            if (res.isToggled) {
	                alertMsg = param.status ? "添加收藏成功!" : "取消收藏成功!";
	                dispatch((0, _commonActionEs6.alert)(alertMsg, 3000));
	            } else {
	                dispatch((0, _commonActionEs6.alert)(res.errMsg, 3000));
	            }
	...
	function requestIsCollected(param) {
	    return {
	        type: _constantEs6.REQUEST_ISCOLLECTED,
	        param: param
	    };
	}
	...
	function responseIsCollected(param, res) {
	    return {
	        type: _constantEs6.RESPONSE_ISCOLLECTED,
	        param: param,
	        res: res
	    };
	}

	function fetchIsCollected(param) {
	    return function (dispatch) {
	        dispatch(requestIsCollected(param));
	        return (0, _libUtilEs6.apiRequest)("/iscollected", param).then(function (res) {
	...
	function requestComments(param) {
	    return {
	        type: _constantEs6.REQUEST_COMMENTS,
	        param: param
	    };
	}
	...
	function responseComments(param, res) {
	    return {
	        type: _constantEs6.RESPONSE_COMMENTS,
	        param: param,
	        res: res
	    };
	}

	function fetchComments(param) {
	    return function (dispatch) {
	        dispatch(requestComments(param));
	        return (0, _libUtilEs6.apiRequest)("/goodcomment", _Object$assign({}, param, {
	            hasImage: false
	        })).then(function (res) {
	...
	function requestShowups(param) {
	    return {
	        type: _constantEs6.REQUEST_SHOWUPS,
	        param: param
	    };
	}
	...
	function responseShowups(param, res) {
	    return {
	        type: _constantEs6.RESPONSE_SHOWUPS,
	        param: param,
	        res: res
	    };
	}

	function fetchShowups(param) {
	    return function (dispatch) {
	...
	function selectCommentImage(index, list) {
	    return {
	        type: _constantEs6.SELECT_COMMENTIMAGE,
	        index: index,
	        list: list
	    };
	}
